...
[![The 386 die with the standard-cell regions highlighted.](https://static.righto.com/images/386-curiosities/die-labeled-w500.jpg "The 386 die with the standard-cell regions highlighted.")](https://static.righto.com/images/386-curiosities/die-labeled.jpg)
...
[![Two CMOS switches, highlighted in green. The lower switch is flipped vertically compared to the upper switch.](https://static.righto.com/images/386-curiosities/switch-metal-w400.jpg "Two CMOS switches, highlighted in green. The lower switch is flipped vertically compared to the upper switch.")](https://static.righto.com/images/386-curiosities/switch-metal.jpg)
...
[![A diagram showing the silicon for a standard-cell switch. The polysilicon is shown in green. The bottom metal is shown in blue, red, and purple.](https://static.righto.com/images/386-curiosities/switch-diagram-w400.jpg "A diagram showing the silicon for a standard-cell switch. The polysilicon is shown in green. The bottom metal is shown in blue, red, and purple.")](https://static.righto.com/images/386-curiosities/switch-diagram.jpg)
...
[![A four-way multiplexer constructed from CMOS switches and individual transistors.](https://static.righto.com/images/386-curiosities/mux4-w200.jpg "A four-way multiplexer constructed from CMOS switches and individual transistors.")](https://static.righto.com/images/386-curiosities/mux4.jpg)
...
[![A block of standard-cell logic with multiplexers highlighted. The metal and polysilicon layers were removed for this photo, revealing the silicon transistors.](https://static.righto.com/images/386-curiosities/muxes-w400.jpg "A block of standard-cell logic with multiplexers highlighted. The metal and polysilicon layers were removed for this photo, revealing the silicon transistors.")](https://static.righto.com/images/386-curiosities/muxes.jpg)
...
[![The "misplaced" transistor, indicated by the arrow. The irregular green regions are oxide that was incompletely removed.](https://static.righto.com/images/386-curiosities/extra-transistor-w500.jpg "The "misplaced" transistor, indicated by the arrow. The irregular green regions are oxide that was incompletely removed.")](https://static.righto.com/images/386-curiosities/extra-transistor.jpg)
...
[![An inverter as seen on the die. The corresponding standard cell is shown below.](https://static.righto.com/images/386-curiosities/inverter-diagram-w450.jpg "An inverter as seen on the die. The corresponding standard cell is shown below.")](https://static.righto.com/images/386-curiosities/inverter-diagram.jpg)
...
[![The "bad" inverter. (Image is flipped vertically for comparison with the previous inverter.)](https://static.righto.com/images/386-curiosities/transistors-die-w450.jpg "The "bad" inverter. (Image is flipped vertically for comparison with the previous inverter.)")](https://static.righto.com/images/386-curiosities/transistors-die.jpg)
...
4.  One very common circuit in the 386 is a latch constructed from an inverter loop and a switch/multiplexer. The inverter's output and the switch's output are connected together. The trick, however, is that the inverter is constructed from special weak transistors. When the switch is disabled, the inverter's weak output is sufficient to drive the loop. But to write a value into the latch, the switch is enabled and its output overpowers the weak inverter.
    ...
    The point of this is that there _are_ circuits where an inverter and a multiplexer have their outputs connected. However, the inverter must be constructed with special weak transistors, which is not the situation that I'm discussing. [↩](#fnref:latch "Jump back to footnote 4 in the text")
...
[![](//www.blogger.com/img/blogger_logo_round_35.png "Ed")](https://www.blogger.com/profile/05166570303512915170)
...
*   [![](https://lh3.googleusercontent.com/blogger_img_proxy/AEn0k_uDrDE5ATdzI0tt9TCFcZ7VeCrpaJJ3_o--Nzpz__ZPf2Elu-2X3cInr3ZDxy7lpxxgZThQQIXDElWyCKXbz48Hy9RJ313FPAlinUmGR0Taa6w=w72-h72-p-k-no-nu)](https://www.righto.com/2009/08/multi-protocol-infrared-remote-library.html)
...
*   [![](https://lh3.googleusercontent.com/blogger_img_proxy/AEn0k