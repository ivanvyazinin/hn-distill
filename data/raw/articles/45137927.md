...
[![/logo_ssp_main.png](/logo_ssp_main.png "/logo_ssp_main.png")](/ "Data Engineering Blog")

*   [Blogs](/posts/ "All Posts")
*   [Tags](/tags/ "Tags")
*   [Brain](/brain/ "Brain")
*   [Vault](/brain/data-engineering/ "Vault")
*   [Book](/book/ "Data Engineering Design Patterns Book")
*   [About](/about/ "About & Now")

[](javascript:void\(0\); "Search")[](javascript:void\(0\); "Clear")[](javascript:void\(0\); "Switch Theme")
...
[](javascript:void\(0\); "Switch Theme")

Contents

1.  [Home](/)
2.  [Data Engineering](/categories/data-engineering/)

# Data Modeling Guide for Real-Time Analytics with ClickHouse

## From S3 Ingestion to Sub-Second Dashboards

[Data Engineering](/categories/data-engineering/) 2025-09-05 4830 words 23 minutes
...
*   [Data Flow for Real-time Analytics](#data-flow-for-real-time-analytics)
    *   [Data Flow is Knowing the Requirements](#data-flow-is-knowing-the-requirements)
    *   [Real-Time Analytics: A Tradeoff](#real-time-analytics-a-tradeoff)
    *   [The Payoff of Great Data Flow](#the-payoff-of-great-data-flow)
*   [ClickHouse Modeling Strategies: From Theory to Practice](#clickhouse-modeling-strategies-from-theory-to-practice)
    *   [Modeling Data with ClickHouse](#modeling-data-with-clickhouse)
*   [Demo: Using S3 -> ClickHouse -> Rill](#demo-using-s3---clickhouse---rill)
    *   [Ingest and Transformation](#ingest-and-transformation)
    *   [Visualizing in Rill](#visualizing-in-rill)
    *   [What Did We Learn so Far?](#what-did-we-learn-so-far)
*   [Applicable Tips & Tricks](#applicable-tips--tricks)
    *   [Deduplication Strategies](#deduplication-strategies)
    *   [Performance Optimization](#performance-optimization)
        *   [Partitioning Strategy](#partitioning-strategy)
        *   [Predicate Pushdown Optimization](#predicate-pushdown-optimization)
        *   [Pre-Aggregation with AggregatingMergeTree](#pre-aggregation-with-aggregatingmergetree)
    *   [Storage Efficiency](#storage-efficiency)
        *   [Data Sketches for Approximation](#data-sketches-for-approximation)
        *   [Rollup to Optimal Time Granularity](#rollup-to-optimal-time-granularity)
    *   [Sampling Strategies](#sampling-strategies)
        *   [Statistical Sampling for Large Datasets](#statistical-sampling-for-large-datasets)
    *   [Schema Management](#schema-management)
        *   [Table Projections for Query Optimization](#table-projections-for-query-optimization)
        *   [Schema Evolution Best Practices](#schema-evolution-best-practices)
    *   [Time Series Optimization](#time-series-optimization)
        *   [Always Store in UTC](#always-store-in-utc)
*   [Choosing the Right ClickHouse Modeling Strategy](#choosing-the-right-clickhouse-modeling-strategy)

This article was written as part of [my services](/services)
...
[![/blog/practical-data-modeling-clickhouse/data-modeling.png](/blog/practical-data-modeling-clickhouse/data-modeling.png "/blog/practical-data-modeling-clickhouse/data-modeling.png")](/blog/practical-data-modeling-clickhouse/data-modeling.png "/blog/practical-data-modeling-clickhouse/data-modeling.png")

From the book [Data Modeling with Snowflake](https://www.amazon.com/dp/1837634459) by Serge Gershkovich | Like seeing a forest for the trees, ubiquitous modeling allows us to see the business for the data.
...
Remember our data flow: `Sources → Transformation & Aggregation → ClickHouse → Visualization`. The key insight is that ClickHouse doesn’t only serve as storage but can handle much of the transformation and aggregation work directly, eliminating traditional ETL bottlenecks.
...
[![/blog/practical-data-modeling-clickhouse/rill-dashboard.webp](/blog/practical-data-modeling-clickhouse/rill-dashboard.webp "/blog/practical-data-modeling-clickhouse/rill-dashboard.webp")](/blog/practical-data-modeling-clickhouse/rill-dashboard.webp "/blog/practical-data-modeling-clickhouse/rill-dashboard.webp")
...
_Source code and full project can be found on GitHub at [clickhouse-modeling-rill-example](https://github.com/sspaeti/clickhouse-modeling-rill-example)_
...
[![/blog/practical-data-modeling-clickhouse/rill-source.webp](/blog/practical-data-modeling-clickhouse/rill-source.webp "/blog/practical-data-modeling-clickhouse/rill-source.webp")](/blog/practical-data-modeling-clickhouse/rill-source.webp "/blog/practical-data-modeling-clickhouse/rill-source.webp")
...
![image](https://www.ssp.sh/blog/practical-data-modeling-clickhouse/clickhouse-locally_hu_5a8477ad2eb3584b.webp "clickhouse-locally.webp")  
...
_Written as part of [my services](/services)_
...
[](javascript:void\(0\); "Share on Linkedin")

[](javascript:void\(0\); "Share on WhatsApp")

[](javascript:void\(0\); "Share on Pinterest")

[](javascript:void\(0\); "Share on Reddit")

[](javascript:void\(0\); "Share on Pocket")

[](javascript:void\(0\); "Share on Evernote")

[](javascript:void\(0\); "Share on Hacker News")

[Clickhouse](/tags/clickhouse/)[Real-Time Analytics](/tags/real-time-analytics/)[Data Modeling](/tags/data-modeling/)[Olap](/tags/olap/)[S3](/tags/s3/)[Rill](/tags/rill/)[Etl](/tags/etl/)[Partitioning](/tags/partitioning/)[Aggregation](/tags/aggregation/)[Dashboard](/tags/dashboard/)[Services](/tags/services/)

 

_©_ 2004-2025 [sspaeti](/about) | [All Rights Reserved](/copyright-policy) & [Legal](/impressum-privacy) | [Services](/services)
