...
![](definitions_bad.webp?t=1760553996)

and here:

![](definitions_good.webp?t=1760553996)
...
![](change_before.webp?t=1760553996)

After:

![](change_after.webp?t=1760553996)
...
![](yellow_comments.webp?t=1760553996)
...
![](two_types_of_comments.webp?t=1760553996)
...
![](vscode_default_dark@2x.webp?t=1760553996)

and here’s a light one:

![](vscode_default_light@2x.webp?t=1760553996)

On the latter one, colors are way less vibrant. Here, I picked them out for you:

![](vscode_colors@2x.png?t=1760553996)
...
![](brightness_hue@2x.webp?t=1760553996)
...
![](bg_highlight@2x.png?t=1760553996)
...
![](dyi40_alt.png?t=1760553996)

Okay, getting close. Let’s highlight comments:

![](dyi50.png?t=1760553996)
...
I’m Niki. Here I write about programming and UI design [Subscribe](/subscribe/)

I consult companies on all things Clojure: web, backend, Datomic, DataScript, performance, etc. Get in touch: [niki@tonsky.me](mailto:niki@tonsky.me)

I also create open-source stuff: Fira Code, DataScript, Clojure Sublimed, Humble UI. Support it on [Patreon](https://patreon.com/tonsky) or [Github](https://github.com/sponsors/tonsky)

![](/i/flashlight.webp?t=1760553996)