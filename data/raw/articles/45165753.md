...
I’m sure it’s frustrating to use slow software and know that you could have built it faster. I’ve been in that position myself. But tech companies are (mostly) rational economic actors who (mostly) do things because it’s profitable to do so. They’re not exclusively hiring elite performance engineers because those engineers _do not produce the most business value for the company_[1](#fn-1). Tech companies would like faster software, all things being equal. But they’re willing to trade off performance against a number of other things.
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/pure-and-impure-engineering/&t=Pure and impure software engineering).

June 22, 2025 │ Tags: [software design](/tags/software design/), [tech companies](/tags/tech companies/)

* * *

[subscribe](https://buttondown.com/seangoedecke) │ [about](/about) │ [popular](/popular) │ [rss](/rss.xml) │ [book](/book)

*   [← Everything I know about good system design](/good-system-design/)
*   [AI coding agents are already commoditized →](/ai-agents-are-commoditized/)