...
[Learn](/en/learn)[About](/en/about)[Download](/en/download)[Blog](/en/blog)[Docs](https://nodejs.org/docs/latest/api/)[Contribute](https://github.com/nodejs/node/blob/main/CONTRIBUTING.md)[Certification](https://training.linuxfoundation.org/openjs/)

[](https://github.com/nodejs/node)

# Node.js v22.18.0 (LTS)

[ADH](https://github.com/aduh95)

Antoine du Hamel

Node.js v22.18.0 (LTS)

## [2025-07-31, Version 22.18.0 'Jod' (LTS), @aduh95](#2025-07-31-version-22180-jod-lts-aduh95)

### [Notable Changes](#notable-changes)

#### [Type stripping is enabled by default](#type-stripping-is-enabled-by-default)
...
There are some limitations in the supported syntax documented at [https://nodejs.org/api/typescript.html#type-stripping](https://nodejs.org/api/typescript.html#type-stripping).
...
Windows 32-bit Installer: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-x86.msi](https://nodejs.org/dist/v22.18.0/node-v22.18.0-x86.msi)  
Windows 64-bit Installer: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-x64.msi](https://nodejs.org/dist/v22.18.0/node-v22.18.0-x64.msi)  
Windows ARM 64-bit Installer: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-arm64.msi](https://nodejs.org/dist/v22.18.0/node-v22.18.0-arm64.msi)  
Windows 32-bit Binary: [https://nodejs.org/dist/v22.18.0/win-x86/node.exe](https://nodejs.org/dist/v22.18.0/win-x86/node.exe)  
Windows 64-bit Binary: [https://nodejs.org/dist/v22.18.0/win-x64/node.exe](https://nodejs.org/dist/v22.18.0/win-x64/node.exe)  
Windows ARM 64-bit Binary: [https://nodejs.org/dist/v22.18.0/win-arm64/node.exe](https://nodejs.org/dist/v22.18.0/win-arm64/node.exe)  
macOS 64-bit Installer: [https://nodejs.org/dist/v22.18.0/node-v22.18.0.pkg](https://nodejs.org/dist/v22.18.0/node-v22.18.0.pkg)  
macOS Apple Silicon 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-darwin-arm64.tar.gz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-darwin-arm64.tar.gz)  
macOS Intel 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-darwin-x64.tar.gz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-darwin-x64.tar.gz)  
Linux 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-x64.tar.xz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-x64.tar.xz)  
Linux PPC LE 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-ppc64le.tar.xz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-ppc64le.tar.xz)  
Linux s390x 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-s390x.tar.xz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-s390x.tar.xz)  
AIX 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-aix-ppc64.tar.gz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-aix-ppc64.tar.gz)  
ARMv7 32-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-armv7l.tar.xz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-armv7l.tar.xz)  
ARMv8 64-bit Binary: [https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-arm64.tar.xz](https://nodejs.org/dist/v22.18.0/node-v22.18.0-linux-arm64.tar.xz)  
Source Code: [https://nodejs.org/dist/v22.18.0/node-v22.18.0.tar.gz](https://nodejs.org/dist/v22.18.0/node-v22.18.0.tar.gz)  
Other release files: [https://nodejs.org/dist/v22.18.0/](https://nodejs.org/dist/v22.18.0/)  
Documentation: [https://nodejs.org/docs/v22.18.0/api/](https://nodejs.org/docs/v22.18.0/api/)
...
[PrevNode.js v24.6.0 (Current)](/en/blog/release/v24.6.0)[NextNode.js v24.5.0 (Current)](/en/blog/release/v24.5.0)
...
[Edit this page](https://github.com/nodejs/nodejs.org/blob/main/apps/site/pages/en/blog/release/v22.18.0.md)

Table of Contents

1.  [2025-07-31, Version 22.18.0 'Jod' (LTS), @aduh95](#2025-07-31-version-22180-jod-lts-aduh95)
2.  [Notable Changes](#notable-changes)
3.  [Type stripping is enabled by default](#type-stripping-is-enabled-by-default)
4.  [Other notable changes](#other-notable-changes)
5.  [Commits](#commits)
6.  [SHASUMS](#shasums)

[v22.18.0Latest LTS](/blog/release/v22.18.0)[v24.6.0Latest Release](/blog/release/v24.6.0)
...
[](https://github.com/nodejs/node)[](https://discord.gg/nodejs)[](https://social.lfx.dev/@nodejs)[](https://bsky.app/profile/nodejs.org)[](https://twitter.com/nodejs)[](https://slack-invite.openjsf.org/)[](https://www.linkedin.com/company/node-js)
