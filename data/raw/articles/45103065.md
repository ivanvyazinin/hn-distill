...
Username and password authentication has largely been removed. Even the app-specific passwords on Google are now entirely undocumented. They are no longer exposed in the settings unless you [know the link](https://myaccount.google.com/apppasswords) [1](#fn-1).
...
1.  This OAuth dependency also puts Open Source projects in an interesting situation. For instance, the Thunderbird client ships with OAuth credentials for Google when you download it from Mozilla. However, if you self-compile it, you don’t have that access.[↩](#fnref-1)
    

This entry was tagged [security](/tags/security/) and [thoughts](/tags/thoughts/)

[copy as](/2025/9/2/passkeys.md) / [view](/2025/9/2/passkeys.md) markdown
