...
[Pyrefly Team](https://github.com/facebook/pyrefly)

![](/assets/images/why-typing-blog-6798a36e31db2a87069bd3636c0c97c2.png)
...
## What is Typed Python?[​](#what-is-typed-python "Direct link to What is Typed Python?")
...
### Dynamic vs static typing[​](#dynamic-vs-static-typing "Direct link to Dynamic vs static typing")
...
```
x = 5        # x is an integerx = "hello"  # now x is a stringx = [1,2,3]  # now x is a list
```
...
```
int x = 5;std::string x_str = "hello";std::vector<int> x_vec = {1, 2, 3};
```
...
### Enter PEP 484: Static Typing Comes to Python[​](#enter-pep-484-static-typing-comes-to-python "Direct link to Enter PEP 484: Static Typing Comes to Python")
...
```
def my_func(x: int, y: str) -> bool:    z: str = str(x)    return z == y
```
...
## Benefits of Python Type Hints: Write Better Code, Faster[​](#benefits-of-python-type-hints-write-better-code-faster "Direct link to Benefits of Python Type Hints: Write Better Code, Faster")
...
### Types help you catch bugs early[​](#types-help-you-catch-bugs-early "Direct link to Types help you catch bugs early")
...
```
def add_numbers(a, b):       return a + b...add_numbers(3, "4")  # Potential error
```
...
```
def add_numbers(a: int, b: int) -> int:  return a + b...add_numbers(3, "4")  # a typechecker will catch this error at time of writing
```
...
### Typed code is self-documenting[​](#typed-code-is-self-documenting "Direct link to Typed code is self-documenting")
...
```
def calculate_stats(data, weights):    total = 0    weighted_sum = 0    for i, value in enumerate(data):        if i < len(weights):            weighted_sum += value * weights[i]            total += weights[i]    avg = weighted_sum / total if total > 0 else 0    return avg, len(data)
```
...
```
def calculate_stats(data: list[float], weights: list[float]) -> tuple[float, int]:    total = 0    weighted_sum = 0    for i, value in enumerate(data):        if i < len(weights):            weighted_sum += value * weights[i]            total += weights[i]    avg = weighted_sum / total if total > 0 else 0    return avg, len(data)
```
...
### Typed Python helps you scale from proof-of-concept to production-ready[​](#typed-python-helps-you-scale-from-proof-of-concept-to-production-ready "Direct link to Typed Python helps you scale from proof-of-concept to production-ready")
...
## Get Started with Typed Python today![​](#get-started-with-typed-python-today "Direct link to Get Started with Typed Python today!")
...
### Step 0 - start early![​](#step-0---start-early "Direct link to Step 0 - start early!")
...
### Step 1 - install a type checker[​](#step-1---install-a-type-checker "Direct link to Step 1 - install a type checker")
...
### Step 2 - make use of resources to get better at typing[​](#step-2---make-use-of-resources-to-get-better-at-typing "Direct link to Step 2 - make use of resources to get better at typing")
...
*   [python-typing-basics](/blog/tags/python-typing-basics/)
...
](/blog/introducing-pyrefly/)

*   [What is Typed Python?](#what-is-typed-python)
    *   [Dynamic vs static typing](#dynamic-vs-static-typing)
    *   [Enter PEP 484: Static Typing Comes to Python](#enter-pep-484-static-typing-comes-to-python)
*   [Benefits of Python Type Hints: Write Better Code, Faster](#benefits-of-python-type-hints-write-better-code-faster)
    *   [Types help you catch bugs early](#types-help-you-catch-bugs-early)
    *   [Typed code is self-documenting](#typed-code-is-self-documenting)
    *   [Typed Python helps you scale from proof-of-concept to production-ready](#typed-python-helps-you-scale-from-proof-of-concept-to-production-ready)
*   [Get Started with Typed Python today!](#get-started-with-typed-python-today)
    *   [Step 0 - start early!](#step-0---start-early)
    *   [Step 1 - install a type checker](#step-1---install-a-type-checker)
    *   [Step 2 - make use of resources to get better at typing](#step-2---make-use-of-resources-to-get-better-at-typing)
