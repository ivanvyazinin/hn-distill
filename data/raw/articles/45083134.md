...
1.  [Strategies](#strategies)
    1.  [Chemistry First](#chemistry-first)
    2.  [Memory](#memory)
    3.  [Energy](#energy)
    4.  [Procrastination](#procrastination)
    5.  [Introspection](#introspection)
    6.  [Time](#time)
2.  [Tactics](#tactics)
    1.  [Task Selection](#task-selection)
    2.  [Visual Field Management](#visual-field-management)
    3.  [Project Check-Ins](#project-check-ins)
    4.  [Centralize Your Inboxes](#centralize-your-inboxes)
    5.  [Inbox Zero](#inbox-zero)
    6.  [Inbox Bankruptcy](#inbox-bankruptcy)
    7.  [Do It On Your Own Terms](#do-it-on-your-own-terms)
    8.  [Replace Interrupts with Polling](#replace-interrupts-with-polling)
    9.  [Accountability Buddy](#accountability-buddy)
    10.  [Plan First, Do Later](#plan-first-do-later)
    11.  [Derailment](#derailment)
    12.  [Using OCD to Defeat ADHD](#using-ocd-to-defeat-adhd)
    13.  [The Master of Drudgery](#the-master-of-drudgery)
    14.  [Thrashing](#thrashing)
    15.  [Put Travel in the Calendar](#put-travel-in-the-calendar)
    16.  [Choice of Tools](#choice-of-tools)
...
![A screenshot of my Todoist sidebar, showing a list of projects described below.](/assets/content/notes-on-managing-adhd/sidebar.webp)
...
![A screenshot of my desktop, showing Todoist on the leftmost one-third of the screen, and Emacs on the rightmost two-thirds of the screen.](/assets/content/notes-on-managing-adhd/desktop.webp)
...
![A screenshot of my calendar, showing an event to go to the dentist, bookended by two events to travel to and from the dentist.](/assets/content/notes-on-managing-adhd/travel.webp)
...
[Inboxes are Underrated](/article/inboxes-are-underrated)

Next

[Adding Planets to Celestia on macOS](/article/adding-planets-to-celestia-on-macos)
