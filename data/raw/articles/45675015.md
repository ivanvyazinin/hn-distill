...
![Dangerous site](/_app/immutable/assets/dangerous-site.CcDdEwz_.webp)
...
## ![Dangerous site appeal](/_app/immutable/assets/dangerous-site-appeal.XG05zUVf.webp)

* * *

Since, nothing is _actually_ wrong we decided to respond with the following:

Immich is a self-hosted application, and the Immich team ([https://immich.app/](https://immich.app/) ) owns and operates the `immich.cloud` domain and subdomains. The flagged sites are our own deployments of our own products and are not impersonating anything or anyone else.
...
](https://immich.app/privacy-policy)

* * *

[](https://github.com/immich-app/immich "GitHub")[](https://discord.immich.app/ "Discord")[](https://www.reddit.com/r/immich/ "reddit")[](https://x.com/immichapp "X")[](https://www.youtube.com/@immich-app "YouTube")[](https://hosted.weblate.org/projects/immich/immich/ "Weblate")[](https://immich.app/blog/feed.xml "RSS")