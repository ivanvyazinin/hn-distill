...
![ICEBlock handled my vulnerability report in the worst possible way](/content/images/size/w1200/2025/09/facepalm-deja-q.jpg)

Last week, I wrote about how Joshua Aaron's ICEBlock app, which allows people to anonymously report ICE sightings within a 5-mile radius, is – unfortunately, and despite apparent good intentions – [activism theater](https://micahflee.com/unfortunately-the-iceblock-app-is-activism-theater/). This was based on Joshua's talk at HOPE where he made it clear that he isn't taking the advice of local community groups, that ICE sightings aren't verified in any way, and that he doesn't know what he's doing when it comes to security and privacy.
...
Joshua runs two Bluesky accounts: [@iceblock.app](https://bsky.app/profile/iceblock.app), the account of the ICEBlock app, and [@joshua.stealingheather.com‬](https://bsky.app/profile/joshua.stealingheather.com), Joshua's personal account. His personal account had DMs closed, but the ICEBlock account had DMs open, so I sent him DMs there.
...
>   
> You seem to be running Apache httpd 2.4.57. See [https://httpd.apache.org/security/vulnerabilities\_24.html](https://httpd.apache.org/security/vulnerabilities_24.html) for more details, but this version of Apache has multiple critical CVEs which could take over your server. Like for example, this one [https://nvd.nist.gov/vuln/detail/CVE-2024-38476](https://nvd.nist.gov/vuln/detail/CVE-2024-38476)
...
> 
> — [Micah Lee (@micahflee.com)](https://bsky.app/profile/did:plc:uzucgmkg2y5vbkqnbv2on7g3?ref_src=embed) [2025-09-01T22:56:27.196Z](https://bsky.app/profile/did:plc:uzucgmkg2y5vbkqnbv2on7g3/post/3lxsp634clk22?ref_src=embed)

He didn't respond from the @iceblock.app account other than blocking me. (Which, honestly, isn't very fair, since I'm not ICE.)

![](https://micahflee.com/content/images/2025/09/Screenshot-2025-09-03-at-1.27.47---PM.png)

Screenshot from Bluesky of @iceblock.app blocking me after my responsible disclosure
...
![](https://micahflee.com/content/images/2025/09/Screenshot-2025-09-03-at-1.31.22---PM.png)

Screenshot from Bluesky DMs with @joshua.stealingheather.com telling me I'm lying about him and his app

A few days later, on September 3, I decided to check again. His server was _still_ running Apache 2.4.57, which has multiple vulnerabilities. He ignored my report and didn't fix it.

And just so you know, fixing this problem is _extremely easy_. He just needs to SSH in and run something like `sudo apt update && sudo apt upgrade`, wait for the Apache updated package to install, and his server would no longer be vulnerable.
...
>   
> Just so you're aware, I determined the version of Apache using nmap's version detection feature. You can run `nmap -p443 -sV iceblock.app` to test the version yourself, and it should show you this:  
>   
> PORT STATE SERVICE VERSION  
> 443/tcp open ssl/http Apache httpd 2.4.57 ((Unix) OpenSSL/3.0.9)  
>   
> As a reminder, you can find the known vulnerabilities for this version of Apache here: [https://httpd.apache.org/security/vulnerabilities\_24.html](https://httpd.apache.org/security/vulnerabilities_24.html)  
>   
> And, as I showed you before, just one of the vulns is CVE-2024-38476, which you can read about here: [https://nvd.nist.gov/vuln/detail/CVE-2024-38476](https://nvd.nist.gov/vuln/detail/CVE-2024-38476). This is a "critical" vulnerability that could potentially be used to execute scripts on your server. Please get back to me.

He didn't get back to me. And an hour and a half later, he blocked me from this account too.

![](https://micahflee.com/content/images/2025/09/Screenshot-2025-09-03-at-1.41.00---PM.png)

Screenshot from Bluesky DMs with @joshua.stealingheather.com, where I disclose his vulnerability again, and he blocks me

It's now been a week, and I checked again: Joshua's "HIGHLY secure" server is _still running a version of Apache with multiple known critical vulnerabilities_. And even with plenty of time to fix the issue, he still hasn't.
...
[← Previous](/unfortunately-the-iceblock-app-is-activism-theater/)
