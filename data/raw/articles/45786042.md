Can you save on LLM tokens using images instead of text? • PageWatch Blog    
...
*   [Setting up an experiment](#setting-up-an-experiment)
    *   [Converting the prompt to an image](#converting-the-prompt-to-an-image)
...
The prompt is simply the following:
    ...
    `List every hygiene tip from the collection, with a short sentence summary. List the titles * EXACTLY * as in the text Follow the following format: ** Title 1 ** - summary 1 ** Title 2 ** - summary 2 DO NOT ask any followup questions, simply return the list.`
...
To fit into the desired resolution, I had to break the prompt into two images; you can see them [here](/blog/images/screenshot_full_1.png) and [here](/blog/images/screenshot_full_2.png). When running the prompt, you have to specify both images with “detail”: “high”
...
© 2025 PageWatch. All rights reserved.