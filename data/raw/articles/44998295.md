...
🚀 Launching Explorer Agent•[Read more](/blog/explorer-agent/)

×

[![MinusX AI Data Scientist - main logo](/_next/static/media/logo.bda07120.svg)](/)

[

Docs

](https://docs.minusx.ai)[
...
[](/github/)[Star](https://github.com/minusxai/minusx)
...
If you're interested in Claude-Codifying your own LLM agent, I'd love to chat - ping me on [twitter](https://x.com/nuwandavek)! If you want trainable Claude Code like data agents for your Metabase, check out [MinusX](https://minusx.com) or set up a demo with me [here](https://minusx.com/demo). Happy (Claude) Coding!

[](https://x.com/nuwandavek "Vivek's Twitter/X")[](https://github.com/nuwandavek "Vivek's GitHub")[](https://www.linkedin.com/in/vivek-aithal "Vivek's LinkedIn")
...
Main Claude Code System PromptShow

All Claude Code ToolsShow

### Related Articles

*   [Read More Blog Posts](/blog/)
    
    New features, learnings, and insights from the MinusX team
    
*   [Explore Metabase AI](/metabase-ai/)
    
    Discover AI Data Engineer + Analyst for Metabase
    
*   [Choose Your Plan](/pricing/)
    
    Find the right MinusX plan for your Metabase AI needs
    

## Footer

[![SOC 2 Type 1 Certified](/soc2_type1.png)](/trust)

![GDPR Compliance in progress](/gdpr.webp)
...
![MinusX AI Data Scientist logo](/_next/static/media/logox.7257fc88.svg)

[Discord](/discord)[X](https://x.com/minusxai)[GitHub](https://github.com/minusxai)

[hi@minusx.ai](mailto:hi@minusx.ai)

© 2025 MinusX, Inc. All rights reserved.
...
*   [Github](/github)
*   [Docs](https://docs.minusx.ai)

### Features

*   [Metabase AI](/metabase-ai)
*   [MBQL AI Assistant](/mbql-ai-assistant)
*   [Dashboard Q&A](/metabase-dashboard-qa)
*   [Embedded AI](/embedded-metabase-ai)
