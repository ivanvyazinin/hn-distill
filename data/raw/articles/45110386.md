...
*   [Next: Branch Prediction Demystified](/blog/branch-prediction-demystified/)
*   [Indices, not Pointers](/blog/indices-not-pointers/)
...
*   *   [Smaller Nodes](#smaller-nodes)
    ...
    *   [Less Allocation Overhead](#less-allocation-overhead)
    *   [Instant Frees](#instant-frees)
    *   [A Downside - Freeing Single Nodes](#a-downside-freeing-single-nodes)
        *   [Freelists](#freelists)
...
![](/blog/indices-not-pointers/Layout-Comparison.svg)
...
![](/blog/indices-not-pointers/Arraylist-Resize.svg)
...
![](/blog/indices-not-pointers/Freelist-Allocation.svg)
