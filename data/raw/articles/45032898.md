Trying to get error backtraces in rust libraries right - Iroh
...
*   [Protocols](/proto)
*   [Roadmap](/roadmap)
*   [6.7k](https://github.com/n0-computer/iroh)

[Join Discord](https://iroh.computer/discord)

[Blog Index](/blog)

# Trying to get error backtraces in rust libraries right

August 22, 2025 by dig, b5, ramfox
...
## [Concrete-error writing guidelines](#concrete-error-writing-guidelines)

Here are some guidelines we’ve used while writing concrete-errors.

### Error enums are scoped to _**functions**_ not _**modules**_
...
We quickly realized that we needed some additional hierarchy: everything that can go wrong _before_ dialing, and the errors that occur _while_ dialing. Hence, we have the `DialError` enum nested inside the `ConnectError` enum.
...
## [The Tradeoffs Are Real](#the-tradeoffs-are-real)
...
For that, we wrote `n0-snafu` , a utility crate that allows for working with `snafu` (and other types of errors) with ease. It’s not _quite_ as ergonomic as if you were just using `anyhow` throughout your entire application, but again, we’ve already established that part of the game here is trade-offs.
...
[Discord](https://iroh.computer/discord)[Twitter](https://twitter.com/iroh_n0)[Bluesky](https://bsky.app/profile/iroh.computer)[Mastodon](https://mastodon.social/@n0iroh)[GitHub](https://github.com/n0-computer)[YouTube](https://www.youtube.com/@n0computer)
...
*   [dumbpipe](https://dumbpipe.dev)
*   [sendme](/sendme)

### Connect

*   [Discord](https://iroh.computer/discord)
*   [Discussion](https://github.com/n0-computer/iroh/discussions)
*   [Twitter](https://twitter.com/iroh_n0)
