...
*   [Importing global access chains](#importing-global-access-chains)
*   [Fast method calls](#fast-method-calls)
*   [Specialized builtin function calls](#specialized-builtin-function-calls)
*   [Optimized table iteration](#optimized-table-iteration)
*   [Optimized table length](#optimized-table-length)
*   [Creating and modifying tables](#creating-and-modifying-tables)
*   [Native vector math](#native-vector-math)
*   [Optimized upvalue storage](#optimized-upvalue-storage)
*   [Closure caching](#closure-caching)
*   [Fast memory allocator](#fast-memory-allocator)
*   [Optimized libraries](#optimized-libraries)
*   [Improved garbage collector pacing](#improved-garbage-collector-pacing)
*   [Reduced garbage collector pauses](#reduced-garbage-collector-pauses)
*   [Optimized garbage collector sweeping](#optimized-garbage-collector-sweeping)
