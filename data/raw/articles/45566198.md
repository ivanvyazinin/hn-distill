...
Configuration formats that humans can read and maintain, are hard for scripts to edit safely. With the new patch feature, RCL now has a principled way to enable safe, automated edits. [Read full post](/2025/automating-configuration-updates)
