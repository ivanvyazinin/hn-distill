Geedge & MESA Leak: Analyzing the Great Firewall’s Largest Document Leak                     [](https://gfw.report/blog/index.xml)
...
*   [Net4People Reading Group](https://github.com/net4people/bbs/issues/519)
...
*   Direct HTTPS download: [https://files.enlacehacktivista.org/geedge/](https://files.enlacehacktivista.org/geedge/)
...
*   [David Fifield’s notes on the related media reports](https://github.com/net4people/bbs/issues/519#issuecomment-3275640752)
*   [David Fifield’s notes on the technical write-ups](https://github.com/net4people/bbs/issues/519#issuecomment-3282101626)

## 6\. Analysis of Source Code Files

**The source-code portion of the leaked files has not yet been carefully analyzed.** This leak is significant and far-reaching. Given the large volume of material, GFW Report will continue to update our analysis and findings on the [current page](https://gfw.report/blog/geedge_and_mesa_leak/zh/) as well as on [Net4People](https://github.com/net4people/bbs/issues/519).

## 7\. Contact or Join Us

This report was first published on [GFW Report](https://gfw.report/blog/geedge_and_mesa_leak/en/). We also actively updated our analysis and findings on [Net4People](https://github.com/net4people/bbs/issues/519).

We encourage you to share questions, comments, analysis, or additional evidence on this topic, either publicly or privately. Our private contact information can be found in the footer of the [GFW Report](https://gfw.report) website.
...
**Contacts**  
Email: [\[email protected\]](/cdn-cgi/l/email-protection#e6818091c8948396899492a69694899289888b878f8ac885898b)  
