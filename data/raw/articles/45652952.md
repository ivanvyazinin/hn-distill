...
Several days ago, DeepSeek released a new [OCR paper](https://github.com/deepseek-ai/DeepSeek-OCR/blob/main/DeepSeek_OCR_paper.pdf). OCR, or “optical character recognition”, is the process of converting an image of text - say, a scanned page of a book - into actual text content. Better OCR is obviously relevant to AI because it unlocks more text data to train language models on[1](#fn-1). But there’s a more subtle reason why really good OCR might have deep implications for AI models.
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/text-tokens-as-image-tokens/&t=Should LLMs just treat text content as an image?).

October 21, 2025 │ Tags: [ai](/tags/ai/)

* * *

[subscribe](https://buttondown.com/seangoedecke) │ [about](/about) │ [popular](/popular) │ [rss](/rss.xml) │ [book](/book) │ [autodeck](https://autodeck.pro) │ [podcast!](https://youtu.be/R5TAZe4ye8U)

*   [← What have we learned about building agentic AI tools?](/ideas-in-agentic-ai-tooling/)
