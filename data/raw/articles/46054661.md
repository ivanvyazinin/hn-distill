...
# [dataHaskell](https://datahaskell.org/index.html)

*   [Home](https://datahaskell.org/index.html)
*   [Blog](https://datahaskell.org/blog.html)
*   [Docs](https://datahaskell.org/docs)
*   [Roadmap](https://www.datahaskell.org/docs/community/roadmap.html)
*   [Github](https://github.com/DataHaskell)
...
1) Reads a connection file to discover what ports to bind to. 2) Speaks the protocol correctly on those five channels. 3) Evaluates Haskell code when asked, and sends back results.
...
When Jupyter starts a kernel, it generates a connection file (represented by {connection\_file} in the args above). This ephemeral JSON file tells the kernel which ports to bind to for the five channels:
...
*   Ports: One per channel (shell\_port, iopub\_port, etc.).
*   Key + signature\_scheme: Used to sign messages (HMAC) so rogue processes can’t spoof messages.
...
*   [Join us on Discord](https://discord.gg/8u8SCWfrNC)

*   [dataHaskell](https://github.com/dataHaskell)
*   [datahaskell](https://twitter.com/datahaskell)
