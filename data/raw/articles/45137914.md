Lava RGB | amaiorano::blog                

[amaiorano::blog](/)

[Tags](/tags/)[About](/about/)
...
*   [Parts](#parts)
*   [The Build](#the-build)
    *   [Prepare NES main board](#prepare-nes-main-board)
        *   [Remove PPU](#remove-ppu)
        *   [Remove power module](#remove-power-module)
        *   [Push main board capacitors flat](#push-main-board-capacitors-flat)
    *   [Solder wires](#solder-wires)
    *   [Power module](#power-module)
    *   [Mod board](#mod-board)
    *   [First test](#first-test)
    *   [Multiout](#multiout)
        *   [Solder ribbon to multiout PCB](#solder-ribbon-to-multiout-pcb)
        *   [Second test](#second-test)
        *   [Cut shell for multiout connector](#cut-shell-for-multiout-connector)
    *   [Expansion audio](#expansion-audio)
    *   [Closing everything up](#closing-everything-up)
...
It was at this point that I tested expansion audio and realized it wasn’t working. After chatting with Toxic\_Tripod0 on Discord, I realized my mistake. To enable expansion audio without NESRGB, all that’s needed is a 47K resistor between pins 3 and 9. This PCB is expressly designed to route expansion audio to the NESRGB for processing. At this point, I could have removed the PCB, but I realized I could fix this relatively easily by removing the 1K resistor, and soldering a wire from the exposed pad to pin 3:
...
With everything back together, I hooked it up using my [SNES2VGA](/2024/02/05/snes2vga.html) with a VGA cable to my gbs-control:
...
I just wanted to give a quick shout out to the folks on the [ConsoleMods](https://consolemods.org/wiki/Main_Page) discord, especially Toxic\_Tripod0, manadream, and RobStrange for their help.

Please enable JavaScript to view the [comments powered by Disqus.](https://disqus.com/?ref_noscript)

[](/2025/09/03/lava-rgb.html)

## amaiorano::blog

*   Antonio Maiorano
*   [amaiorano@gmail.com](mailto:amaiorano@gmail.com)

*   [daroou2](https://www.twitch.tv/daroou2)
*   [antoniomaiorano](https://www.twitter.com/antoniomaiorano)
*   [daroou2](https://youtube.com/daroou2)
*   [amaiorano](https://github.com/amaiorano)
*   [amaiorano](https://www.linkedin.com/in/amaiorano)

Welcome to my blog, where you'll mainly find stuff related to programming, electronics, and retro console modding. All thoughts and opinions are my own, and do not represent those of my employer.