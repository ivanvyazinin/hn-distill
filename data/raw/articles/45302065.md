I regret building this $3000 Pi AI cluster | Jeff Geerling   [Skip to main content](#main-content)
...
![Raspberry Pi AI 10 node compute blade server](/sites/default/files/images/raspberry-pi-compute-blade-10-node-ai-server.jpeg)
...
![10 Node Pi Cluster Pricing](/sites/default/files/images/framework-vs-pi-cluster-pricing.png)
...
![Installing M.2 NVMe SSDs in Compute Blades](/sites/default/files/images/compute-blade-cluster-nvme-install.jpeg)
...
Compared to the $8,000 [Framework Cluster I benchmarked last month](/blog/2025/i-clustered-four-framework-mainboards-test-huge-llms), this cluster is about 4 times faster:

![Pi vs Framework Cluster HPL performance](/sites/default/files/images/framework-vs-pi-cluster-hpl-cluster.png)

But the Pi cluster is _slightly_ more energy efficient, on a Gflops/W basis:

![Pi vs Framework Cluster HPL Efficiency](/sites/default/files/images/framework-vs-pi-cluster-hpl-efficiency.png)

But what about price?

![Pi vs Framework Cluster Cost](/sites/default/files/images/framework-vs-pi-cluster-hpl-cost.png)
...
![AI model Llama 3.2 3B on Pi vs Framework vs N150](/sites/default/files/images/framework-vs-pi-cluster-ai-llama-32-3b.png)
...
![Pi vs Framework Cluster AI token generation](/sites/default/files/images/framework-vs-pi-cluster-ai-llama-33-70b-tg.png)
...
![Pi vs Framework Cluster AI token generation - dllama](/sites/default/files/images/framework-vs-pi-cluster-ai-llama-33-70b-tg-dllama.png)
...
![Gateworks Gblade server](/sites/default/files/images/gateworks-gblade-server.jpg)
...
![Compute Blade 10 node Raspberry Pi Cluster mini rack 1](/sites/default/files/images/compute-blade-cluster-front.jpeg)
...
*   [Sipeed NanoCluster fits 7-node Pi cluster in 6cm](/blog/2025/sipeed-nanocluster-fits-7-node-pi-cluster-6cm)
...
*   [Add new comment](/comment/reply/node/3496/comment_node_blog_post#comment-form "Share your thoughts and opinions.")
