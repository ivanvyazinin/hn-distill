...
*   [Products](/blog/moosestack-does-olap-need-an-orm#)
...
*   [Use cases](/blog/moosestack-does-olap-need-an-orm#)
...
*   [Resources](/blog/moosestack-does-olap-need-an-orm#)
    ...
    *   [Comparisons](/blog/moosestack-does-olap-need-an-orm#)
...
![](/uploads/fiveonefour_avatar_8b25b9739c.png)![](/uploads/neutral_avatar_400804ae96_5c370e757b.png)

Fiveonefour & ClickHouse Team

Aug 15, 2025 - 19 minutes read
...
[#](/blog/moosestack-does-olap-need-an-orm#oltp-orms-probably-shouldnt-extend-to-olap)
...
[#](/blog/moosestack-does-olap-need-an-orm#example-1-nullability-is-inverted)
...
[#](/blog/moosestack-does-olap-need-an-orm#example-2-uniqueness-is-fundamentally-different)
...
[#](/blog/moosestack-does-olap-need-an-orm#so-what-might-an-orm-for-olap-look-like)
...
[#](/blog/moosestack-does-olap-need-an-orm#applying-orm-principles-in-olap-with-moosestack)
...
[#](/blog/moosestack-does-olap-need-an-orm#schemas-as-composable-cross-system-code)
...
The base type can then be serialized to a Kafka schema registry, while the tags tell Moose how to map it in ClickHouse. This lets you leverage the same type definition across your Kafka topics _and_ your ClickHouse tables, preventing schema drift when data flows from your streams to your OLAP tables.
...
[#](/blog/moosestack-does-olap-need-an-orm#embracing-orm-like-typing-in-sql-for-complex-queries)
...
[#](/blog/moosestack-does-olap-need-an-orm#olap-first-schema-management-and-migrations)
...
[#](/blog/moosestack-does-olap-need-an-orm#migration-planning-in-moosestack)
...
[#](/blog/moosestack-does-olap-need-an-orm#expecting-and-handling-schema-drift)
...
[#](/blog/moosestack-does-olap-need-an-orm#conclusion-beyond-an-orm-for-olap)
...
![You can’t UPDATE what you can’t find: ClickHouse vs PostgreSQL](/uploads/medium_clickhouse_vs_postgresql_update_findn_e08095e2de.png)

Engineering

You can’t UPDATE what you can’t find: ClickHouse vs PostgreSQL

Al Brown and Tom Schreiber · Aug 13, 2025





](/blog/update-performance-clickhouse-vs-postgresql)
