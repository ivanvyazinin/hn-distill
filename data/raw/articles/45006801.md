...
When an API request succeeds, you know it did what it tried to do. What about when it fails? Some types of failure tell you what happened: a 422 typically means it failed during the request-validation stage, before any action was taken[3](#fn-3). But what about a 500? What about a timeout?
...
This is part of the idea behind [GraphQL](https://graphql.org/), a style of API where instead of hitting different endpoints per-operation, you craft a single query with all the data you need and the backend figures it out[6](#fn-6).
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/good-api-design/).

August 24, 2025 │ Tags: [good engineers](/tags/good engineers/), [software design](/tags/software design/)

* * *

[subscribe](https://buttondown.com/seangoedecke) │ [about / popular](/about) │ [rss](/rss.xml) │ [book](/book) │ [what I'm currently working on](https://github.blog/ai-and-ml/llms/solving-the-inference-problem-for-open-source-ai-projects-with-github-models/)

*   [← Don't feed me AI slop](/dont-feed-me-slop/)