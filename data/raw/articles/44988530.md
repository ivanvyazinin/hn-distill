...
[![cgit logo](/graffiti-vuxuorg.png)](/)
...
[about](/nitro/about/) [summary](/nitro/) [refs](/nitro/refs/) [log](/nitro/log/) [tree](/nitro/tree/) [commit](/nitro/commit/) [diff](/nitro/diff/)
...
*   `log`, a symlink to another service directory. The standard output of `run` is connected to the standard input of the service under `log` by a pipe. You can chain these for reliable and supervised log processing.
...
Leah Neukirchen [leah@vuxu.org](mailto:leah@vuxu.org)
...
generated by [cgit-pink 1.4.1](https://git.causal.agency/cgit-pink/about/) ([git 2.36.1](https://git-scm.com/)) at 2025-08-22 20:18:25 +0000