...
Engineers disagree a lot about what constitutes simple code. If “simplest” already means “with good design”, is it just a tautology to say “you should do the simplest thing that could possibly work?” In other words, is Unicorn really simpler than [Puma](https://github.com/puma/puma)[3](#fn-3)? Is adding in-memory rate limiting really simpler than using Redis? Here’s a rough, intuitive definition of simplicity[4](#fn-4):
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/the-simplest-thing-that-could-possibly-work/&t=Do the simplest thing that could possibly work).

August 28, 2025 │ Tags: [software design](/tags/software design/), [shipping](/tags/shipping/)
...
*   [← Finding the low-hanging fruit](/low-hanging-fruit/)