...
[](https://linkedin.com/in/softwaredoug)[](http://twitter.com/softwaredoug)[](mailto:doug@softwaredoug.com) [![](/assets/media/headshot2.jpg) Doug Turnbull](/)

[Consulting](/consulting) · [Training](http://maven.com/softwaredoug)
...
![image.png](/assets/media/reasoning-agents-need-bad-search/image.png)
...
![image.png](/assets/media/reasoning-agents-need-bad-search/image%201.png)
...
_( the doc string here becomes part of the prompt, see the [source code](https://github.com/softwaredoug/cheat-at-search/blob/main/cheat_at_search/agent/chat.py))_
...
The agent’s judgment is bound to be flawed / limited. Even in an ideal setting, it will _always_ be disjoint from what users want. Lack of user clickstream feedback is a [huge gap in RAG](https://softwaredoug.com/blog/2025/05/16/rags-big-blindspot) that continues here.
...
[![](/assets/media/2025/cheat-at-search-social.png)](https://maven.com/softwaredoug/cheat-at-search)
...
![](/assets/media/headshot2.jpg)

#### Doug Turnbull

[More from Doug](/)  
[Twitter](https://twitter.com/softwaredoug/) | [LinkedIn](https://www.linkedin.com/in/softwaredoug/) | [Newsletter](https://softwaredoug.kit.com/390a7f3a03) | [Bsky](https://bsky.app/profile/softwaredoug.bsky.social)  
[Take My New Course - Cheat at Search with LLMs](https://maven.com/softwaredoug/cheat-at-search)  

* * *

* * *

© 2025 SoftwareDoug LLC