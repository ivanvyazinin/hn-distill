...
1.  [Home](/)
2.  [Productivity](/categories/productivity/)

# My Journey from macOS to Arch Linux with Omarchy

## Switching macOS after 15 years.

[Productivity](/categories/productivity/) 2025-08-07 2250 words 11 minutes

![My Journey from macOS to Arch Linux with Omarchy](https://www.ssp.sh/blog/macbook-to-arch-linux-omarchy/featured-image.jpg)

Contents

*   [Getting Ready for the Switch](#getting-ready-for-the-switch)
    *   [The Tradeoffs](#the-tradeoffs)
*   [Omarchy: An Opinionated Arch Linux “Distro”](#omarchy-an-opinionated-arch-linux-distro)
*   [How It Began: Taking the Leap](#how-it-began-taking-the-leap)
    *   [Big Upside](#big-upside)
    *   [Downside](#downside)
    *   [My macOS Workflow](#my-macos-workflow)
    *   [Life with Arch Linux (Omarchy)](#life-with-arch-linux-omarchy)
*   [Choosing the Hardware](#choosing-the-hardware)
*   [I Learned Sooooo much (and Had Fun)](#i-learned-sooooo-much-and-had-fun)
...
*   ✅ photo program
*   ✅ daylight adjustment like [f.lux](https://justgetflux.com/)
...
[![/blog/macbook-to-arch-linux-omarchy/arch-btw.jpeg](/blog/macbook-to-arch-linux-omarchy/arch-btw.jpeg "/blog/macbook-to-arch-linux-omarchy/arch-btw.jpeg")](/blog/macbook-to-arch-linux-omarchy/arch-btw.jpeg "/blog/macbook-to-arch-linux-omarchy/arch-btw.jpeg")
...
[![/blog/macbook-to-arch-linux-omarchy/omarchy-coffee.webp](/blog/macbook-to-arch-linux-omarchy/omarchy-coffee.webp "/blog/macbook-to-arch-linux-omarchy/omarchy-coffee.webp")](/blog/macbook-to-arch-linux-omarchy/omarchy-coffee.webp "/blog/macbook-to-arch-linux-omarchy/omarchy-coffee.webp")  
...
I recorded my macOS workflow (_before_) as of now to document it before I potentially switch to Arch Linux with Omarchy. Let’s see 😉

However, I also showcase that most of my setup on macOS is very similar to the shortcut-driven Linux setup shown in Omarchy - workflow _after_ (now):
...
[![/blog/macbook-to-arch-linux-omarchy/omarchy-old-dell.webp](/blog/macbook-to-arch-linux-omarchy/omarchy-old-dell.webp "/blog/macbook-to-arch-linux-omarchy/omarchy-old-dell.webp")](/blog/macbook-to-arch-linux-omarchy/omarchy-old-dell.webp "/blog/macbook-to-arch-linux-omarchy/omarchy-old-dell.webp")  
...
[![/blog/macbook-to-arch-linux-omarchy/wifi-tui.webp](/blog/macbook-to-arch-linux-omarchy/wifi-tui.webp "/blog/macbook-to-arch-linux-omarchy/wifi-tui.webp")](/blog/macbook-to-arch-linux-omarchy/wifi-tui.webp "/blog/macbook-to-arch-linux-omarchy/wifi-tui.webp")  
...
[Linux](/tags/linux/)[Macbook](/tags/macbook/)[Arch](/tags/arch/)[Omarchy](/tags/omarchy/)[Thinkbook](/tags/thinkbook/)[Workflow](/tags/workflow/)[Hyprland](/tags/hyprland/)
