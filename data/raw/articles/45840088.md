...
Reading time • 13 min [Share this post on Twitter](https://twitter.com/share?text=You Should Write An Agent&url=https://fly.io/blog/everyone-write-an-agent/&via=flydotio) [Share this post on Hacker News](http://news.ycombinator.com/submitlink?u=https://fly.io/blog/everyone-write-an-agent/&t=You Should Write An Agent) [Share this post on Reddit](http://www.reddit.com/submit?url=https://fly.io/blog/everyone-write-an-agent/&title=You Should Write An Agent)
...
![](/blog/everyone-write-an-agent/assets/agents-cover.webp)
...
## [](#its-incredibly-easy)It’s Incredibly Easy
...
This is a trivial engine for an LLM app using the [OpenAI Responses API](https://platform.openai.com/docs/api-reference/responses). It implements ChatGPT. You’d drive it with the the obvious loop. It’ll do what you’d expect: the same thing ChatGPT would, but in your terminal.
...
_The_ [_‘M’ in “LLM agent”_](https://news.ycombinator.com/item?id=43600192) _stands for “MCP”_.
...
## [](#context-engineering-is-real)Context Engineering Is Real

I know it [wants my iron](https://www.decisionproblem.com/paperclips/) no matter what it tells me.
...
## [](#nobody-knows-anything-yet-and-it-rules)Nobody Knows Anything Yet And It Rules

Maybe neither will! Skeptics could be right. ([Seems unlikely though](https://www.darpa.mil/research/programs/ai-cyber).)
