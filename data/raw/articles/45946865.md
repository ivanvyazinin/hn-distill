...
[![](https://david.coffee/etc/dm.png)Home](https://david.coffee/ "Home (Alt + H)")

*   [about](https://david.coffee/about/ "about")
*   [projects+apps](https://david.coffee/projects/ "projects+apps")
*   [github](https://github.com/dvcrn "github") 
*   [mastodon](https://mastodon.d.sh/@david "mastodon") 
*   [twitter](https://twitter.com/dvcrn "twitter") 
*   [rss](https://david.coffee/index.xml "rss")

1.  [](https://david.coffee/)
2.  I finally understand Cloudflare Zero Trust tunnels

# I finally understand Cloudflare Zero Trust tunnels

September 22, 2025 · 14 min · 2822 words

![](https://david.coffee/cloudflare-zero-trust-tunnels/banner.jpeg)

Table of Contents

*   [Quickie: Cloudflare Zero Trust vs Tailscale](#quickie-cloudflare-zero-trust-vs-tailscale)
*   [Cloudflared != Warp](#cloudflared--warp)
*   [Tunnels, Routes, Targets](#tunnels-routes-targets)
    *   [Tunnels](#tunnels)
    *   [Routes](#routes)
    *   [Targets](#targets)
*   [Access Policies: Protecting Who Can Access What](#access-policies-protecting-who-can-access-what)
    *   [Allow public access to everyone logging into your network](#allow-public-access-to-everyone-logging-into-your-network)
    *   [Bypass login completely when connected through WARP](#bypass-login-completely-when-connected-through-warp)
*   [Deploying the Warp client and enrolling into Zero Trust](#deploying-the-warp-client-and-enrolling-into-zero-trust)
...
#### Exposing a private network to the public with tunnels quickly[#](#exposing-a-private-network-to-the-public-with-tunnels-quickly)
...
![Configuring a route in Zero Trust](./routes-configure.png)
...
![Configuring a target in Zero Trust](./targets-config-screen.png)
...
![Configuring an Access Policy with GitHub and email](./policy-github-emails.png)
...
![Policy to allow Gateway auth](./policy-gateway-auth.png)
...
In **Enrollment Permissions**, we specify the same policies for who can enroll. For example, “[\[email protected\]](/cdn-cgi/l/email-protection)” when authenticated through GitHub is allowed to enroll. In the _Login Methods_ we can specify what login methods are available when someone tries to enroll into our Zero Trust org.

![Login methods enroll policies](./enrollment-policy-login-methods.png)
...
![Device posture checks for Gateway and Warp](./device-posture-checks.png)
...
[« Prev  
microfn - Your favorite toolbox for tiny, composable functions](https://david.coffee/microfn/) [Next »  
Release: Quickshot AI Editor for iOS](https://david.coffee/quickshot-ai-editor-release/)

*   [](https://x.com/intent/tweet/?text=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels&url=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f&hashtags=)
*   [](https://www.linkedin.com/shareArticle?mini=true&url=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f&title=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels&summary=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels&source=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f)
*   [](https://reddit.com/submit?url=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f&title=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels)
*   [](https://facebook.com/sharer/sharer.php?u=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f)
*   [](https://api.whatsapp.com/send?text=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels%20-%20https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f)
*   [](https://telegram.me/share/url?text=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels&url=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f)
*   [](https://news.ycombinator.com/submitlink?t=I%20finally%20understand%20Cloudflare%20Zero%20Trust%20tunnels&u=https%3a%2f%2fdavid.coffee%2fcloudflare-zero-trust-tunnels%2f)
