Can you use GDPR to Circumvent BlueSky’s Adult Content Blocks? – Terence Eden’s Blog              
...
[BlueSky](https://shkspr.mobi/blog/tag/bluesky/) [gdpr](https://shkspr.mobi/blog/tag/gdpr/) [OnlineSafety](https://shkspr.mobi/blog/tag/onlinesafety/) · [1 comment](https://shkspr.mobi/blog/2025/09/can-you-use-gdpr-to-circumvent-blueskys-adult-content-blocks/#comments) · 1,200 words · Viewed ~474 times

* * *

In the battle between the Online Safety Act and GDPR, who will win? FIGHT!

I'll start by saying that I'm [moderately positive on Online Safety](https://shkspr.mobi/blog/2024/12/food-safety-vs-online-safety/). If services don't want to provide moderation then they shouldn't let their younger users be exposed to harm.

The social network BlueSky has taken a pragmatic approach to this. If you don't want to verify your age, you can still use its services - but [it won't serve you porn or let people send you non-public messages](https://bsky.app/profile/edent.tel/post/3ltmzgl5h4c2k).
...
There are two slight wrinkles with BSky's implementation. Firstly, there's no way to retrieve DMs which were sent before this restriction came into force. Oh, you can one-click export your data - but [it only includes _public_ data](https://docs.bsky.app/blog/repo-export). So no DMs.

Secondly, you can't turn off DM from people who have previously messaged you. [I asked people to message me](https://bsky.app/profile/edent.tel/post/3luoqklgdhk27) to see if they got an error - but it looks like the messages just get silently accepted. I probably look a bit rude if I don't answer them.

Worse still, the DM notification keeps incrementing!

![A notification counter showing the number 3. The message next to it says I need to complete age assurance.](https://shkspr.mobi/blog/wp-content/uploads/2025/07/Bluesky-DM-notification.webp)

It _is_ possible to turn off DMs - but [only if you can access your DM settings](https://bsky.social/about/blog/05-22-2024-direct-messages). Which you can't if you haven't passed age assurance.

Well, what about GDPR?

[BlueSky's privacy policy](https://bsky.social/about/support/privacy-policy#personal-information-collect) has this to say about DMs:
...
## [But why didn't you just…](#but-why-didnt-you-just)

This was definitely "playing on hard mode". There were other ways to get my DMs. Here are some alternatives which I didn't try and _why_ I didn't try them.
...
*   Use [the API](https://docs.bsky.app/docs/api/chat-bsky-convo-get-messages) to read DMs.
...
## One thought on “Can you use GDPR to Circumvent BlueSky's Adult Content Blocks?”

1.  ### ![](https://shkspr.mobi/favicons/?domain=mastodon.social) [Simon Wood](https://mastodon.social/@simonwood)
    
    [@blog](https://shkspr.mobi/blog) Re: You can’t access your DM settings without passing age verification.
    
    I just tried this, and although I have not age verified I was able access chat settings and set ‘allow new messages from’ to ‘no one’. Maybe this has changed recently?
    
    [Reply](https://shkspr.mobi/blog/2025/09/can-you-use-gdpr-to-circumvent-blueskys-adult-content-blocks/?replytocom=468722#respond) | [Reply to original comment on mastodon.social](https://mastodon.social/@simonwood/115287458332822485) [2025-09-29 12:56](#comment-468722)
...
2.  ![](data:image/svg+xml;base64,)
    ...
    ### [More comments on Mastodon](https://mastodon.social/@Edent/115287372889516385).
    

### What are your reckons? [Cancel reply](/blog/2025/09/can-you-use-gdpr-to-circumvent-blueskys-adult-content-blocks/#respond)
...
![](https://shkspr.mobi/blog/wp-content/themes/edent-wordpress-theme/info/okgo.php?ID=62143)