Branching With or Without PII: The Future of Environments - Neon[With great power comes great responsibility. Here’s a quick MCP safety cheatsheet to protect yourself (and your DB)![](/_next/static/svgs/9ee958f8b2be7694e4ce9140c14df68e.svg)](https://neon.com/blog/mcp-safety-cheatsheet/)
...
*   Product
    ...
    *   Database
        ...
        *   [
            ...
            BranchingFaster Postgres workflows
        ...
        *   [
            ...
            Connection poolerBuilt-in with pgBouncer
            
            ](/docs/connect/connection-pooling)
    *   Ecosystem
        *   [
            
            Neon APIManage infra, billing, quotas
        ...
        *   [
            ...
            Data APIPostgREST-compatible
            
            ](/docs/data-api/get-started)
        *   [
            
            InstagresNo-signup flow
            
            ](https://neon.new/)
        *   [
            
            Migration guidesStep-by-step
            
            ](/docs/import/migrate-intro)
    *   [![](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbanner-desktop.06c1a82a.jpg&w=384&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)![](/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbanner-mobile.46e1f677.jpg&w=640&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
...
[Discord](https://discord.gg/92vNTzKDGp)[20.2k](https://github.com/neondatabase/neon)

[Log In](https://console.neon.tech/login)[Sign Up](https://console.neon.tech/signup)

[Product](/blog/category/product)Nov 11, 2025

# Branching With or Without PII: The Future of Environments

Managing data across dev, test, and staging is painful. We built a way out

![Post image](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2FScreenshot-2025-11-10-at-10.25.16-AM.png&w=3840&q=85&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
...
## Environments Are a Time Sink[](#environments-are-a-time-sink)
...
> **  
> _(Miguel Hernandez, Backend Tech Lead at Neo.Tax)_
...
### The manual non-prod data lifecycle[](#the-manual-non-prod-data-lifecycle)

Most teams start simple – copy the production database and scrub it. They run pg\_dump, maybe write shell scripts to remove or redact sensitive data, and restore the dump into a staging instance. The hard reality is that production data changes often, especially as you’re shipping quickly or the business is growing. New tables, columns, and configs are added all the time, and the scripts quickly fall out of date. 
...
### Where the process tends to break[](#where-the-process-tends-to-break)
...
#### **Broken referential integrity**[](#broken-referential-integrity)
...
### The cost of keeping it all running[](#the-cost-of-keeping-it-all-running)
...
>   
> _(Thorsten Rieß, Software Architect at traconiq)_
...
## Branching as the Alternative[](#branching-as-the-alternative)
...
> (_Cody Jenkins, Head of Engineering at Invenco_)

## The Architecture Primitives of Branching [](#the-architecture-primitives-of-branching)
...
### WAL-first storage[](#wal-first-storage)
...
### Per-branch compute lifecycle[](#per-branch-compute-lifecycle)
...
> **  
> (_Avi Romanoff, Founder at Magic Circle_)
...
> **  
> (_Ryan McHenry, Head of Technology, Sharing Excess_)

### Ephemeral testing and CI environments[](#ephemeral-testing-and-ci-environments)
...
> **  
> _(Ahsan Nabi Dar, CTO and co-founder of DAT)_
...
> **  
> _(Dominik Koch, CEO and Co-Founder of Marble_)

## But what about PII? [](#but-what-about-pii)
...
## PII Won’t Stop You. Introducing Anonymized Branches[](#pii-wont-stop-you-introducing-anonymized-branches)

Adopting the branching workflows above could get tricky for teams handling sensitive data in prod – things like names, emails, addresses, payment details. That changes with our recent release of  
anonymized branches.
...
![Post image](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fimage-5.png&w=3840&q=85&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
...
![Post image](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fimage-7.png&w=3840&q=85&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
...
### Storage costs implications[](#storage-costs-implications)
...
## A New Way to Manage Environments[](#a-new-way-to-manage-environments)
...
> **_production → anonymized staging → anonymized dev/test/preview branches → delete branch_**
...
![Monica Steinke](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2024%2F10%2FMonica-Steinke.png&w=96&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)

Monica SteinkeTechnical Product Manager
...
*   [
    ...
    ![MCP Safety Cheatsheet ](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fneon-mcp-1-1.jpg&w=256&q=85&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
    
    ](/blog/mcp-safety-cheatsheet)
*   [
    
    # Integrating Postgres and Auth the Easy Way: Daisy’s Neon Setup
    
    Carlota Soto
    
    ![Integrating Postgres and Auth the Easy Way: Daisy’s Neon Setup](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fneon-daisy-1.jpg&w=256&q=85&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
    
    ](/blog/integrating-postgres-and-auth-the-easy-way-daisys-neon-setup)
*   [
    
    # Big DX Improvements for Neon Users on Vercel
    
    Gustavo Salomão
    
    ![Big DX Improvements for Neon Users on Vercel](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fneon-vercel-1.jpg&w=256&q=85&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
    
    ](/blog/big-dx-improvements-for-neon-users-on-vercel)
...
*   [![MCP Safety Cheatsheet ](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fneon-mcp-1-1.jpg&w=3840&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)](/blog/mcp-safety-cheatsheet)
    
    [AI](/blog/category/ai)Nov 19, 2025
    
    [
    
    # MCP Safety Cheatsheet 
    
    ![Ryan Vogel](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F03%2FRyan-Vogel.png&w=64&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
...
*   [![Integrating Postgres and Auth the Easy Way: Daisy’s Neon Setup](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fneon-daisy-1.jpg&w=3840&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)](/blog/integrating-postgres-and-auth-the-easy-way-daisys-neon-setup)
    
    [Case Studies](/blog/category/case-study)Nov 18, 2025
    
    [
    
    # Integrating Postgres and Auth the Easy Way: Daisy’s Neon Setup
    
    ![Carlota Soto](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2024%2F02%2Fcarlota.jpg&w=64&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
...
*   [![Big DX Improvements for Neon Users on Vercel](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F11%2Fneon-vercel-1.jpg&w=3840&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)](/blog/big-dx-improvements-for-neon-users-on-vercel)
    
    [Product](/blog/category/product)Nov 18, 2025
    
    [
    
    # Big DX Improvements for Neon Users on Vercel
    
    ![Gustavo Salomão](/_next/image?url=https%3A%2F%2Fneondatabase.wpengine.com%2Fwp-content%2Fuploads%2F2025%2F01%2FGustavo-Salomao.png&w=64&q=75&dpl=dpl_9PxkXyRaK45wyyNk3nUPj4LN9iiR)
