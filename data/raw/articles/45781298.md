...
![Jellyfin Logo](/images/logo.svg)![Jellyfin Logo](/images/logo.svg)

](/)

[Blog](/posts)[Downloads](/downloads)[Contribute](/contribute)[Documentation](/docs/)[Contact](/contact)[Forum](https://forum.jellyfin.org)

Recent posts

### 2025

*   [Jellyfin for Android TV 0.19](/posts/androidtv-v0.19.0)
*   [Jellyfin 10.11.0](/posts/jellyfin-release-10.11.0)
*   [SQLite concurrency and why you should care about it](/posts/SQLite-locking)
*   [Jellyfin for iOS 1.7.0](/posts/ios-v1.7.0)
*   [Jellyfin for Xbox 0.9.0](/posts/xbox-v0.9.0)
...
## The Premise[​](#the-premise "Direct link to The Premise")
...
## The W-A-L mode[​](#the-w-a-l-mode "Direct link to The W-A-L mode")
...
## SQLite transactions[​](#sqlite-transactions "Direct link to SQLite transactions")
...
## The Jellyfin factor[​](#the-jellyfin-factor "Direct link to The Jellyfin factor")
...
### Optimistic locking behavior[​](#optimistic-locking-behavior "Direct link to Optimistic locking behavior")
...
### Pessimistic locking behavior[​](#pessimistic-locking-behavior "Direct link to Pessimistic locking behavior")
...
### The future Smart locking behavior[​](#the-future-smart-locking-behavior "Direct link to The future Smart locking behavior")
...
*   [SQLite](/posts/tags/sq-lite)
*   [jellyfin](/posts/tags/jellyfin)
*   [locked-database](/posts/tags/locked-database)
...
](/posts/jellyfin-release-10.11.0)[
...
*   [The W-A-L mode](#the-w-a-l-mode)
*   [SQLite transactions](#sqlite-transactions)
*   [The Jellyfin factor](#the-jellyfin-factor)
*   [The solution](#the-solution)
    *   [Optimistic locking behavior](#optimistic-locking-behavior)
    *   [Pessimistic locking behavior](#pessimistic-locking-behavior)
    *   [The future Smart locking behavior](#the-future-smart-locking-behavior)

[Documentation](/docs)·[Feature Requests](https://features.jellyfin.org)·[Contribute](/contribute)·[Status](https://status.jellyfin.org)·[Contact](/contact)
