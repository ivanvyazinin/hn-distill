...
One interesting observation about em-dashes is that _GPT-3.5 did not use them_. GPT-4o used ~10x more em-dashes than its predecessor, and GPT-4.1 was even worse. However, Anthropic and Google’s models do use em-dashes. Even the open-source Chinese models use em-dashes[3](#fn-3). What changed between November 2022 and July 2024?
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/em-dashes/&t=Why do AI models use so many em-dashes?). Here's a preview of a related post that shares tags with this one.
...
> [Continue reading...](/good-code-reviews/)

* * *

[subscribe](https://buttondown.com/seangoedecke) │ [about](/about) │ [popular](/popular) │ [rss](/rss.xml) │ [autodeck](https://autodeck.pro)
