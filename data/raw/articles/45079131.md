...
[![](/assets/images/aura-logo.png)](/en)

[About](/en/about)[Blog](/en/blog)

Projects

[Aura](https://github.com/fosskers/aura)[Credit](https://github.com/fosskers/credit)[MapAlgebra](https://github.com/fosskers/mapalgebra)

* * *

[Haskell Libraries](http://hackage.haskell.org/user/fosskers)[Rust Crates](https://crates.io/users/fosskers)[Go Libraries](https://pkg.go.dev/search?q=fosskers)

* * *

[ScalaZ and Cats](https://github.com/fosskers/scalaz-and-cats)[Scala Benchmarks](https://github.com/fosskers/scala-benchmarks)

* * *

[My Dotfiles](https://github.com/fosskers/dotfiles)

Tools

[Al Bhed Translator](/en/tools/al-bhed)[Love Letter Tracker](/en/tools/love-letter)[Twitch Player](/en/tools/twitch)

Demos

[Game of Life](/en/demo/game-of-life)[Web Effects](/en/demo/web-effects)[Seed Effects](/en/demo/seed-effects)

[CV](/en/cv)

[](https://github.com/fosskers)[](https://x.com/fosskers)[](mailto:colin@fosskers.ca)[](/en/rss)[English](/en)[日本語](/jp)

Table of Contents

*   [Types are of the Sky](#orgcd1acb)

*   [Types for Correctness](#orgd71ed4)
*   [Types for Optimization](#orgc5d00e)
*   [Type Fluidity](#org3aaf3d)

*   [Classes are of the Earth](#org580418)

*   [Inheritance](#orgfb2d51)
*   [Generic Function Dispatch](#org97b2be)

*   [The Heart of the Machine](#orgcb53e4)

*   ["Abstract" Classes](#org28635e)
*   [Fixnums](#orgbce5a6)
...
I settled on Common Lisp two years ago because I found it to be the most debuggable language I had tried in my career. The time between discovery of the _What_ of a problem to the _Why_ is the shortest for me in this language, and this is due to how inspectable everything is.
...
It's doing this because at the moment it can't know what the type of `n` is. At best it could constrain it to `number`, but that's the type at [the top of the number tower](https://lispcookbook.github.io/cl-cookbook/numbers.html), and adding ints to floats is not going to be free.
...
In Common Lisp, types offer a notion of general compatibility between operations, but are in fact disconnected from their data presentations within Lisp itself. See for yourself:
...
Likely for performance reasons, the SBCL compiler is using its own internal implementation for this, whose true details we have basically no access to. While the type claims it's a `simple-array`, technically the implementation is under no obligation to _be_ a true array (in the C-sense) at all (although I'm sure it is). It only has to _act_ like one.
...
Thwarted: `0111`. Really the tag bit isn't even shown to us here. Yet I promise you that if we could ["get in"](https://simonsafar.com/2020/sbcl/) to that value on the hardware, we'd see the first four bits as `1110`. 8 became 16 in the assembly because:
...
As [Arjuna](https://en.wikipedia.org/wiki/Arjuna) asked Krishna, "Yeah okay, but now what?"
...
*   [Hyperspec: Introduction to Types](https://www.lispworks.com/documentation/HyperSpec/Body/04_a.htm)
*   [Type Hierarchy of Strings](https://lispcookbook.github.io/cl-cookbook/strings.html#string-and-character-types-hierarchy)
*   [SBCL Type Tags](https://www.chiark.greenend.org.uk/doc/sbcl/sbcl-internals/Type-tags.html)
*   [SBCL Object Representation](https://github.com/guicho271828/sbcl-wiki/wiki/Object-representation-%28lowtags%2C-widetags%2C-memory-consumption%2C-arrays%29)
...
*   [
    ...
    Quirks of Common Lisp TypesNew!
    
    ](/en/blog/cl-type-quirks)
*   [
...
*   [
    ...
    ](/en/blog/optimizing-common-lisp)
...
*   [
    ...
    Proven Complexity and Technology Choice
    
    ](/en/blog/proven-complexity)
*   [
    
    A Tour of the Lisps
    
    ](/en/blog/rounds-of-lisp)
...
*   [
    ...
    ](/en/blog/disk-encryption)
*   [
    
    Subsetting your Life
    
    ](/en/blog/subsetting-your-life)
*   [
    
    How much Lisp and C are in Emacs?
    
    ](/en/blog/emacs-c-lisp)
*   [
...
*   [
    ...
    O.S. Card: How Software Companies Die
    
    ](/en/blog/how-software-companies-die)

2022

*   [
    
    Yubikey-based SSH Keys
...
*   [
    ...
    ](/en/blog/turin-and-nellas)
*   [
    
    Software Development Languages: Haskell
    
    ](/en/blog/haskell-software-dev)
...
*   [
    ...
    ](/en/blog/arc-patterns)
*   [
    
    Contributing to Emacs
    
    ](/en/blog/contributing-to-emacs)
*   [
...
*   [
    ...
    ](/en/blog/rust-software-dev)
*   [
    
    Software Development Languages
    
    ](/en/blog/software-dev-langs)
*   [
...
*   [
    ...
    ](/en/blog/container-sizes)
*   [
    
    Terraform Remote State on S3
    
    ](/en/blog/remote-state)
*   [
    
    Extracting Subtitles from MP4 Files
    
    ](/en/blog/subtitle-extraction)
