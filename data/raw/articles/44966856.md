...
I am working as a software engineer at Amazon, and I write about programming, UX, interviewing and more - Opinions are my own

](https://www.mindflash.org/)

*   [Coding](https://www.mindflash.org/category/coding)
    
*   [Learn Programming](https://www.mindflash.org/category/coding/learn-programming)
    
*   [Work](https://www.mindflash.org/category/work)
    
*   [Tutorials](https://www.mindflash.org/category/tutorials)
    
*   [Resume](https://www.mindflash.org/resume)
...
[Home](https://www.mindflash.org/) » [Coding](https://www.mindflash.org/category/coding) » [AI](https://www.mindflash.org/category/coding/ai) » “AI First” and the Bus Factor of 0

# “AI First” and the Bus Factor of 0

![](https://www.mindflash.org/wp-content/uploads/2025/08/banner-bus-factor-2.jpg)

_All the opinions expressed in this article and on this website are entirely my own and do not represent my employer in any way._
...
And humanity has worked hard to keep itself far from this Bus Factor of 1. Brown-bag sessions, documentation, video tutorials, knowledge handovers, demos and showcases, without forgetting _schools_, and many more mechanisms in which an uncountable number of man-hours has been sunk.

![Cavemen holding a knowledge sharing session to increase their bus factor](https://www.mindflash.org/wp-content/uploads/2025/08/c07fb8c4-dd67-4388-8c6c-df38ce04bce0.jpg)
...
Focusing a bit on programming, it seems like a growing part of the industry is now happy to let LLMs generate functions, entire features, or even complete projects ([security holes included](https://news.ycombinator.com/item?id=44157131)). They have moved on from understanding their code-base and preserving this knowledge to actively trying to avoid having any piece of knowledge about their project to begin with, preferring instead to “vibe”.
...
![a programmer looking confused at hieroglyphs on his computer](https://www.mindflash.org/wp-content/uploads/2025/08/c07fb8c4-dd67-4388-8c6c-df38ce04bce0-1.jpg)
...
If vibe coding isn’t for you and you want to read more articles, check out my category dedicated to advice about [learning programming](https://www.mindflash.org/category/coding/learn-programming).