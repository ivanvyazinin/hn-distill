...
![Joannis Orlandos](https://www.github.com/joannis.png?size=64 "Joannis is the chair of the Android Workgroup, member of the Server Workgroup and maintainer of Hummingbird.") [Joannis Orlandos](https://github.com/joannis/ "Joannis Orlandos (@joannis) on GitHub")

October 24, 2025 ![Featured blog image with the screenshot of Android Studio with Swift code](/assets/images/swift-sdk-for-android-blog/blog-hero@2x.png) ![Featured blog image with the screenshot of Android Studio with Swift code](/assets/images/swift-sdk-for-android-blog/blog-hero-dark@2x.png)
...
## Getting Started[](#getting-started "Permalink for Getting Started section")
...
## Next Steps[](#next-steps "Permalink for Next Steps section")
...
![Joannis Orlandos](https://www.github.com/joannis.png?size=64) [Joannis Orlandos](https://github.com/joannis/ "Joannis Orlandos (@joannis) on GitHub")
...
*   ### Introducing Swift Profile Recorder: Identifying Performance Bottlenecks in Production
    ...
    Swift Profile Recorder, an in-process sampling profiler for Swift services, is..
    
    [More](/blog/swift-profile-recorder/)
...
*   [](https://x.com/swiftlang "Follow @SwiftLang on X")
*   [](https://bsky.app/profile/swift.org "Follow @swift.org on Bluesky")
*   [](https://mastodon.social/@swiftlang "Follow @swiftLang on Mastodon")
*   [](/atom.xml "Subscribe to Site Updates")