...
[Subscribe to Updates](#subscribe-modal-72f99lh1cj2c)
...
Subscribe to updates for **Model output quality** via email and/or text message. You'll receive email notifications when incidents are updated, and text message notifications whenever Anthropic **creates** or **resolves** an incident.
