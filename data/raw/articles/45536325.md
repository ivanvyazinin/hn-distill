...
[![](https://ramsayleung.github.io/apple-touch-icon.png)Home](https://ramsayleung.github.io/en/ "Home (Alt + H)")

*   |
*   [Zh](https://ramsayleung.github.io/zh/ "中文")

*   [Archives](https://ramsayleung.github.io/en/archives/ "Archives")
*   [Search](https://ramsayleung.github.io/en/search/ "Search (Alt + /)")
*   [Tags](https://ramsayleung.github.io/en/tags/ "Tags")
*   [About](https://ramsayleung.github.io/en/about_me "About")
*   [RSS](https://ramsayleung.github.io/en/index.xml "RSS")

[Home](https://ramsayleung.github.io/en/) » [Posts](https://ramsayleung.github.io/en/post/)

# A Story About Bypassing Air Canada's In-flight Network Restrictions

October 10, 2025 · 9 min · 1843 words | [Suggest Changes](https://github.com/ramsayleung/ramsayleung.github.io/blob/master/content/post/2025/a_story_about_bypassing_air_canada%27s_in-flight_network_restrictions.md)

Table of Contents

*   [1 Prologue](#prologue)
*   [2 The Process](#the-process)
*   [3 Approach 1: Domain Self-Signing](#approach-1-domain-self-signing)
*   [4 Approach 2: DNS Port Masquerading](#approach-2-dns-port-masquerading)
    *   [4.1 Arbitrary DNS Servers](#arbitrary-dns-servers)
    *   [4.2 TCP Queries](#tcp-queries)
    *   [4.3 Proxy Service on Port 53](#proxy-service-on-port-53)
*   [5 Ultimate Approach: DNS Tunnel](#ultimate-approach-dns-tunnel)
...
For example, if you type `https://acwifi.com` and only focus on the network request part, the general process is: DNS query -> TCP connection -> TLS handshake -> HTTP request and response.
 ...
 ![](/ox-hugo/network_request_sequence_en.png)
...
Since `acwifi.com` is accessible but `github.com` is not, could I disguise my server as `acwifi.com` and route all request traffic through my server to access the target website (`github.com`)?
 ...
 ![](/ox-hugo/self-sign-certificate-en.png)
...
My roommate spent about an hour setting up a proxy server exposing port 53 using [xray](https://github.com/XTLS/Xray-core) [1](#fn:1), and sent me the configuration via WeChat:
...
And I already had an xray client on my computer, so no additional software was needed to establish the connection.
 ...
 ![](/ox-hugo/dns-server-proxy-en.png)
...
Currently, the gateway only checks whether the port is 53 to determine if it’s a DNS request. But if the gateway were stricter and inspected the content of DNS request packets, it would discover that our requests are “disguised” as DNS queries rather than genuine DNS queries:
 ...
 ![](/ox-hugo/intercept-dns-request-en.png)
...
1.  [https://github.com/XTLS/Xray-core](https://github.com/XTLS/Xray-core) [↩︎](#fnref:1)
    

*   [Network](https://ramsayleung.github.io/en/tags/network/)
*   [Hacking](https://ramsayleung.github.io/en/tags/hacking/)

[Next »  
A Telegram Spam Blocker Bot Based On Bayesian Algorithm](https://ramsayleung.github.io/en/post/2025/a_telegram_spam_blocker_bot_based_on_bayesian/)

*   [](https://x.com/intent/tweet/?text=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions&url=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f&hashtags=network%2chacking)
*   [](https://www.linkedin.com/shareArticle?mini=true&url=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f&title=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions&summary=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions&source=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f)
*   [](https://reddit.com/submit?url=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f&title=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions)
*   [](https://facebook.com/sharer/sharer.php?u=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f)
*   [](https://api.whatsapp.com/send?text=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions%20-%20https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f)
*   [](https://telegram.me/share/url?text=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions&url=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f)
*   [](https://news.ycombinator.com/submitlink?t=A%20Story%20About%20Bypassing%20Air%20Canada%27s%20In-flight%20Network%20Restrictions&u=https%3a%2f%2framsayleung.github.io%2fen%2fpost%2f2025%2fa_story_about_bypassing_air_canadas_in-flight_network_restrictions%2f)
