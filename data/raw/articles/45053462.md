...
[![Lucy the star, Gleam's mascot](/images/lucy/lucy.svg)Gleam](/)

[News](/news)[Community](/community)[Sponsor](/sponsor)

[Packages](https://packages.gleam.run)[Docs](/documentation)[Code](https://github.com/gleam-lang)

# Optimising for maintainability
...
![Return Icon](/images/share-icon.svg)Share

[Strand](https://www.strand-uk.com) is a marketing agency based in London, UK. The company specialises in copywriting and content creation for many of the world’s largest enterprise technology companies, running marketing programmes that produce hundreds of white papers, case studies, blog posts and articles every year.
...
![Lucy the star, Gleam's mascot](/images/lucy/lucy.svg)

#### Ready to start your Gleam journey?

Check out the [language tour](https://tour.gleam.run) and [documentation](/documentation).

Already using it in production? [Share your story with us](/community), we'd love to hear all about it!
