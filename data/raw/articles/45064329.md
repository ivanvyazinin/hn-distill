...
[Projects](/projects/)[Blog](/blog/)[About](/about/)[Donations](/donations/)[Chatbot Arena (graduated)](https://lmarena.ai)

[](mailto:lmsys.org@gmail.com)[](https://slack.sglang.ai)[](https://github.com/lm-sys)[](https://twitter.com/lmsysorg)[](https://lmsys.org/rss.xml)
...
[](mailto:lmsys.org@gmail.com)[](https://discord.gg/HSWAKCrnFx)[](https://github.com/lm-sys)[](https://twitter.com/lmsysorg)[](https://lmsys.org/rss.xml)
...
![](/images/blog/large_scale_ep/overall-arch.png)
...
![](/images/blog/large_scale_ep/parallel-design.png)

### [](#sparse-ffns)Sparse FFNs
...
### [](#issues-with-unified-scheduling)Issues with Unified Scheduling
...
![](/images/blog/large_scale_ep/pd-disaggregation.png)
...
### [](#expert-parallelism-with-deepep)Expert Parallelism with DeepEP
...
### [](#deepgemm-integration)DeepGEMM Integration
...
##### [](#abstraction-for-clean-implementation)Abstraction for Clean Implementation
...
##### [](#prefill-overlapping-implementation)Prefill Overlapping Implementation
...
![](/images/blog/large_scale_ep/tbo-prefill.png)

### [](#expert-parallelism-load-balancer)Expert Parallelism Load Balancer
...
![](/images/blog/large_scale_ep/eplb-balancedness.png)

##### [](#eplb-for-real-world-serving)EPLB for Real-World Serving
...
##### [](#implementation-of-rebalancing)Implementation of Rebalancing
...
##### [](#performance-analysis-of-prefill-and-decode-phases)Performance Analysis of Prefill and Decode Phases
...
![](/images/blog/large_scale_ep/e2e-prefill-decode.png)
...
##### [](#overall-throughput)Overall Throughput
...
![](/images/blog/large_scale_ep/profile-prefill.png)
...
![](/images/blog/large_scale_ep/profile-decode.png)
...
### [](#ablation-study-two-batch-overlap)Ablation Study: Two-batch Overlap

##### [](#impact-of-batch-size-and-attention-time)Impact of Batch Size and Attention Time

This section investigates TBO performance across varying batch sizes and simulated MTP scenarios.

![](/images/blog/large_scale_ep/tbo-overall.png)
...
##### [](#detail-breakdown-1)Detail Breakdown
...
![](/images/blog/large_scale_ep/tbo-breakdown-prefill.png)
...
![](/images/blog/large_scale_ep/tbo-breakdown-decode.png)

### [](#ablation-study-eplb)Ablation Study: EPLB
...
![](/images/blog/large_scale_ep/eplb-throughput.png)

##### [](#case-study-workload-imbalance-versus-overall-throughput)Case Study: Workload Imbalance Versus Overall Throughput
...
![](/images/blog/large_scale_ep/eplb-throughput-vs-imbalance.png)
...
##### [](#case-study-expert-distribution-statistics)Case Study: Expert Distribution Statistics

The following figure presents expert distribution statistics for prefill and decode sample data:

![](/images/blog/large_scale_ep/eplb-stat.png)
...
### [](#disposable-tensor)Disposable Tensor
...
### [](#expert-workload-extraction-and-simulation)Expert Workload Extraction and Simulation
