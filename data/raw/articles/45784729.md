From 400 Mbps to 1.7 Gbps: A WiFi 7 Debugging Journey :: The Tymscar Blog![](https://librecounter.tymscar.com/counter.svg)
...
# [From 400 Mbps to 1.7 Gbps: A WiFi 7 Debugging Journey](/posts/wifi7speedhunt/)

2025-11-01Oscar Molnar6 min read (1172 words)

#[networking](/tags/networking/)  #[wifi](/tags/wifi/)  #[unifi](/tags/unifi/)  #[debugging](/tags/debugging/)  #[performance](/tags/performance/) 
...
## The disappointing numbers[#](#the-disappointing-numbers)
...
## False start #1: “Maybe I’m testing wrong”[#](#false-start-1-maybe-im-testing-wrong)
...
## Finding the first bottleneck[#](#finding-the-first-bottleneck)
...
## False start #2: “It’s a 2.5 GbE problem”[#](#false-start-2-its-a-25-gbe-problem)
...
## The actual issue: 80 MHz, not 160 MHz[#](#the-actual-issue-80-mhz-not-160-mhz)
...
## Why certain iperf flags matter[#](#why-certain-iperf-flags-matter)
...
## Why no 2×2 client hits 2.5 Gbps on WiFi[#](#why-no-22-client-hits-25-gbps-on-wifi)
...
[\[When Curl Works But IntelliJ Doesn’t: The Ollama Connection Mystery\] >](/posts/intellijollamaconnectionmystery/)
