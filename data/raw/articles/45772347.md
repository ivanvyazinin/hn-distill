Nix derivation madness | Farid Zakaria’s Blog                       

# Nix derivation madness

Published 2025-10-29 on [Farid Zakaria's Blog](/)
...
Thinking back to a previous post, I remember touching on [modulo fixed-output derivations](/2025/03/28/what-s-in-a-nix-store-path). Is that what’s going on? Let’s investigate from first principles. 🤓
...
Let’s test this all out by changing our `fod.nix` derivation. Let’s do this by just adding some _garbage_ attribute to the derivation.
...
[Improve this page @ 7492cd3](https://github.com/fzakaria/fzakaria.com/tree/7492cd35f274d0feeed079fc8454f1c7cd1a2977/_posts/2025-10-29-nix-derivation-madness.md)  
