Anthropic Status - API, Claude.ai, and Console services impacted                                  

# API, Claude.ai, and Console services impacted

Incident Report for [Anthropic](/)

[Subscribe to Updates](#subscribe-modal-k6gkm2b8cjk9)

## Monitoring

A fix has been implemented and we are monitoring the results.

Posted Sep 10, 2025 - 17:15 UTC
...
[← Current Status](/) [Powered by Atlassian Statuspage](https://www.atlassian.com/software/statuspage?utm_campaign=status.anthropic.com&utm_content=SP-notifications&utm_medium=powered-by&utm_source=inapp)

[×](#)

#### Subscribe to Incident

Subscribe to updates for **API, Claude.ai, and Console services impacted** via email and/or text message. You'll receive email notifications when incidents are updated, and text message notifications whenever Anthropic **creates** or **resolves** an incident.
