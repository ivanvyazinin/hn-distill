...
## [](#its-all-about-unix)It’s all about UNIX
...
## [](#sending-messages-using--signals)Sending messages using signals
...
## [](#sending-sigusr1-and-sigusr2)Sending SIGUSR1 and SIGUSR2
...
### [](#decoding-the-binary-data)Decoding the binary data
...
### [](#sending-the-letter-h)Sending the letter “h”
...
### [](#building-the-sender)Building the sender
...
### [](#sending-the-hello-message)Sending the “hello” message
...
## [](#a-modest-message-broker-using-unix-signals)A modest message broker using UNIX signals
...
Powered by [Curupira](https://github.com/leandronsp/curupira) | Open source blog platform built with Phoenix LiveView

Licensed under [AGPL-3.0](https://github.com/leandronsp/curupira/blob/master/LICENSE)