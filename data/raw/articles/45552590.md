A whirlwind introduction to dataflow graphs | The ryg blog                                                                 
...
[Twitter](http://twitter.com/rygorous)

[The ryg blog](https://fgiesen.wordpress.com/)

When I grow up I'll be an inventor.

*   [Home](https://fgiesen.wordpress.com/)
*   [About](https://fgiesen.wordpress.com/about/)
*   [Coding](https://fgiesen.wordpress.com/category/coding/)
*   [Compression](https://fgiesen.wordpress.com/category/compression/)
*   [Computer Architecture](https://fgiesen.wordpress.com/category/computer-architecture/)
*   [Demoscene](https://fgiesen.wordpress.com/category/demoscene/)
*   [Graphics Pipeline](https://fgiesen.wordpress.com/category/graphics-pipeline/)
*   [Maths](https://fgiesen.wordpress.com/category/maths/)
*   [Multimedia](https://fgiesen.wordpress.com/category/multimedia/)
*   [Networking](https://fgiesen.wordpress.com/category/networking/)
*   [Papers](https://fgiesen.wordpress.com/category/papers/)
*   [Stories](https://fgiesen.wordpress.com/category/stories/)
*   [Thoughts](https://fgiesen.wordpress.com/category/thoughts/)
*   [Uncategorized](https://fgiesen.wordpress.com/category/uncategorized/)
...
*   There is _some_ limit W (“width”) on how many new instructions we can start per clock cycle. In-flight instructions don’t interfere with each other; as long as we have enough independent work, we can start W new instructions every cycle. We’re going to treat W as variable.
...
This model can be understood as approximating either a [dataflow architecture](https://en.wikipedia.org/wiki/Dataflow_architecture), an out-of-order machine with a very large issue window (and infinitely fast front-end), or a statically scheduled in-order machine running code compiled with a Sufficiently Smart Scheduler. (The kind that actually exists; e.g. a compiler implementing [software pipelining](https://en.wikipedia.org/wiki/Software_pipelining)).

Furthermore, I’m assuming that while there is explicit control flow (unlike a pure dataflow machine), there is a branch prediction mechanism in place that allows the machine to guess the control flow path taken arbitrarily far in advance. When these guesses are correct, the branches are effectively free other than still taking an instruction slot, during which time the machine checks whether its prediction was correct. When the guess was incorrect, the machine reverts all computations that were down the incorrectly guessed path, and takes some number of clock cycles to recover. If this idea of branch prediction is new to you, I’ll refer you to [Dan Luu’s excellent article](http://danluu.com/branch-prediction/) on the subject, which explains both how and why computers would be doing this.
...
[![Dataflow graph for basic array sum](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/array_sum-gv1.png?w=497)](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/array_sum-gv1.png)
...
[![Dataflow graph for linked list sum](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/linked_list_sum-gv.png?w=497)](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/linked_list_sum-gv.png)
...
[![Dataflow graph for indirect array sum](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/array_indir_sum-gv.png?w=497)](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/array_indir_sum-gv.png)
...
We have a kernel with four instructions here. Out of these four, two (“Load” and “Sum”) do the actual work we want done, whereas “Advance” and “Done?” just implement the loop itself and are essentially overhead. This type of loop is a prime target for [unrolling](https://en.wikipedia.org/wiki/Loop_unrolling), where we collapse two or more iterations of the loop into one to decrease the overhead fraction. Let’s not worry about the setup or what to do when the number of elements in the array is odd right now, and only focus on the “meat” of the loop. Then a 2× unrolled version might look like this:
...
[![Dataflow graph for unrolled array sum, first attempt](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/unroll2x_array_sum1-gv.png?w=497)](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/unroll2x_array_sum1-gv.png)
...
[![Dataflow graph for unrolled array sum, second attempt](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/unroll2x_array_sum2-gv.png?w=497)](https://fgiesen.wordpress.com/wp-content/uploads/2018/03/unroll2x_array_sum2-gv.png)
...
From → [Computer Architecture](https://fgiesen.wordpress.com/category/computer-architecture/)

One Comment[](#respond "Leave One →")

1.  ![Rodéric's avatar](https://0.gravatar.com/avatar/63f1dc66906eb6e541dab17019c7159914fb693854970a2c8f466b721ab82436?s=40&d=identicon&r=G)
    
    [Rodéric](http://www.beyond3d.com) [permalink](https://fgiesen.wordpress.com/2018/03/05/a-whirlwind-introduction-to-dataflow-graphs/#comment-11093)
    
    Nice article :)  
    You might want to change : “Because dataflow and data dependencies is because they can be viewed as” to “Because dataflow and data dependencies can be viewed as”
    
    [Reply](https://fgiesen.wordpress.com/2018/03/05/a-whirlwind-introduction-to-dataflow-graphs/?replytocom=11093#respond)
    

### Leave a comment [Cancel reply](/2018/03/05/a-whirlwind-introduction-to-dataflow-graphs/#respond)

   

Δ

« [Reading bits in far too many ways (part 3)](https://fgiesen.wordpress.com/2018/09/27/reading-bits-in-far-too-many-ways-part-3/)

[Reading bits in far too many ways (part 2)](https://fgiesen.wordpress.com/2018/02/20/reading-bits-in-far-too-many-ways-part-2/) »

*   ## Recent Posts
    
    *   [Content creator](https://fgiesen.wordpress.com/2025/07/06/content-creator/)
    *   [Oodle 2.9.14 and Intel 13th/14th gen CPUs](https://fgiesen.wordpress.com/2025/05/21/oodle-2-9-14-and-intel-13th-14th-gen-cpus/)
    ...
    *   [MRSSE](https://fgiesen.wordpress.com/2024/11/14/mrsse/)
    ...
    *   [When is a BCn/ASTC endpoints-from-indices solve singular?](https://fgiesen.wordpress.com/2024/08/29/when-is-a-bcn-astc-endpoints-from-indices-solve-singular/)
*   ## Categories
...
*   ## Archives
    ...
    *   [July 2025](https://fgiesen.wordpress.com/2025/07/)
    *   [May 2025](https://fgiesen.wordpress.com/2025/05/)
    *   [December 2024](https://fgiesen.wordpress.com/2024/12/)
    *   [November 2024](https://fgiesen.wordpress.com/2024/11/)
    *   [October 2024](https://fgiesen.wordpress.com/2024/10/)
    *   [August 2024](https://fgiesen.wordpress.com/2024/08/)
    *   [October 2023](https://fgiesen.wordpress.com/2023/10/)
    *   [July 2023](https://fgiesen.wordpress.com/2023/07/)
    *   [May 2023](https://fgiesen.wordpress.com/2023/05/)
    *   [March 2023](https://fgiesen.wordpress.com/2023/03/)
    *   [November 2022](https://fgiesen.wordpress.com/2022/11/)
    *   [October 2022](https://fgiesen.wordpress.com/2022/10/)
    *   [September 2022](https://fgiesen.wordpress.com/2022/09/)
