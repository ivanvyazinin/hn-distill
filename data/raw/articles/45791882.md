...
Anyways, yet again I came across a real life application of Algorithms. This time in the OG tool `git`. `git bisect - Use binary search to find the commit that introduced a bug` [ref](]\(https://git-scm.com/docs/git-bisect\)). And Leetcode wanted you to know it [First Bad Version](https://leetcode.com/problems/first-bad-version/description/?envType=problem-list-v2&envId=binary-search)
...
[](/git/2025/11/02/At-the-end-you-use-git-bisect.html)
...
*   [kevin3010](https://github.com/kevin3010)
*   [kevin-jivani](https://www.linkedin.com/in/kevin-jivani)
