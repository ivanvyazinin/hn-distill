Broccoli Man, Remastered • mbleigh.dev  [skip to content](#main)
...
*   [#Making Broccoli Man Remastered](#making-broccoli-man-remastered)
    *   [#Overall Process](#overall-process)
    *   [#Preproduction](#preproduction)
    *   [#Production](#production)
    *   [#Postproduction](#postproduction)
*   [#So, is it slop?](#so-is-it-slop)

# Broccoli Man, Remastered

November 16, 2025 / 10 min read

[ai](/tags/ai/), [fun](/tags/fun/)

Within Google there is a series of videos starring “Broccoli Man” poking fun at the experience of building software as a Googler. One of these, [“I just want to serve 5TB”](https://www.youtube.com/watch?v=3t6L-FlfeaI), circulated extremely widely and ended up getting published publicly to YouTube. It’s a Google cultural classic that still resonates 15 years later (though with _mostly_ different specifics thwarting Googlers’ ability to “just” do simple things).

A few Saturdays ago I found myself in need of distraction and with some hours to spare. I had recently been reminded of the Broccoli Man video and decided to recreate it using the latest and greatest AI technology available at Google.

I was pretty pleased with the result!

In a single day, using Veo 3.1 and Nano Banana, I was able to create a 4-minute short film that has plenty of glitches and inconsistencies but I felt captured the spirit of the original.
...
![a screengrab of my directory full of reference images](/_astro/refs_folder.CbJoOYLJ_Z1oEPBL.webp)
...
*   **Specific character interactions.** Trying to get complex movements out of the characters was tough especially if it involved them directly interacting with each other. Trying to get the chibi anime sword slashing was _very_ difficult because it combined this issue with guardrails and “doing anything fast”.
...
![my final capcut timeline](/_astro/capcut_timeline.j_KHXZao_28Wbk4.webp)
