...
[Ramon van Sprundel](https://ramones.dev)

 [![github](https://ramones.dev/social_icons/github.svg)](https://github.com/van-sprundel/)[![linkedin](https://ramones.dev/social_icons/linkedin.svg)](https://www.linkedin.com/in/ramon-van-sprundel-6456701b1/)

[/posts](https://ramones.dev/posts) [/projects](https://ramones.dev/projects) [/hire-me](https://ramones.dev/hire-me) [/rss](https://ramones.dev/rss.xml)

LinkedIn is loud, and corporate is hell..

Posted on 2025-11-22 :: Tags: [linkedin](https://ramones.dev/tags/linkedin/), [corporate](https://ramones.dev/tags/corporate/), [hell](https://ramones.dev/tags/hell/)
...
*   _AI steers towards the use of `.unwrap()`_
*   _LinkedIn man doesn't fact check anything or reads the post-mortem_

Result: "Le unwrap is le dangerous. Here's how the unwrap works"
...
Fast-forward a few months, we now have 3 managers, 1 dev (hi), and a buttload of busywork that needs to be done yesterday. From what I understand, a manager is supposed to be your safetynet and keep the context switching to a minimum. Tickets should feel like little updates, yet they take up 40% of my work (which could've been spent on solutioning). Since I'm the lead dev, any busywork will move tickets further back. This also means I'm to blame, because I should've been way earlier with alerting _them_ about the project's drift. I'M NOT A PM! It's my job to make the project and keep you up to date. If this isn't sufficient then go to the PM (oh wait, that's not me!). Another big issue I have with this workflow is that we're sometimes moving priorization mid-cycle due to client requests. This is fine if it wasn't low priority stuff a client _wants_ but doesn't _need_.
