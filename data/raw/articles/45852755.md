...
@[renerocksai](https://renerocks.ai/)

☰

[Home](/)

[Blog](/blog/) [![](/Feed-icon.svg)](/blog/index.xml)

[Projects](/projects/) [![](/Feed-icon.svg)](/projects/index.xml)

[About](/about/) [GitHub](https://github.com/renerocksai)

# TigerFans: Building a High-Performance Ticketing System with TigerBeetle

November 02, 2025 • 17 min read • by **renerocksai**
...
So I built it. Three days later, I had a working demo. What started as an educational project became a 19-day optimization journey that pushed the system to 977 ticket reservations per second—15x faster than the Oasis baseline[1](#fn-1). All in Python.
...
But then Joran turned it into a friendly challenge. He mentioned the Oasis ticket sale[1](#fn-1)—approximately 1.4 million tickets over six hours, or roughly 65 tickets per second. Then came the kicker: _“It would be pretty sweet if you could do better than six hours.”_
...
[← Using build.zig.zon to Report Your Zig Package Version at Runtime](/blog/2025-04-27--version-in-zig/)   or   [Back to the Homepage](/)