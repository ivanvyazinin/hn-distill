...
*   [About](#about)
*   [News](#news)
*   [Getting Mosh](#getting)
*   [Usage](#usage)
*   [Technical Info](#techinfo)
*   [FAQ](#faq)
*   [Contact](#contact)
*   [Mosh on GitHub](https://github.com/mobile-shell/mosh)
...
[Getting Mosh »](#getting) [Tech Video »](#techinfo)
...
*   **Aug. 22, 2012**: Mosh (and its tolerance for high packet loss) helps Iain Learmonth [escape from an elevator](elevator.txt).
...
### [![](macosx.png)](https://www.apple.com)macOS 10.10 or later

Binary package: [![](dmg.png) mosh-1.4.0.pkg](https://github.com/mobile-shell/mosh/releases/download/mosh-1.4.0/mosh-1.4.0.pkg).
...
### [![](homebrew2.png)](https://mxcl.github.io/homebrew/)Homebrew OS X 10.5 or later

$ brew install mosh

  

### [![](macports.png)](https://www.macports.org)MacPorts OS X 10.5 or later
...
![](mosh-chrome.png)   Install [Mosh for Chrome.](https://chrome.google.com/webstore/detail/mosh/ooiklbnjmhbcgemelgfhaeaocllobloj)
...
### [![](Cygwin_logo.svg)](https://www.cygwin.com)Cygwin
...
### [![](Android_Robot_100.png)](https://www.android.com/)Android

![](JuiceSSH.png)   [Install JuiceSSH from the Play Store](https://play.google.com/store/apps/details?id=com.sonelli.juicessh)  
  
or...  
  
![](assets/img/termux.png)   [Install Termux from F-Droid](https://f-droid.org/en/packages/com.termux)

  

### [![](chrome.png)](https://www.google.com/chrome)Chrome / Chrome OS

![](mosh-chrome.png)   Install [Mosh for Chrome.](https://chrome.google.com/webstore/detail/mosh/ooiklbnjmhbcgemelgfhaeaocllobloj)

### ![](App-store-icon.png)iOS

![](blink_shell.png)   [Install Blink Shell from the App Store](https://itunes.apple.com/app/id1156707581)  
  
or...  
  
![](GitHub-Mark-32px.png)   [build it from source.](https://github.com/blinksh/blink)

### [![](alpinelinux-logo.png)](https://alpinelinux.org)Alpine Linux

\# apk add mosh

  

### [![](arch.png)](https://www.archlinux.org) Arch Linux

\# pacman -S mosh

  

### [![](debian.png)](https://www.debian.org)Debian squeeze-backports and later  

$ sudo apt-get install mosh

### [![](fedora.png)](https://getfedora.org)Fedora 15 or later

$ sudo dnf install mosh

### [![](gentoo.png)](https://www.gentoo.org) Gentoo

\# emerge net-misc/mosh

  

### [![](GuixSD-V.png)](http://www.gnu.org/software/guix)GuixSD
...
### [![](openSUSE.png)](https://www.opensuse.org) openSUSE 12.3 or later

$ sudo zypper in mosh

  

### [![](ubuntu.png)](http://www.ubuntu.com)Ubuntu 12.04 and later
...
### [![](freebsd.png)](https://www.freebsd.org) FreeBSD

\# pkg install net/mosh

  

### [![](ppuf100X91.gif)](https://www.openbsd.org)OpenBSD

\# pkg\_add mosh

  

### [![](NetBSD-smaller-tb.png)](https://www.netbsd.org)NetBSD (pkgsrc)

\# cd net/mosh; make install clean

### [![](opencsw.png)](https://www.opencsw.org)OpenCSW Solaris 10 Update 8 or later
...
Extract [mosh-1.4.0.tar.gz](https://github.com/mobile-shell/mosh/releases/download/mosh-1.4.0/mosh-1.4.0.tar.gz) (SHA-256 in [signed release announcement](mosh-1.4.0-released.html)), then
...
$ git clone [https://github.com/mobile-shell/mosh](https://github.com/mobile-shell/mosh)
$ cd mosh
$ ./autogen.sh
$ ./configure
$ make
...
![](terminal-shots/firstcol-xterm.png.2.png)  
xterm: circumflex on wrong letter.

![](terminal-shots/firstcol-gnome.png.2.png)  
GNOME Terminal: no circumflex at all.

![](terminal-shots/firstcol-osx.png.2.png)  
OS X Terminal.app gets it right.

![](terminal-shots/firstcol-mosh.png.2.png)  
...
![](terminal-shots/acs-xterm.png.2.png)  
xterm

![](terminal-shots/acs-gnome.png.2.png)  
GNOME Terminal

![](terminal-shots/acs-osx.png.2.png)  
OS X Terminal.app

![](terminal-shots/acs-mosh.png.2.png)  
Mosh
...
![](terminal-shots/unicode-and-escape-xterm.png.2.png)  
xterm: circumflex on wrong letter.

![](terminal-shots/unicode-and-escape-gnome.png.2.png)  
GNOME Terminal's circumflex placement is defensible.

![](terminal-shots/unicode-and-escape-osx.png.2.png)  
OS X Terminal.app applies circumflex to part of escape sequence, then irretrievably shuts off keyboard input.

![](terminal-shots/unicode-and-escape-mosh.png.2.png)  
...
To diagnose the problem, run `locale` on the local terminal, and `ssh _remotehost_ locale`. To use Mosh, both sides of the connection will need to show a UTF-8 locale, like `LC_CTYPE="en_US.UTF-8"`.
...
mosh _remotehost_ **\--server="LANG=en\_US.UTF-8 mosh-server"**
...
mosh _remotehost_ **\--ssh="ssh -p 2222"**
...
mosh _remotehost_ **\--ssh="ssh -o GSSAPITrustDns=no"**
...
Please see the entries for `MOSH_SERVER_NETWORK_TMOUT` and `MOSH_SERVER_SIGNAL_TMOUT` in the _mosh-server(1)_ man page.
...
Copyright 2012 Keith Winstein <[\[email protected\]](/cdn-cgi/l/email-protection)\>
...
We welcome your contribution! Please join us in `#mosh` channel on [Libera Chat](https://libera.chat/) IRC, [visit us on GitHub](https://github.com/mobile-shell), or email `[[email protected]](/cdn-cgi/l/email-protection)`. To contribute to our code base, please fork the repository on GitHub and open a pull request there.
...
*   At the recommendation of the security community, **confidential security-related matters** may be sent to: `[[email protected]](/cdn-cgi/l/email-protection)`  
    
    Messages may optionally be encrypted with [Keith Winstein's public key](keithw-gpg.txt):
