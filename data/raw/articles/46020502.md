...
[mcp blog](http://blog.modelcontextprotocol.io/ "mcp blog (Alt + H)")

*   [Documentation](https://modelcontextprotocol.io/docs "Documentation") 
*   [GitHub](https://github.com/modelcontextprotocol "GitHub") 

[Home](http://blog.modelcontextprotocol.io/) » [Posts](http://blog.modelcontextprotocol.io/posts/)
...
## Standardization for interactive interfaces[#](#standardization-for-interactive-interfaces)
...
## MCP Apps Extension specification[#](#mcp-apps-extension-specification)
...
#### Pre-declared resources[#](#pre-declared-resources)
...
#### MCP transport for communication[#](#mcp-transport-for-communication)
...
*   [Apps](http://blog.modelcontextprotocol.io/tags/apps/)
*   [Ui](http://blog.modelcontextprotocol.io/tags/ui/)
*   [User Interfaces](http://blog.modelcontextprotocol.io/tags/user-interfaces/)

[Next »  
Adopting the MCP Bundle format (.mcpb) for portable local servers](http://blog.modelcontextprotocol.io/posts/2025-11-20-adopting-mcpb/)

© 2025 [mcp blog](http://blog.modelcontextprotocol.io/) · Powered by [Hugo](https://gohugo.io/) & [PaperMod](https://github.com/adityatelange/hugo-PaperMod/)
