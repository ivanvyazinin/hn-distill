...
[![](/blog/img/logo.png)Kennedn's Blog](/blog)
...
*   There are _two_ public keys used to send passwords to the device — one that is shared with the client and another super secret one that’s hardcoded in the app. The easiest way to figure out which one to use is to flip a coin.
...
[Modchipping a fridge](/blog/posts/fridgepwn/)

© Joshua Kennedy 2024

Site code is open source 🔓︎ and can be found [here](https://github.com/kennedn/kennedn.github.io)