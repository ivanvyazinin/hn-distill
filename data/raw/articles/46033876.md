...
For filtering network I use a simplified version of partitioning pyramids from [Neural Partitioning Pyramids for Denoising Monte Carlo Renderings](https://balint.io/nppd/nppd_paper.pdf) :

![](/assets/gen_cats/nppd.png)

With a few tricks from [Bartlomiej Wronski: Procedural Kernel Networks](https://arxiv.org/pdf/2112.09318) to make it more efficient:
...
\[1\][Understand Diffusion Models with VAEs](https://yonigottesman.github.io/2023/03/11/vae.html)

\[2\][Variational Autoencoders and Diffusion Models](https://cs231n.stanford.edu/slides/2023/lecture_15.pdf)

\[3\][Generative modelling in latent space](https://sander.ai/2025/04/15/latents.html)

\[4\][Back to Basics: Let Denoising Generative Models Denoise](https://arxiv.org/pdf/2511.13720v1)

\[5\][Neural Partitioning Pyramids for Denoising Monte Carlo Renderings](https://balint.io/nppd/nppd_paper.pdf)

\[6\][Bartlomiej Wronski: Procedural Kernel Networks](https://arxiv.org/pdf/2112.09318)

\[7\][The Unreasonable Effectiveness of Deep Features as a Perceptual Metric](https://arxiv.org/pdf/1801.03924)

[](/jekyll/update/2025/11/22/generating_cats.html)

## Index

*   Index
*   [antonschrein@gmail.com](mailto:antonschrein@gmail.com)

*   [aschrein](https://github.com/aschrein)
*   [antonschrein](https://www.twitter.com/antonschrein)