...
*   [My Browser DevTools Use Cases](#toc_0)
*   [Problems with Common Browser DevTools for Your Agent](#toc_1)
*   [Embracing Bash (and Code)](#toc_2)
    *   [The Start Tool](#toc_3)
    *   [The Navigate Tool](#toc_4)
    *   [The Evaluate JavaScript Tool](#toc_5)
    *   [The Screenshot Tool](#toc_6)
*   [The Benefits](#toc_7)
*   [Adding the Pick Tool](#toc_8)
*   [Adding the Cookies Tool](#toc_9)
*   [A Contrived Example](#toc_10)
*   [Making This Reusable Across Agents](#toc_11)
*   [In Conclusion](#toc_12)

After months of agentic coding frenzy, Twitter is still ablaze with discussions about MCP servers. I previously did some [very light benchmarking](/posts/2025-08-15-mcp-vs-cli/) to see if Bash tools or MCP servers are better suited for a specific task. The TL;DR: both can be efficient if you take care.
