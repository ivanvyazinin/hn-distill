...
*   [Products](/blog/optimizing-clickhouse-intel-high-core-count-cpu#)
...
*   [Use cases](/blog/optimizing-clickhouse-intel-high-core-count-cpu#)
...
*   [Resources](/blog/optimizing-clickhouse-intel-high-core-count-cpu#)
    ...
    *   [Comparisons](/blog/optimizing-clickhouse-intel-high-core-count-cpu#)
...
[42.9k](https://github.com/ClickHouse/ClickHouse?utm_source=clickhouse&utm_medium=website&utm_campaign=website-nav)[Sign in](https://console.clickhouse.cloud/signIn)[Get started](https://console.clickhouse.cloud/signUp?loc=nav-get-started)
...
![](/uploads/Jiebin_Sun_02e4b94b87.jpeg)![](/uploads/Zhiguo_Zhou_08a336995d.jpeg)![](/uploads/Wangyang_Guo_92f765ec89.jpeg)![](/uploads/Tianyou_Li_ec54ea302e.jpeg)

Jiebin Sun, Zhiguo Zhou, Wangyang Guo, Tianyou Li

Sep 17, 2025 - 27 minutes read
...
The results have been exciting: individual optimizations routinely deliver speedups of multiple times for individual queries, in some cases up to 10x. The geometric mean of all 43 ClickBench queries consistently improved between 2% and 10% per optimization. The results demonstrate that ClickHouse can be made scale very well on ultra-high core count systems.
...
_Performance degradation with increased core count_

![intel_img_2.png](/uploads/intel_img_2_d019431938.png)

_Pipeline visualization (max\_threads=80) - the merge phase is reasonable_

![intel_img_3.png](/uploads/intel_img_3_b28b847281.png)

_Pipeline visualization (max\_threads=112) - the merge phase takes 3.2x longer_
...
_Performance improvement after parallel conversion - Q5 achieves 264% improvement_
...
_Perf analysis showing 36.6% cycles in ProfileEvents::increment_
...
_After optimization: ProfileEvents::increment drops to 8.5% (from 36.6%)_
...
_ClickBench Q3: 27.4% improvement, with larger gains on higher core count systems_
...
_For questions about implementation details or performance reproduction, please refer to the individual PR discussions linked throughout this post._
...
![September 2025 newsletter](/uploads/medium_Newsletter_Cover_Facebook_Post_10_2fc735890d.png)

Community

September 2025 newsletter

Mark Needham · Sep 18, 2025





](/blog/202509-newsletter)

[

![Build ClickHouse-powered APIs with React and MooseStack](/uploads/medium_Build_Click_House_powered_AP_Is_with_React_and_Moose_Stack_748a2e457e.png)

Engineering

Build ClickHouse-powered APIs with React and MooseStack

Fiveonefour & ClickHouse Team · Sep 16, 2025





](/blog/clickhouse-powered-apis-in-react-app-moosestack)

[

![How Exabeam uses ClickHouse for scalable, searchable security analytics](/uploads/medium_blog_banner_exabeam_f3371d87d9.png)

User stories

How Exabeam uses ClickHouse for scalable, searchable security analytics

ClickHouse Team · Sep 11, 2025





](/blog/exabeam-clickhouse-security-analytics)

[

![How Lyft powers batch and real-time analytics with ClickHouse Cloud](/uploads/medium_484843464_6d06f916_d640_4118_a1e8_573cfb434a2a_b9b0d2e508.png)

User stories

How Lyft powers batch and real-time analytics with ClickHouse Cloud

ClickHouse Team · Sep 10, 2025





](/blog/lyft-analytics-clickhouse-cloud)
