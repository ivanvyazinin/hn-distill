Minisforum stuffs an entire Arm Homelab in the MS-R1 | Jeff Geerling   [Skip to main content](#main-content)
...
![Minisforum MS-R1 front](/sites/default/files/images/minisforum-ms-r1-front.jpg)
...
![Minisforum MS-R1 open chassis rear ports](/sites/default/files/images/minisforum-ms-r1-open-rear.jpg)
...
![Minisforum MS-R1 U.2 adapter in WiFi card slot](/sites/default/files/images/minisforum-ms-r1-u2-adapter-wifi-e-key-slot.jpg)
...
![Minisforum Geekbench 6 Arm benchmark MS-R1](/sites/default/files/images/minisforum-ms-r1-benchmark-geekbench-6.jpg)
...
![Minisforum HPL graph with other Arm systems](/sites/default/files/images/minisforum-ms-r1-benchmark-hpl-glflops-revised.png)
...
![Minisforum HPL graph - efficiency](/sites/default/files/images/minisforum-ms-r1-benchmark-hpl-efficiency-revised.png)

But the efficiency story is _much_ worse considering the idle power draw:

![Minisforum MS-R1 - Idle power draw](/sites/default/files/images/minisforum-ms-r1-benchmark-power-idle-arm_0.jpg)
...
![Minisforum c2clat Cix SoC Arm](/sites/default/files/images/minisforum-ms-r1-cix-c2clat.jpg)

![Minisforum MS-R1 Memory Access benchmark](/sites/default/files/images/minisforum-ms-r1-benchmark-memory-access_0.jpg)
...
![Minisforum MS-R1 AI CPU benchmarks vs Arm systems](/sites/default/files/images/minisforum-ms-r1-ai-cpu-benchmarks-llama.jpg)
...
![Minisforum MS-R1 rear with Nvidia RTX A2000 installed](/sites/default/files/images/minisforum-ms-r1-gpu-installed-pcie-rear.jpg)
...
![Minisforum MS-R1 Cix BIOS screen](/sites/default/files/images/minisforum-ms-r1-cix-bios.jpg)
...
![Minisforum MS-R1 AI benchmark on RTX A2000](/sites/default/files/images/minisforum-ms-r1-benchmark-ai-a2000.jpg)
...
*   [All Intel GPUs run on Raspberry Pi and RISC-V](/blog/2025/all-intel-gpus-run-on-raspberry-pi-and-risc-v)
    
*   [Orion O6 ITX Arm V9 board - temper your expectations](/blog/2025/orion-o6-itx-arm-v9-board-temper-your-expectations)
...
*   [Add new comment](/comment/reply/node/3511/comment_node_blog_post#comment-form "Share your thoughts and opinions.")

## Comments

Jeff Geerling – [3 days ago](/comment/36374#comment-36374)

Just wanted to note after some discussion over in the [sbc-reviews issue for the MS-R1](https://github.com/geerlingguy/sbc-reviews/issues/89), I'm re-running my HPL top500 benchmark with the correct optimizations for the Cix CPU and will update the HPL benchmark and efficiency graphs in the post.

*   [Reply](/comment/reply/node/3511/comment_node_blog_post/36374)

spuwho – [3 days ago](/comment/36376#comment-36376)

Minis Forum is advertising Proxmox support for virtualization. All of the builds I have seen previously for this are unsupported or custom. It appears there is a build based on Debian ARM64? Does it work? Is it viable? I see people running routing software (like OpenWRT) on these VM's.

*   [Reply](/comment/reply/node/3511/comment_node_blog_post/36376)

Jeff Geerling – [3 days ago](/comment/36377#comment-36377)

In reply to [Minis Forum is advertising…](/comment/36376#comment-36376) by spuwho

Their [PVE install guide for the MS-R1](https://github.com/minisforum-docs/MS-R1-Docs/blob/main/PlayBook/MS-R1-How-To-Install-PVE.md) seems to use [the pxvirt fork of Proxmox](https://github.com/jiangcuo/pxvirt) targeting Arm and LoongArch architectures. It's not an officially supported way to get Proxmox going, but it does work.

*   [Reply](/comment/reply/node/3511/comment_node_blog_post/36377)

Yalc Relyk – [2 days ago](/comment/36383#comment-36383)

Do note that those "Abovetop" cards are not modified A2000s they are actually mobile A2000s. Desktop A2000s have either 6GB or 12GB of VRAM and the dual slot cooler that can infact be modified by nerdwares all copper single slot cooler. The Desktop cards also have 4 mini Displayports and not the more standard 1 DP 1 HDMI that you would see on gaming cards. There is also the terrible AMD RX 6400 that would fit in these but no-one should ever use a 4GB GPU in 2025.

*   [Reply](/comment/reply/node/3511/comment_node_blog_post/36383)

DestinationUnknown – [2 days ago](/comment/36384#comment-36384)

Minisforum proudly advertises ECC support for this. Have you done any testing on that?  
It's going to reduce performance, Minisforum says it's 1/8, so the best case is 12.5% reduction in memory bound workloads and none in compute bound workloads, though it's probably much worse.  
Anandtech (RIP) tested Intel's in-band ECC, which is 1/32, and found that it reduced performance by 0% to 10% in CPU tests, which isn't that bad, but in iGPU tests performance was reduced by 20% to 30%, which is pretty awful. Also the energy efficiency was reduced by similar amounts.  
(Couldn't add a link, so just search for "Anandtech in-band ECC" and you should find the article)

*   [Reply](/comment/reply/node/3511/comment_node_blog_post/36384)
