...
[![Tenderlove Making](/images/logo1.png)](/)
...
![screenshot of a corrupt image](/images/corrupt-image.png)

## How I used to import images

I’ve got an [OM System OM-1](https://en.wikipedia.org/wiki/OM_System_OM-1) camera. I used to shoot in RAW + jpg, then when I would import to Photos app, I would check the “delete photos after import” checkbox in order to empty the SD card. Turns out “delete after import” was a huge mistake.
...
However, after I got home from RailsConf and imported my photos, I found one corrupt image (the one above). I was able to verify that the image was _not_ corrupt on the SD card, so the camera was working fine (meaning I probably didn’t need to buy a new camera body at all).
...
![screenshot of non-corrupt image](/images/non-corrupt.png)

[Here is the binary diff between the files](https://gist.github.com/tenderlove/25853f50ab46a58738ff2cc22d682f2b). I ran both files through `xxd` then diffed them.

## My new workflow

I’m not going to put any more effort into debugging this problem, but I wanted to blog about it in case anyone else is seeing the issue. I take a lot of photos, and to be frank, most of them are not very good. I don’t want to look through a bunch of bad photos every time I look at my library, so culling photos is important. Culling photos in the Photos app is way too cumbersome, so I’ve switched to using [Darktable](https://www.darktable.org).
...
## [Archives](/archives)
 ...
 [![Mastodon](/images/mastodon-icon.svg)](https://mastodon.social/@tenderlove)[![Bluesky](/images/bluesky.svg) ](https://bsky.app/profile/tenderlove.dev)[![GitHub](/images/github-icon.svg) ](https://github.com/tenderlove)[![Instagram](/images/instagram-icon.svg) ](https://instagram.com/tenderlove)[![X](/images/x.svg)](https://x.com/tenderlove)

Copyright © 2025 Tenderlovemaking.com All rights reserved.