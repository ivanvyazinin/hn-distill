...
Though it was fully understood upfront that supporting _all_ languages in one go is unrealistic, as some languages are more different than others and require significant additional work. Human language is surprisingly disparate.
...
Language Processing Tool illustrating some problems with keyword identification when run on a very short sample of text.
...
[The CoPilot productivity paradox](/log/a_125_ai_assistants/)

2025-09-06

[marginalia.nu](https://www.marginalia.nu/) © 2025 Viktor Löfgren <kontakt@marginalia.nu>  
