...
Let’s start with two bugs. The first one is from Andrew Kelley’s HYTRADBOI 2025 talk, [“Programming Without Pointers”](https://www.hytradboi.com/2025/05c72e39-c07e-41bc-ac40-85e8308f2917-programming-without-pointers):
...
The second one is from the [Ghostty](https://github.com/ghostty-org/ghostty/tree/0930b2daff95c3550282b567c90d4c370fcd329b) terminal emulator:
...
[As a reminder](https://matklad.github.io/2024/03/21/defer-patterns.html), `errdefer comptime unreachable;` is a Zig idiom for expressing “no errors after this point”.
...
Zig applications should consider aborting on OOM. While the design goal of handling OOM errors correctly is laudable, and Zig makes it possible, I’ve seen only one application, [xit](https://github.com/radarroark/xit) which passes “matklad spends 30 minutes grepping for `errdefer`” test. For libraries, prefer leaving allocation to the caller, or use generative testing with an allocator that actually returns errors.

Alternatively, do as TigerBeetle. We take this pattern literally, reserve _all_ resources in main, and never allocate memory afterwards:

[ARCHITECTURE.md#static-memory-allocation](https://github.com/tigerbeetle/tigerbeetle/blob/0.16.54/docs/internals/ARCHITECTURE.md#static-memory-allocation)

[Fix typo](https://github.com/matklad/matklad.github.io/edit/master/content/posts/2025-08-16-reserve-first.dj) [Subscribe](/feed.xml) [Get in touch](mailto:aleksey.kladov+blog@gmail.com) [matklad](https://github.com/matklad)