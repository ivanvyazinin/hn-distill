...
Sep 8, 2025 ([Programming](http://maurycyz.com/tags/programming))  
...
However, most people see advertising as a part of the internet experience, which is why I added this message to my site:
 ...
 No adblocker detected. Consider using an extension like [uBlock Origin](https://ublockorigin.com/) to save time and bandwidth. Click here to close.
...
The specific recommendation is important because a lot of people have only _heard of adblockers from ads_. Commercial adblockers range from sketchy to outright scams: If they are paying to be promoted, they must expect to make money from users.
...
The message won’t be visible if an adblocker removes the <div> element – which has a lot of ad-like class names – or blocks the network request for “nativeads.js”.
...
**Previous post:** [Spotting AI articles:](/misc/spotting_ai_articles/)  
...
This page is licensed under a [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en). This website is **not** licensed for ML/LLM training or content creation.  
