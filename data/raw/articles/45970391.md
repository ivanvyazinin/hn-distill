OrthoRoute | Benchoff Design Portfolio                    OrthoRoute | Benchoff Design Portfolio                       

Menu Main System 7

![Apple Menu](/assets/images/apple.png)

# Brian Benchoff

[Email](mailto:benchoff@gmail.com) [Twitter](https://twitter.com/BBenchoff) [Github](https://github.com/bbenchoff) [Résumé (PDF)](https://github.com/bbenchoff/CV/blob/main/Brian%20Benchoff%20-%20Resume.pdf)

### Popular Stuff

[An isolated thermocouple reader](https://bbenchoff.github.io/pages/IsoTherm.html)  
[Citicar Restoration](https://bbenchoff.github.io/pages/Citicar.html)  
[Converting a car to CAN](https://bbenchoff.github.io/pages/CANconversion.html)  
[My Instagram clone for vintage digital cameras.](https://www.640by480.com/)  

### Software

[OrthoRoute](https://bbenchoff.github.io/pages/OrthoRoute.html)  
[Babelscope](https://bbenchoff.github.io/pages/Babelscope.html)  
[Finite Atari Machine](https://bbenchoff.github.io/pages/FiniteAtari.html)  
[SSL for classic Macs](https://bbenchoff.github.io/pages/MacSSL.html)  
[System 7](https://bbenchoff.github.io/pages/system7.html)  
[SFMTA-API](https://bbenchoff.github.io/pages/sfmta-api.html)  
[Dennis Nedry](https://bbenchoff.github.io/pages/nedry.html)  
[Embedded SSL and GZIP](https://bbenchoff.github.io/pages/BusTideDisplay.html)  
[Reading ΔΣ DAQs at 120Mbps (C)](https://bbenchoff.github.io/pages/IsoTherm.html)  
[Instagram Clone (Python, Django)](http://bbenchoff.github.io/pages/InstaClone.html)  
[IS31FL3741 LED driver library (C)](http://bbenchoff.github.io/pages/IS31FL3741.html)  
[NT35510 TFT driver library (C)](http://bbenchoff.github.io/pages/NT35510.html)  
[Terminal Parser library (C & C++)](http://bbenchoff.github.io/pages/parser.html)  

### Hardware

[Nvidia SXM2 Reverse Engineering](https://bbenchoff.github.io/pages/SXM2PCIe.html)  
[Isolated Thermocouple Reader](https://bbenchoff.github.io/pages/IsoTherm.html)  
[Nikon lens adapter](https://bbenchoff.github.io/pages/QuicktakeLens.html)  
[Eink Bus Station Display](https://bbenchoff.github.io/pages/BusTideDisplay.html)  
[The $15 Linux Machine](http://bbenchoff.github.io/pages/LinuxDevice.html)  
[Portable Dumb Terminal](http://bbenchoff.github.io/pages/dumb.html)  
[Mr. Robot Badge](http://bbenchoff.github.io/pages/MrRobot.html)  
[Zip Drive Tower](http://bbenchoff.github.io/pages/atapi.html)  
[Full Color Circuit Boards](http://bbenchoff.github.io/pages/colorPCB.html)  
[RGB Gaming Coaster](http://bbenchoff.github.io/pages/RGBgaming.html)  
[Serial Fidget Spinner](http://bbenchoff.github.io/pages/FidgetSpinner.html)  
[Baud Box](http://bbenchoff.github.io/pages/BaudBox.html)  
[A Wall of Circuit Boards](http://bbenchoff.github.io/pages/ShittyWall.html)  

### CAD Design

[Silicone Membrane Keyboard](http://bbenchoff.github.io/pages/keyboard.html)  
[Injection Molded Palmtop](http://bbenchoff.github.io/pages/Palmtop.html)  
[Retro-inspired industrial design](http://bbenchoff.github.io/pages/MiniITX.html)  
[Quarter-Scale Retrocomputing](https://bbenchoff.github.io/pages/BeBox.html)  
[Hardened clamshell computer](http://bbenchoff.github.io/pages/clamshell.html)  
[3D Printed Tank Treads](http://bbenchoff.github.io/pages/Tread.html)  
[Porygon](http://bbenchoff.github.io/pages/Porygon.html)  

![OrthoRoute Logo](/images/icon200.png)

## OrthoRoute — GPU-Accelerated Autorouting for KiCad

**OrthoRoute is a GPU-accelerated PCB autorouter that uses a Manhattan lattice and the PathFinder algorithm to route high-density boards. Built as a KiCad plugin using the IPC API, it handles complex designs with thousands of nets that make traditional push-and-shove routers give up.**

_Never trust the autorouter, but at least this one is fast._
...
[Download OrthoRoute (GitHub)](https://github.com/bbenchoff/OrthoRoute)
...
The original PathFinder paper was, _“A Negotiation-Based Performance-Driven Router for FPGAs”_ and from 1995, this meant early FPGAs like the Xilinx 3000 series and others manufactured by Tryptych. These devices were simple, and to get a good idea of how they worked, [check out Ken Shirriff’s blog](https://www.righto.com/2020/09/reverse-engineering-first-fpga-chip.html). Here’s what the inside of a Xilinx XC2064 looks like:
...
I found every bug imaginable while developing OrthoRoute. For one, congestion of nets would grow each iterations. The router would start fine with 9,495 edges with congestion in iteration 1. Then iteration 2: 18,636 edges. Iteration 3: 36,998 edges. The overuse was _growing_ by 3× per iteration instead of converging. Something was fundamentally broken. The culprit? History costs were _decaying_ instead of accumulating. The algorithm needs to remember which edges were problematic in past iterations, but my implementation had `history_decay=0.995`, so it was forgetting 0.5% of the problem every iteration. By iteration 10, it had forgotten everything. No memory = no learning = explosion.

With the history fixed, I ran another test. I got _oscillation_. The algorithm would improve for 12 iterations (9,495 → 5,527, a 42% improvement!), then spike back to 11,817, then drop to 7,252, then spike to 14,000. The pattern repeated forever. The problem was “adaptive hotset sizing”—when progress slowed, the algorithm would enlarge the set of nets being rerouted from 150 to 225, causing massive disruption. Fixing the hotset at 100 nets eliminated the oscillation.
...
![Full backplane view showing completed routing](/images/ConnM/OrthoRouteLarge.png)

The full backplane view: 8,192 nets routed through 32 layers, in OrthoRoute

![Zoomed detail of Manhattan lattice routing](/images/ConnM/OrthorouteRouted.png)

Zoomed detail showing Manhattan lattice routing density

![Routed board imported into KiCad](/images/ConnM/OrthoRouteKiCad.png)
