Claude Status - Elevated errors on claude.ai                                     

# Elevated errors on claude.ai

Incident Report for [Claude](/)

[Subscribe to Updates](#subscribe-modal-s5f75jhwjs6g)

## Monitoring

A fix has been implemented and we are monitoring the results.

Posted Oct 31, 2025 - 10:23 UTC

## Identified

The issue has been identified and a fix is being implemented.

Posted Oct 31, 2025 - 10:18 UTC

## Investigating

We are currently investigating this issue.

Posted Oct 31, 2025 - 09:25 UTC

This incident affects: claude.ai.

[← Current Status](/) [Powered by Atlassian Statuspage](https://www.atlassian.com/software/statuspage?utm_campaign=status.claude.com&utm_content=SP-notifications&utm_medium=powered-by&utm_source=inapp)

[×](#)

#### Subscribe to Incident

Subscribe to updates for **Elevated errors on claude.ai** via email and/or text message. You'll receive email notifications when incidents are updated, and text message notifications whenever Claude **creates** or **resolves** an incident.
