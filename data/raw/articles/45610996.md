...
![A 2x2 matrix, x-axis “Clarity of problem”, y-axis “Size of problem”. Each quadrant has a box with a question mark, and there is a label in the middle that says “Where does SDD sit?”](sdd-where-matrix.png)
...
latest article (Oct 15):

[Understanding Spec-Driven-Development: Kiro, spec-kit, and Tessl](sdd-3-tools.html)

previous article:

[Anchoring AI to a reference application](anchoring-to-reference.html)
