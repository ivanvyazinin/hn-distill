...
Sustaining Engineer @ [Canonical](https://canonical.com).  
Kernel Developer. Reverse Engineer.  
Founder of [Dapper Linux](https://dapperlinux.com).

[Home](/) [About](/about.html) [Books](/books.html) [Programming](/category/programming.html) [Reverse Engineering](/category/reverse-engineering.html) [Talks](/category/talks.html) [Thoughts](/category/thoughts.html) [Writeups](/category/writeups.html)

[](https://github.com/matthewruffell "Matthew Ruffell on GitHub")[](/feed.xml "Subscribe")[](/tags.html "Tags")[](/search.html "Search")

© 2022. [MIT License.](/LICENSE.md)

# Looking at kmalloc() and the SLUB Memory Allocator

15 Feb 2019 • [Programming](/category/programming.html) • [Writeups](/category/writeups.html)
...
> 
> In addition, we will discuss the overall architecture of the SLUB allocator and memory management in the kernel, and the specifics of the slab\_alloc\_node() function in mm/slub.c.
...
`kmalloc_slab()` is defined in /mm/slab\_common.c:851
...
*   ### [Reflecting on the Azure DNS Outage - A Post Incident Analysis 09 Dec 2022](/programming/writeups/2022/12/09/reflecting-on-the-azure-dns-outage-a-post-incident-analysis.html)
    
*   ### [Investigating Missing Stack Canaries and Fortify Source on Binaries 10 Jun 2022](/programming/writeups/2022/06/10/investigating-missing-stack-canaries-and-fortify-source.html)
    
*   ### [Learning How to Write Reactive Charms by Porting our Minetest Charm 07 Sep 2021](/programming/writeups/2021/09/07/learning-how-write-reactive-charms-by-porting-minetest-charm.html)