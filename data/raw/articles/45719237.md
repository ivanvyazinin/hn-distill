...
[![Sealos Logo](/_next/image?url=%2Flogo.svg&w=96&q=75)Sealos](/ "Sealos")

Products

[Docs](/docs)[Blog](/blog)[Pricing](/pricing)
...
](https://os.sealos.io "Get Started")

[](/)

Case Study: How We Reduced a Container Image by 99.7% (800GB to 2GB)

![Case Study: How We Reduced a Container Image by 99.7% (800GB to 2GB)](/_next/image?url=%2Fapi%2Fog%2Fblog%2Freduce-container-image-size-case-study.en%2Fbest-practices&w=3840&q=75)

BEST-PRACTICESOctober 24, 2025
...
[![Avatar of Sealos](/_next/image?url=%2Flogo.svg&w=96&q=75)](https://github.com/labring/sealos)
...
# [Case Study: How We Reduced a Container Image by 99.7% (800GB to 2GB)](#case-study-how-we-reduced-a-container-image-by-997-800gb-to-2gb)
...
### [1\. The Problem: Critical Disk Exhaustion Caused by Container Image Bloat](#1-the-problem-critical-disk-exhaustion-caused-by-container-image-bloat)
...
### [2\. Why It Matters: The Business Context](#2-why-it-matters-the-business-context)
...
### [3\. Investigation: Pinpointing the I/O Storm with iotop and du](#3-investigation-pinpointing-the-io-storm-with-iotop-and-du)
...
![Terminal output from the iotop command showing containerd processes with disk write speeds over 100MB/s.](/_next/image?url=.%2Fimages%2Fcontainerd-high-disk-io-iotop.png&w=3840&q=75)Terminal output from the iotop command showing containerd processes with disk write speeds over 100MB/s.
...
### [4\. Root Cause: How OverlayFS Copy-on-Write Amplified a Brute-Force Attack](#4-root-cause-how-overlayfs-copy-on-write-amplified-a-brute-force-attack)
...
![Terminal screenshot showing a single container image composed of 272 layers, indicating image bloat.](/_next/image?url=.%2Fimages%2Fbloated-container-image-272-layers.png&w=3840&q=75)Terminal screenshot showing a single container image composed of 272 layers, indicating image bloat.
...
4.  Because of CoW, OverlayFS doesn't just write the new line. It copies the _entire 11GB file_ into the new, upper layer.
...
### [5\. Solution: Building a Custom OCI Tool to Squash 272 Image Layers](#5-solution-building-a-custom-oci-tool-to-squash-272-image-layers)
...
### [6\. Validation: The Proof Is in the Data](#6-validation-the-proof-is-in-the-data)
...
### [7\. Lessons Learned & Next Steps](#7-lessons-learned--next-steps)
...
![Complete Guide to Migrating from Local to Cloud Development with Sealos DevBox](/_next/image?url=%2Fapi%2Fog%2Fblog%2Flocal-to-cloud-development-migration-sealos-devbox.en%2Fbest-practices&w=3840&q=75)
...
](/blog/local-to-cloud-development-migration-sealos-devbox)[

![Building Resilient Systems: A Deep Dive into Sealos High-Availability and Auto-Failover](/_next/image?url=%2Fapi%2Fog%2Fblog%2Fbuilding-resilient-systems-a-deep-dive-into-sealos-high-availability-and-auto-failover.en%2Fbest-practices&w=3840&q=75)

Best Practices

### Building Resilient Systems: A Deep Dive into Sealos High-Availability and Auto-Failover

Explore how Sealos enables high availability and auto-failover to keep distributed systems resilient, with practical patterns, configuration tips, and trade-offs.



](/blog/building-resilient-systems-a-deep-dive-into-sealos-high-availability-and-auto-failover)[

![A Developer's Guide to Kubernetes RBAC: Securing Your Cluster the Easy Way with Sealos](/_next/image?url=%2Fapi%2Fog%2Fblog%2Fa-developers-guide-to-kubernetes-rbac-securing-your-cluster-the-easy-way-with-sealos.en%2Fbest-practices&w=3840&q=75)

Best Practices

### A Developer's Guide to Kubernetes RBAC: Securing Your Cluster the Easy Way with Sealos

A practical guide for developers on implementing Kubernetes RBAC using Sealos to secure cluster access. Learn actionable steps, common pitfalls, and best-practice patterns to reduce risk.



](/blog/a-developers-guide-to-kubernetes-rbac-securing-your-cluster-the-easy-way-with-sealos)[

![The Definitive Guide to Using Claude Code on Your Phone](/_next/image?url=%2Fapi%2Fog%2Fblog%2Fclaude-code-on-phone.en%2Fbest-practices&w=3840&q=75)

Best Practices

### The Definitive Guide to Using Claude Code on Your Phone

Unlock mobile coding with Claude Code. This guide explores the best methods for using the AI assistant on your phone, from SSH setups to one-click cloud CDEs.
...
Optimizing PostgreSQL Performance: A Guide to Sealos Managed Database Tuning

Previous Page

](/blog/optimizing-postgresql-performance-a-guide-to-sealos-managed-database-tuning)[

Rightsizing Kubernetes Workloads: How to Stop Wasting Money on CPU and Memory Requests

Next Page

](/blog/rightsizing-kubernetes-workloads-how-to-stop-wasting-money-on-cpu-and-memory-requests)
...
[![Sealos](/logo.svg)Sealos](/ "Sealos")

Develop, deploy, and scale in one seamless cloud platform

Resources

[Docs](/docs/quick-start)[Education](/education)[Blog](/blog)

Products

[DevBox](/products/devbox)[Databases](/products/databases)[App Store](/products/app-store)

Services

[Pricing](/pricing)[FastGPT](https://tryfastgpt.ai)

Support

[Contact Us](/contact)[Customers](/)

[Terms of Service](/docs/msa/terms-of-service)[Privacy Policy](/docs/msa/privacy-policy)[Cookie Policy](/legal/cookie-policy)

Copyright © 2025 Sealos. All rights reserved.

[](https://github.com/labring/sealos "GitHub")[](https://discord.gg/wdUn538zVP "Discord")[](https://x.com/Sealos_io "Twitter")[![YouTube](/icons/youtube.svg)](https://www.youtube.com/@sealos_io "YouTube")[](/rss.xml "RSS Feed")