Packing The World For Longest Lines Of Sight       
 ...
 [![Watercolour Heart Logo](/images/heart_logo.png) tom bh
...
I have a side project to find the longest line of sight on the planet[1](#footnotes) using a novel [Total Viewshed algorithm](https://github.com/tombh/total-viewsheds). At a resolution of 3 arc-seconds (~100m²), the planet contains around 4.5 billion elevation samples[2](#footnotes). Now obviously we don’t need to calculate the visibility between literally every single one of those, so how do we begin to cut it up? That’s what I’ll explore in this post.
...
![](images/cardiff_viewshed.webp#wide)
