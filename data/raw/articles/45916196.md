...
![Joseph Lyons](/_next/image?url=https%3A%2F%2Favatars.githubusercontent.com%2Fu%2F19867440%3Fv%3D4&w=128&q=75)
...
*   [Collaboration Built into Zed's DNA](#collaboration-built-into-zeds-dna)
*   [A Speed Run of Zed's Collaboration Tools](#a-speed-run-of-zeds-collaboration-tools)
*   [Our Virtual Office](#our-virtual-office)
*   [Company-Wide Discussion Spaces](#company-wide-discussion-spaces)
*   [Project-Specific Spaces](#project-specific-spaces)
*   [Personal Focus Spaces](#personal-focus-spaces)
...
![Our weekly "all hands" Monday meeting in Zed](/img/post/zed-is-our-office/this-week.webp)

Our weekly "all hands" Monday meeting in Zed

Our mission from the beginning has been to engineer an editor that will be:

1.  **[Responsive](/blog/videogame)**: The latency between keystroke and re-render should be imperceptible.
...
![Overview of collaboration](/img/post/zed-is-our-office/collab-annotated.webp)
...
_See our [FAQs](/faq#data-and-privacy) on data and privacy regarding collaboration._

## [Our Virtual Office](#our-virtual-office)

Our office is Zed's collaboration panel.

![A sliver of Zed Industries' channel tree](/img/post/zed-is-our-office/tree-focus.webp)

A sliver of Zed Industries' channel tree

[Our channel tree](/channel/zed-283) has been through many iterations as our company has grown, but what we have today is a structure flexible enough to accommodate many forms of collaboration. Our channel tree is used for:
...
*   Meetings don't have to be a drag. The `demos` channel is used every Friday and is considered by the team to be a "[banger](http://banger.urbanup.com/11605371)." Staff members hop in, volunteer to show off a cool feature or bug fix they worked on, and get real-time feedback from the rest of the team.
    ...
    ![Lukas shares a feature in the Friday demos meeting](/img/post/zed-is-our-office/demos.webp)
...
![Our generalized meeting rooms (featuring a lonely developer, looking to pair)](/img/post/zed-is-our-office/generalized-meeting-rooms.webp)
...
![The git 1.0 channel and its subchannels](/img/post/zed-is-our-office/git-1_0-channels.webp)
...
_Many of our project channels are public, you can join [our channel tree](/channel/zed-283), read the notes, and learn about how we build Zed, just like `@FalbertengoDev`._

[

![@FalbertengoDev discovers Zed's public channels](/img/post/zed-is-our-office/user-discovers-zeds-tree.webp)
...
](https://x.com/FalbertengoDev/status/1987937137090523255)
...
![Our people channel](/img/post/zed-is-our-office/people-channel.webp)
...
While collaboration in Zed has given us the ability to run Zed Industries from within Zed, it merely _scratches_ the surface of [how we envision working as a team](/blog/sequoia-backs-zed). We're building toward a future where collaboration is continuous conversation, not discrete commits—where every discussion, edit, and insight remains linked to the code as it evolves, accessible to both teammates and AI agents.

Getting here hasn't been a straight line. Over the years, we've paused work on collaboration to focus on features users frequently requested—[agent-powered tooling](/ai), [debugging](/debugger), [Windows support](/windows), and [git support](/git)—but our primary goals for Zed **have not changed**. As we reach parity with other editors on table-stakes features, these detours are becoming less frequent, opening us up to refocus on what we're most excited about: building the greatest multiplayer software development tool.
