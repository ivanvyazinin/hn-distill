Matrix Core Programming on AMD CDNA3 and CDNA4 architecture Matrix Core Programming on AMD CDNA3 and CDNA4 architecture | salykova                    

 [![logo](/assets/logo.svg)](/)[salykova](/)

# Matrix Core Programming on AMD CDNA3 and CDNA4 architecture

Sep 30, 2025 • Amanzhol Salykov, Andy Luo, Carlus Huang, Peng Sun
...
![binary_repr](/assets/matrix_cores/binary_format_2.png)

_Figure 1: Binary representation of a floating-point number._
...
![fp_cvt](/assets/matrix_cores/g81.png)

_Figure 2: Conversion to real value from binary representation for floating-point numbers._
...
![fp_cvt](/assets/matrix_cores/e4m3fnuz.png)

_Figure 3: E4M3FNUZ encoding details._
...
![fp_cvt](/assets/matrix_cores/e8m0.png)

_Figure 4: E8M0 encoding details._
...
### 5.1. \_\_builtin\_amdgcn\_mfma\_f32\_32x32x2f32
...
![fp_cvt](/assets/matrix_cores/mfma_fp32_32x32x2_fp32.png)

_Figure 5: Data layout for \`\_\_builtin\_amdgcn\_mfma\_f32\_32x32x2f32\`. The operands are stored in row-major order._
...
### 5.2. \_\_builtin\_amdgcn\_mfma\_f32\_16x16x16f16
...
![fp_cvt](/assets/matrix_cores/mfma_fp32_16x16x16_fp16.png)

_Figure 6: Data layout for \_\_builtin\_amdgcn\_mfma\_f32\_16x16x16f16. The operands are stored in row-major order._
...
### 5.3. \_\_builtin\_amdgcn\_mfma\_f32\_32x32x16\_fp8\_fp8
...
![fp_cvt](/assets/matrix_cores/mfma_fp32_32x32x16_fp8_fp8.png)

_Figure 7: Data layout for \_\_builtin\_amdgcn\_mfma\_f32\_32x32x16\_fp8\_fp8. The operands are stored in row-major order._
...
### 5.4. \_\_builtin\_amdgcn\_mfma\_scale\_f32\_32x32x64\_f8f8
...
![fp_cvt](/assets/matrix_cores/block_scale_fp8.png)

_Figure 8: Block-scaled matrix multiplication via \_\_builtin\_amdgcn\_mfma\_scale\_f32\_32x32x64\_f8f6f4._
...
![fp_cvt](/assets/matrix_cores/mfma_scale_fp32_32x32x64_fp8_fp8.png)

_Figure 9: Data layout for \_\_builtin\_amdgcn\_mfma\_scale\_f32\_32x32x64\_f8f6f4 with FP8 input matrices. The operands are stored in row-major order._
...
### 5.5. \_\_builtin\_amdgcn\_mfma\_scale\_f32\_32x32x64\_f4f4
...
![fp_cvt](/assets/matrix_cores/mfma_scale_fp32_32x32x64_fp4_fp4.png)

_Figure 10: Data layout for \_\_builtin\_amdgcn\_mfma\_scale\_f32\_32x32x64\_f8f6f4 with FP4 input matrices. The operands are stored in row-major order._
