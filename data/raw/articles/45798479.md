...
October 29, 2025 2599 words 13 min

Table of Contents

*   [Everyone Loves pgvector (in theory)](#everyone-loves-pgvector-in-theory)
*   [Nobody’s actually run this in production](#nobodys-actually-run-this-in-production)
*   [Picking an index (there are no good options)](#picking-an-index-there-are-no-good-options)
    *   [IVFFlat](#ivfflat)
    *   [HNSW](#hnsw)
*   [Real-time search is basically impossible](#real-time-search-is-basically-impossible)
    *   [How index updates actually work](#how-index-updates-actually-work)
    *   [Handling new inserts](#handling-new-inserts)
    *   [The operational reality](#the-operational-reality)
*   [Pre- vs. Post-Filtering (or: why you need to become a query planner expert)](#pre--vs-post-filtering-or-why-you-need-to-become-a-query-planner-expert)
    *   [Multiple filters](#multiple-filters)
    *   [Workarounds](#workarounds)
    *   [What vector databases do](#what-vector-databases-do)
*   [Hybrid search? Build it yourself](#hybrid-search-build-it-yourself)
*   [pgvectorscale (it doesn’t solve everything)](#pgvectorscale-it-doesnt-solve-everything)
*   [Just use a real vector database](#just-use-a-real-vector-database)
    *   [What you actually get](#what-you-actually-get)
    *   [It’s probably cheaper than you think](#its-probably-cheaper-than-you-think)
...
[Understanding Vector Search and HNSW Index with pgvector](https://neon.com/blog/understanding-vector-search-and-hnsw-index-with-pgvector)

[HNSW Indexes with Postgres and pgvector](https://www.crunchydata.com/blog/hnsw-indexes-with-postgres-and-pgvector)

[Understand Indexes in pgvector](https://www.stormatics.tech/blog/understand-indexes-in-pgvector)

[External Indexing for pgvector](https://www.lantern.dev/blog/external-indexing-for-pgvector)

[Exploring Postgres pgvector HNSW Index Storage](https://www.lantern.dev/blog/exploring-postgres-pgvector-hnsw-index-storage)

[pgvector v0.5.0: Faster semantic search with HNSW indexes](https://supabase.com/blog/pgvector-v0-5-0)

[Early Look at HNSW Performance with pgvector](https://info.crunchydata.com/blog/early-look-at-hnsw-performance)

[Vector Indexes in Postgres using pgvector: IVFFlat vs HNSW](https://tembo.io/blog/vector-indexes-in-postgres-using-pgvector-ivfflat-vs-hnsw)

[Vector Database Basics: HNSW Index](https://www.tigerdata.com/blog/vector-database-basics-hnsw)

[PostgreSQL Vector Indexing with HNSW](https://dev.to/azure/postgresql-vector-indexing-hnsw-cosmosdb)
...
![img_1.png](/posts/the-case-against-pgvector/img_1.png) _Image source: [IVFFlat or HNSW index for similarity search?](https://unfoldai.com/ivfflat-vs-hnsw/) by Simeon Emanuilov_
...
![img_2.png](/posts/the-case-against-pgvector/img_2.png) _Image source: [IVFFlat or HNSW index for similarity search?](https://unfoldai.com/ivfflat-vs-hnsw/) by Simeon Emanuilov_
...
![img_6.png](/posts/the-case-against-pgvector/img_6.png)
...
![img_3.jpg](/posts/the-case-against-pgvector/img_3.jpg)
...
![img_4.jpg](/posts/the-case-against-pgvector/img_4.jpg)
...
![img_5.png](/posts/the-case-against-pgvector/img_5.png)
...
Now add another dimension: you’re filtering by user\_id AND category AND date\_range.
...
![img_7.jpg](/posts/the-case-against-pgvector/img_7.jpg)
...
[Next Page   
A Production Framework for LLM Feature Evaluation](https://alex-jacobs.com/posts/practicalaifeatures/)

Please enable JavaScript to view the [comments powered by Disqus.](https://disqus.com/?ref_noscript)

[comments powered by Disqus](https://disqus.com)

© 2025 [Alex Jacobs](https://alex-jacobs.com/) [CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) Powered by [Hugo](https://gohugo.io/) & [PaperModX](https://github.com/reorx/hugo-PaperModX/)
