...
[Announcing Oxlint Type-Aware Preview](/blog/2025-08-17-oxlint-type-aware) 🎉

[Skip to content](#VPContent)

[![](https://cdn.jsdelivr.net/gh/oxc-project/oxc-assets/round.svg)Oxc](/)

Search

Main Navigation [Guide](/docs/guide/introduction)[Learn](/docs/learn/parser_in_rust/intro)[Contribute](/docs/contribute/introduction)[Playground](https://playground.oxc.rs)

Resources

[Blog](/blog/2025-08-17-oxlint-type-aware)

[Team](/team)

[Branding](/branding)

[Website GitHub](https://github.com/oxc-project/oxc-project.github.io)

[Sponsor](/sponsor)

[](https://bsky.app/profile/boshen.github.io)[](https://discord.gg/9uXCAwqQZW)[](https://github.com/oxc-project/oxc)
...
](/blog/2025-08-17-oxlint-type-aware)

[

Oxlint v1.0 Stable

](/blog/2025-06-10-oxlint-stable)

[

Oxlint Beta

](/blog/2025-03-15-oxlint-beta)

[

Minifier Alpha

](/blog/2025-03-13-minifier-alpha)

[

Oxlint v0.10 Release

](/blog/2024-10-18-oxlint-v0.10-release)

[

Transformer Alpha

](/blog/2024-09-29-transformer-alpha)

[

Oxlint Import Plugin Alpha

](/blog/2024-05-04-import-plugin-alpha)

[

Oxlint General Availability

](/blog/2023-12-12-announcing-oxlint)

On this page

# Oxlint Type-Aware Preview

*   ![Boshen](https://www.github.com/Boshen.png)
    
    [Boshen](https://github.com/Boshen)Project Lead
    
*   ![auvred](https://www.github.com/auvred.png)
    
    [auvred](https://github.com/auvred)tsgolint
    
*   ![Cam](https://www.github.com/camchenry.png)
    
    [Cam](https://github.com/camchenry)Member
    
*   ![Cameron](https://www.github.com/camc314.png)
    
    [Cameron](https://github.com/camc314)Core
...
Please visit our [usage guide](https://oxc.rs/docs/guide/usage/linter) for more configuration options.
...
This is achieved by leveraging [`typescript-go`](https://github.com/microsoft/typescript-go), the [10x faster TypeScript](https://devblogs.microsoft.com/typescript/typescript-native-port) written in Go.
...
Please refer to [Rust-Based JavaScript Linters: Fast, But No Typed Linting Right Now](https://www.joshuakgoldberg.com/blog/rust-based-javascript-linters-fast-but-no-typed-linting-right-now) to understand the current status of type-aware linting in the ecosystem.

## Technical Details [​](#technical-details)

The core of this new functionality is [oxc-project/tsgolint](https://github.com/oxc-project/tsgolint).

The `tsgolint` project was initially prototyped as [typescript-eslint/tsgolint](https://github.com/typescript-eslint/tsgolint). However, the `typescript-eslint` team decided not to allocate development resources to this prototype, as they plan to continue their work on `typescript-eslint` for typed linting with ESLint.

[@boshen](https://github.com/Boshen) reached out to [@auvred](https://github.com/auvred) for a forked, scoped-down version adapted for oxlint. This version would only contain type-aware rules without the sophisticated configuration resolution a full linter would require.
...
### Write our own type checker [​](#write-our-own-type-checker)
...
### Communication with TypeScript Compiler [​](#communication-with-typescript-compiler)
...
With `typescript-go`, the TypeScript team is [leaning towards](https://github.com/microsoft/typescript-go/discussions/455) encoding the TypeScript AST and decoding it on the JavaScript side through inter-process communication.
...
### Requirement for a Different TypeScript Version [​](#requirement-for-a-different-typescript-version)
...
### Maintenance cost of `tsgolint` [​](#maintenance-cost-of-tsgolint)
...
[Suggest changes to this page](https://github.com/oxc-project/oxc-project.github.io/edit/main/src/blog/2025-08-17-oxlint-type-aware.md)

Pager

[Next pageOxlint v1.0 Stable](/blog/2025-06-10-oxlint-stable)

Released under the MIT License.

Copyright © 2023-present VoidZero Inc.