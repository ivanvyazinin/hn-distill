...
Lobster is Open Source (Apache v2 license) and can be found on [github](https://github.com/aardappel/lobster). Online copy of the full [documentation](http://aardappel.github.io/lobster/README_FIRST.html).
...
*   Implementation
    ...
    *   Relatively fast (order of magnitude faster than Python, significantly faster than Lua ([benchmark](https://github.com/stefandd/Tic4)), not yet a C competitor, but can be eventually) and economical (low overhead memory allocation)
...
To see more about the builtin functionality of Lobster (graphics or otherwise), check out the [builtin functions reference](http://aardappel.github.io/lobster/builtin_functions_reference.html) (this particular file may be out of date, it can be regenerated by the running `lobster -r`). You can also check out draft version of the full Lobster [documentation](http://aardappel.github.io/lobster/README_FIRST.html), in particular the [Language Reference](http://aardappel.github.io/lobster/language_reference.html).

Most recent version of everything is on [GitHub](https://github.com/aardappel/lobster).

Come chat on [Discord](https://discord.gg/szJPYdX) or [Gitter](https://gitter.im/lobster_programming_language/community).

Like it on the [Facebook page](https://www.facebook.com/lobsterprogramminglanguage).
...
[![](/img/icon/iconmonstr-home-7-64.png)](/)

  

[![](/img/icon/iconmonstr-email-2-64.png)](/cdn-cgi/l/email-protection#badbdbc8dedbcacadfd6dbceddd7dbd3d6ded5ced9d5d7)

[![](/img/icon/iconmonstr-twitter-1-64.png)](https://twitter.com/wvo)

[![](/img/icon/iconmonstr-github-1-64.png)](https://github.com/aardappel)