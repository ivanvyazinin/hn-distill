...
[Home](/git) / [bebbo](/git/bebbo) / bebbossh › README.md
...
*   [📄 .gitignore](/git/bebbo/bebbossh/master/.gitignore)
*   [📄 COPYING](/git/bebbo/bebbossh/master/COPYING)
*   [📄 LICENSE](/git/bebbo/bebbossh/master/LICENSE)
*   [📄 Makefile](/git/bebbo/bebbossh/master/Makefile)
*   [📄 README.md](/git/bebbo/bebbossh/master/README.md)
*   [📄 bebbossh.info](/git/bebbo/bebbossh/master/bebbossh.info)
*   [📄 bebbossh.readme](/git/bebbo/bebbossh/master/bebbossh.readme)
*   [📄 class\_hierarchy.pdf](/git/bebbo/bebbossh/master/class_hierarchy.pdf)
*   [📁 docs](/git/bebbo/bebbossh/master/docs)
*   [📁 include](/git/bebbo/bebbossh/master/include)
*   [📄 mkrelease](/git/bebbo/bebbossh/master/mkrelease)
*   [📁 src](/git/bebbo/bebbossh/master/src)
*   [📁 template](/git/bebbo/bebbossh/master/template)

[📄 Raw](?view=raw "Toggle raw view")
...
*   Source code available at: [https://franke.ms/git/bebbo/bebbossh](https://franke.ms/git/bebbo/bebbossh)
...
e.g.: list foobar:  
Get [https://aminet.net/util/boot/Requester.lha](https://aminet.net/util/boot/Requester.lha)  
and run "Cancel 5" from your startup-sequence!  
Or try [https://aminet.net/util/cdity/OkayDokay14.lha.](https://aminet.net/util/cdity/OkayDokay14.lha.)  
  

*   public key authentication does not work!?

Check the file ENVARC:.ssh/authorized\_keys if your  
