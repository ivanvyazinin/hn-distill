...
[apple 2 blog](/apple-2-blog/)

*   [Home](/)
*   [GitHub](https://github.com/mdcramer/mdcramer.github.io/tree/blog/_apple-2-blog)

Toggle Menu

![Mark Cramer](https://mdcramer.github.io/assets/images/profilepic-small.jpg)
...
*   San Francisco
*   [Twitter](https://twitter.com/markdcramer)
*   [Facebook](https://www.facebook.com/markdcramer)
*   [LinkedIn](https://www.linkedin.com/in/mcramer)
*   [GitHub](https://github.com/mdcramer)
*   [Stackoverflow](https://www.stackoverflow.com/users/852795/mark-cramer)
*   [YouTube](https://youtube.com/c/MarkCramerD)
*    [![googlescholar](/assets/images/googlescholar.svg) Google Scholar](https://scholar.google.com/citations?user=vlo46P8AAAAJ)

  

# K-means by another means

Wait. Does k-means count as machine learning? Yes. Yes, it does.

[CS229](https://cs229.stanford.edu/) is the graduate-level machine learning course I took at Stanford as part of the [Graduate Certificate in AI](https://www.linkedin.com/pulse/graduate-certificate-ai-achievement-unlocked-mark-cramer/) which I received back in 2021. While k-means is my choice as the easiest to understand algorithm in machine learning, it was taught as the introductory clustering algorithm for unsupervised learning. As a TA for [XCS229](https://online.stanford.edu/courses/xcs229-machine-learning), which I have been doing since 2022 and most recently did this Spring, I know that it is still being taught as part of this seminal course in AI.
...
[![Video of Apple 2+ running k-means](https://img.youtube.com/vi/Cy0wMMLObVA/0.jpg)](https://youtube.com/shorts/Cy0wMMLObVA?autoplay=1 "Video of Apple ]\[+ running k-means")
...
[K-means clustering](https://en.wikipedia.org/wiki/K-means_clustering) is a recursive algorithm that aims to partition \\(n\\) observations into \\(k\\) clusters in which each observation belongs to the cluster with the nearest mean, called the cluster centroid.
...
Produce and initial set of k cluster centroids. This can be done by randomly choosing k observations from the dataset.

Step 1 - Assignment

Using Euclidean distance to the centroids, assign each observation to a cluster.

Step 2 - Update

For each cluster, recompute the centroid using the newly assigned observations. If the centroids change (outside of a certain tolerance), go back to step 1 and repeat.

Ezpz.

The math is also simple. In step 1, the distance between two points, \\(x\\) and \\(y\\), is simply \\(\\sqrt{(x\_0 - y\_0)^2 + (x\_1 - y\_1)^2 + \\cdots + (x\_{d-1} - y\_{d-1})^2}\\), where \\(d\\) is the dimensionality of the observations. In our case \\(d=2\\) which is why we only have \\(x\_0\\) and \\(x\_1\\). Also, since we’re only using the distances for comparative purposes, it’s not even necessary to take the square root. In step 2, the centroid is simply the sum of all the points divided by the number of points.
...
**Tags:** [K-means](/tags/k-means), [machine learning](/tags/machine-learning)

**Updated:** September 20, 2025

#### Share on

[Twitter](https://twitter.com/intent/tweet?via=markdcramer&text=K-means+by+another+means%20https%3A%2F%2Fmdcramer.github.io%2Fapple-2-blog%2Fk-means%2F "Share on Twitter") [Facebook](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmdcramer.github.io%2Fapple-2-blog%2Fk-means%2F "Share on Facebook") [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fmdcramer.github.io%2Fapple-2-blog%2Fk-means%2F "Share on LinkedIn")

[Previous](https://mdcramer.github.io/apple-2-blog/emulator/ "No Cursor, no emulator
") [Next](#)
...
*   [Stackoverflow](https://www.stackoverflow.com/users/852795/mark-cramer)
*    [![googlescholar](/assets/images/googlescholar.svg) Google Scholar](https://scholar.google.com/citations?user=vlo46P8AAAAJ)
*   [Feed](https://mdcramer.github.io/feed.xml)

© 2025 Mark Cramer. Powered by [Jekyll](http://jekyllrb.com) & [Minimal Mistakes](https://mademistakes.com/work/minimal-mistakes-jekyll-theme/).
