...
[nixpkgs](https://ptrpa.ws/tag/nixpkgs), [nix](https://ptrpa.ws/tag/nix), [github-actions](https://ptrpa.ws/tag/github-actions), [vulnerability](https://ptrpa.ws/tag/vulnerability)
...
## github actions: the easy target [#](#github-actions-the-easy-target)
...
## the dangerous pull\_request\_target [#](#the-dangerous-pull_request_target)
...
## the editorconfig vulnerability [#](#the-editorconfig-vulnerability)
...
## the code owners vulnerability: local file inclusion [#](#the-code-owners-vulnerability-local-file-inclusion)
...
Meta Quest Firmware Archive & How it works](/quest-firmware-archive)

[](https://github.com/ptrpaws "Github profile")[](https://twitter.com/ptrpaws "Twitter")[](https://wetdry.world/@ptrpaws "Mastodon")[](https://ptrpa.ws/atom.xml "Feed RSS")[](https://github.com/DavideBri/Gesko "Browse the code")