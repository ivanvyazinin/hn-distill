...
![quad9](https://torrentfreak.com/images/quad9-1.jpg)In May 2024, the Paris Judicial Court ordered [Google, Cloudflare, and Cisco](https://www.cloudflare.com/learning/dns/dns-cache-poisoning/) to block access to several pirate sports streaming sites.

The move was a major enforcement escalation by French rightsholders, but in hindsight it was only the beginning.

In the months that followed, additional rightsholders such as DAZN and beIN joined in on the action with similar requests, while more DNS providers were added as targets, [including Quad9 and Vercel](https://torrentfreak.com/french-piracy-blocking-order-goes-global-dns-service-quad9-vows-to-fight-241212/). This pitted notably smaller players against these billion-dollar companies in court.

## An Existential Threat

[Quad9](https://quad9.net/) was no stranger to site blocking requests, having previously dealt with a similar legal battle in Germany. That said, for the small Swiss non-profit organization, these proceedings are more than a legal disagreement. They present an existential threat.

For billion-dollar tech companies Google and Cloudflare, dealing with these legal challenges is a nuisance, but they have the means to fight back. In a [recent blog post](https://quad9.net/news/blog/when-enforcing-copyright-starts-breaking-the-internets-plumbing/), Quad9 explains that its foundation doesn’t have this luxury.
...
Ideally Quad9 would like to defend itself in these blocking cases, as Google and Cloudflare have done. However, since it doesn’t have the financial resources to do so, it [chose not to make an appearance](https://torrentfreak.com/wrong-logo-no-piracy-proof-french-court-rejects-dns-piracy-blocking-bids-250515/) in one of the recent site-blocking cases.
...
_Breaking the Internet’s Plumbing_

  

 ![plumbing](https://torrentfreak.com/images/plumbing.png)
...
_“Should neutral, technical infrastructure be held responsible for the actions of others?”_
...
_“At what point does legal compliance become de facto censorship?”_

These are not just rhetorical questions for the Swiss non-profit. After fighting and winning a multi-year, costly legal battle [against Sony in Germany](https://torrentfreak.com/dns-resolver-quad9-wins-pirate-site-blocking-appeal-against-sony-231208/), Quad9’s “existential threat” has reemerged in France.
...
*   [Previous Post![](https://torrentfreak.com/wp-content/themes/tf-theme-v2/build/assets/img/arrow-right.svg)](https://torrentfreak.com/torrentgalaxy-to-returns-as-a-dubious-memecoin-promo-page/)

### Tagged In:

*   [quad9](https://torrentfreak.com/tag/quad9/)
...
![](https://torrentfreak.com/images/digital-court-500x210.png)

Anti-Piracy

### Warner Bros. Discovery & TNT Sports Target UK Piracy Blocking Injunction

*   November 3, 2025, 15:46 by Andy Maxwell



](https://torrentfreak.com/warner-bros-discovery-tnt-sports-target-uk-piracy-blocking-injunction-251103/)
...
*   October 31, 2025, 09:40 by Andy Maxwell



](https://torrentfreak.com/iptv-piracy-demands-are-bad-for-isps-disaster-for-user-privacy-security-251030/)

[

![](https://torrentfreak.com/images/cloudflare-spain-f-500x210.png)

Anti-Piracy

### Proposal to Prevent LaLiga Site-Blocking Hurting Innocent Sites Rejected in Spain

*   October 25, 2025, 12:03 by Andy Maxwell
...
](https://torrentfreak.com/riaa-files-massive-repeat-infringer-copyright-lawsuit-against-u-s-isp-altice-231209/)

[

Take-Two Wins Injunction to Kill Red Dead Redemption Enhancement Project

](https://torrentfreak.com/take-two-wins-injunction-to-kill-red-dead-redemption-enhancement-projects-200909/)
