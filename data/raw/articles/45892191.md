...
2025-11-11 • [ideas](https://jyn.dev/tags/ideas/) • [terminal](https://jyn.dev/tags/terminal/)

Table of contents

1.  [a mental model of a terminal](https://jyn.dev/the-terminal-of-the-future/#a-mental-model-of-a-terminal)
2.  [what does a better terminal look like?](https://jyn.dev/the-terminal-of-the-future/#what-does-a-better-terminal-look-like)
    1.  [a first try: Jupyter](https://jyn.dev/the-terminal-of-the-future/#a-first-try-jupyter)
    2.  [some problems](https://jyn.dev/the-terminal-of-the-future/#some-problems)
3.  [how does that work?](https://jyn.dev/the-terminal-of-the-future/#how-does-that-work)
    1.  [shell integration](https://jyn.dev/the-terminal-of-the-future/#shell-integration)
    2.  [long-lived processes](https://jyn.dev/the-terminal-of-the-future/#long-lived-processes)
        1.  [interacting](https://jyn.dev/the-terminal-of-the-future/#interacting)
        2.  [suspending](https://jyn.dev/the-terminal-of-the-future/#suspending)
        3.  [disconnecting](https://jyn.dev/the-terminal-of-the-future/#disconnecting)
    3.  [rerun and undo/redo](https://jyn.dev/the-terminal-of-the-future/#rerun-and-undo-redo)
    4.  [derived features](https://jyn.dev/the-terminal-of-the-future/#derived-features)
        1.  [needs a Jupyter notebook frontend](https://jyn.dev/the-terminal-of-the-future/#needs-a-jupyter-notebook-frontend)
        2.  [needs shell integration](https://jyn.dev/the-terminal-of-the-future/#needs-shell-integration)
        3.  [needs sandboxed tracing](https://jyn.dev/the-terminal-of-the-future/#needs-sandboxed-tracing)
4.  [ok but how do you build this](https://jyn.dev/the-terminal-of-the-future/#ok-but-how-do-you-build-this)
    1.  [stage 1: transactional semantics](https://jyn.dev/the-terminal-of-the-future/#stage-1-transactional-semantics)
    2.  [stage 2: persistent sessions](https://jyn.dev/the-terminal-of-the-future/#stage-2-persistent-sessions)
    3.  [stage 3: structured RPC](https://jyn.dev/the-terminal-of-the-future/#stage-3-structured-rpc)
    4.  [stage 4: jupyter-like frontend](https://jyn.dev/the-terminal-of-the-future/#stage-4-jupyter-like-frontend)
5.  [jyn, what the fuck](https://jyn.dev/the-terminal-of-the-future/#jyn-what-the-fuck)
6.  [bibliography](https://jyn.dev/the-terminal-of-the-future/#bibliography)

This post is part 6 of a multi-part series called [“the computer of the next 200 years”](/computer-of-the-future).

* * *

> Terminal internals are a mess. A lot of it is just the way it is because someone made a decision in the 80s and now it’s impossible to change. —[Julia Evans](https://jvns.ca/blog/2025/06/24/new-zine--the-secret-rules-of-the-terminal/)

> This is what you have to do to redesign infrastructure. Rich \[Hickey\] didn't just pile some crap on top of Lisp \[when building Clojure\]. He took the entire Lisp and moved the whole design at once. —[Gary Bernhardt](https://www.destroyallsoftware.com/talks/a-whole-new-world)
...
*   high fidelity image rendering
    ...
    ![screenshot of a JupyterLite notebook. It has some python code in a cell that generates a matplotlib chart. Beneath is the chart, rendered to raster graphics.](/assets/jupyter%20bubble%20plot.png)
...
*   a "rerun from start" button (or rerun the current command; or rerun only a single past command) that replaces past output instead of appending to it
    ...
    ![](/assets/jupyter%20run%20cells.png)
...
*   "views" of source code and output that can be rewritten in place (e.g. markdown can be viewed either as source or as rendered HTML)
    ...
    ![](/assets/jupyter%20markdown%20raw.png) ![](/assets/jupyter%20markdown%20rendered.png)
    
*   a built-in editor with syntax highlighting, tabs, panes, mouse support, etc.
    
    ![](/assets/jupyter%20window%20management.png)
...
To interact with a process, you need bidirectional communication, i.e. you need a "cell output" that is also an input. An example would be any TUI, like `top`, `gdb`, or `vim` [1](#fn-1). Fortunately, Jupyter is really good at this! The whole design is around having [interactive outputs](https://ipywidgets.readthedocs.io/en/latest/) that you can change and update.
...
![](/assets/intellij%20background%20tasks.png)
...
![](/assets/pluto%20interactive%20ode.gif)
...
This bit depends on the client/server model. Once you have a server interposed between the terminal emulator and the client, you can start doing really funny things like tagging I/O with metadata. This lets all data be timestamped[3](#fn-3) and lets you distinguish input from output. [xterm.js](https://jvns.ca/blog/2022/07/20/pseudoterminals/) works something like this. When combined with shell integration, this even lets you distinguish shell prompts from program output, at the _data_ layer.

Now you can start doing really funny things, because you have a _structured log_ of your terminal session. You can replay the log as a recording, like [asciinema](https://asciinema.org/)[4](#fn-4); you can transform the shell prompt without rerunning all the commands; you can import it into a Jupyter Notebook or [Atuin Desktop](https://blog.atuin.sh/atuin-desktop-runbooks-that-run/); you can save the commands and rerun them later as a script. Your terminal is data.
...
*   [\[email protected\]](/cdn-cgi/l/email-protection#bad8d6d5ddfad0c3d494dedfcc)
