...
[reflexions](https://reflexions.florianernotte.be/)

[home](/) [post](/post) [numérique](/numerique) [about](/about) [tags](/tags) |
...
First, I discovered [Derek Sivers’s pages on ai usage.](https://sive.rs/ai). As mentioned by Derek, he has _“never ever used AI to generate text instead of (his) own”_ and he is using his special page to let people know that nothing claiming to be written by him is written by an AI. I was thinking about this initiative and thought it might be a decent idea to explain how we use AI publicly. Time flies and this idea stay in my head.

Few months later, I stumbled upon [notbyai.fyi](https://notbyai.fyi/) which have pretty much the same spirit. As mentioned on their website, they are promoting human content. They also have a strong statement on their homepage:
...
Lately, I acknowledged the [University of Montreal initiative](https://bib.umontreal.ca/evaluer-analyser-rediger/iag). They shared a guide on AI and recommended to declare the use of AI for academic work.
...
So, at this point, we might have some issues to disclaim AI without a clear scale of usage. Does proofread your text implies you were assisted by AI? If so, why don’t we see people mentioning they used specific tools to proofread before AI apparition? There are a lot of tools out there ([Gramarly](https://www.grammarly.com/), [Antidote](https://www.antidote.info/) for naming the most famous) and I did not see someone mentioning he used this or that.
...
Therefore, the only point where credibility is in discussion is for fresh, new and good ideas/contents. So, it’s maybe more about sourcing content than disclaiming the use of AI _per se_ that is important.
...
*   [numerique](/tags/numerique)
*   [ia](/tags/ia)
*   [dualite](/tags/dualite)

2025 © Florian Ernotte | [Archie Theme](https://github.com/athul/archie) | Built with [Hugo](https://gohugo.io)