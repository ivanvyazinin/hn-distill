...
[View the Project on GitHub Hypfer/Valetudo](https://github.com/Hypfer/Valetudo)

## General

[Newcomer Guide](https://valetudo.cloud/pages/general/newcomer-guide.html) [Why Valetudo?](https://valetudo.cloud/pages/general/why-valetudo.html) [Why not Valetudo?](https://valetudo.cloud/pages/general/why-not-valetudo.html) [Getting Started](https://valetudo.cloud/pages/general/getting-started.html) [Supported Robots](https://valetudo.cloud/pages/general/supported-robots.html) [Rooting Essentials](https://valetudo.cloud/pages/general/rooting-essentials.html) [Buying Supported Robots](https://valetudo.cloud/pages/general/buying-supported-robots.html) [Media & Content Creators](https://valetudo.cloud/pages/general/media.html)

## Installation

[Dreame](https://valetudo.cloud/pages/installation/dreame.html) [Roborock](https://valetudo.cloud/pages/installation/roborock.html)

## Usage

[Implementation Overview](https://valetudo.cloud/pages/usage/implementation-overview.html) [Capabilities Overview](https://valetudo.cloud/pages/usage/capabilities-overview.html) [Upgrading](https://valetudo.cloud/pages/usage/upgrading.html) [Firmware Updates](https://valetudo.cloud/pages/usage/firmware-updates.html)

## Companion Apps

[Valetudo Companion (Android)](https://valetudo.cloud/pages/companion_apps/valetudo_companion.html) [Valetudo Tray Companion](https://valetudo.cloud/pages/companion_apps/valetudo_tray_companion.html) [Valeronoi](https://valetudo.cloud/pages/companion_apps/valeronoi.html) [Lovelace Valetudo Map Card](https://valetudo.cloud/pages/companion_apps/lovelace_valetudo_map_card.html) [I Can't Believe It's Not Valetudo](https://valetudo.cloud/pages/companion_apps/i_cant_believe_its_not_valetudo.html) [node-red-contrib-valetudo](https://valetudo.cloud/pages/companion_apps/node-red-contrib-valetudo.html) [Fun & Games](https://valetudo.cloud/pages/companion_apps/fun_games.html) [Other Noteworthy Projects](https://valetudo.cloud/pages/companion_apps/other_noteworthy_projects.html)

## Integrations

[MQTT](https://valetudo.cloud/pages/integrations/mqtt.html) [Home Assistant](https://valetudo.cloud/pages/integrations/home-assistant-integration.html) [Node-RED](https://valetudo.cloud/pages/integrations/node-red.html) [openHAB](https://valetudo.cloud/pages/integrations/openhab-integration.html)

## Misc

[FAQ](https://valetudo.cloud/pages/faq.html) [Style Guide](https://valetudo.cloud/pages/style-guide.html) [Troubleshooting](https://valetudo.cloud/pages/troubleshooting.html)

## Development

[Building and Modifying Valetudo](https://valetudo.cloud/pages/development/building-and-modifying-valetudo.html) [Valetudo core concepts](https://valetudo.cloud/pages/development/valetudo-core-concepts.html) [MQTT](https://valetudo.cloud/pages/development/mqtt.html)

![Valetudo Full Logo](/img/valetudo_logo_with_name.svg)
...
Valetudo is made, managed, maintained and more by me, [Sören Beye](https://hypfer.de), with occasional contributions by [these awesome people](https://github.com/Hypfer/Valetudo/graphs/contributors).  
It would not exist without the ongoing work of [Dennis Giese](https://dontvacuum.me/), who is constantly providing us with new ways of liberating and gaining actual ownership of our robots.
...
![](https://user-images.githubusercontent.com/974410/211155741-d6430660-a6b2-48ab-8ddc-2217328444de.png) ![](https://github.com/user-attachments/assets/eaad6fe0-dd1e-4f56-b6f9-f65954aecac7)

![](https://user-images.githubusercontent.com/974410/211155650-7cac266c-ffeb-432d-8656-5241a5d6f227.png) ![](https://user-images.githubusercontent.com/974410/211155656-d43ee25e-1ae6-432f-95ff-1a39d294828d.png)
...
There is simply no ground to stand on to demand change to the garden. It doesn’t matter if it would attract more people or if all the other gardens in town are doing something in a specific way. It doesn’t matter if your idea of what gardens even are differs.  
This at the end of the day is simply private property with free public access as a gift to everyone.

When it comes to software development, _everyone_ has access to infinite plots of undeveloped land that they can claim at any time. Therefore, a garden being build with a specific vision does not take away the ability for anyone else to build their own garden with a different vision.

### Further questions?

1.  [dust\_announce - Very low frequency updates about Valetudo and Rooting](https://t.me/dust_announce)
    
2.  [Valetudo Telegram group](https://t.me/+F00lFE1NVUc2NTAy)
    

Be aware that there is an automod active on Telegram that will automatically kick users without a username and/or a screen name with less than 2 characters. If you’re unable to join, make sure that your account passes those requirements, as they are necessary for the moderation tools to work.
