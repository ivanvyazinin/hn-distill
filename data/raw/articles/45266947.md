...
## The Reputation of C++[](#the-reputation-of-c)
...
### Rewrites of C++ codebases to Rust always yield more memory-safe results than before.[](#rewrites-of-c-codebases-to-rust-always-yield-more-memory-safe-results-than-before)
...
### But that does not deny the fact that C++ is unsafe.[](#but-that-does-not-deny-the-fact-that-c-is-unsafe)
...
### Can C++ be made safer?[](#can-c-be-made-safer)
...
## C++ is Hard to Read[](#c-is-hard-to-read)
...
### But doesn’t that defeat the whole purpose of C++? Why not just use C then?[](#but-doesnt-that-defeat-the-whole-purpose-of-c-why-not-just-use-c-then)
...
## C++ has a confusing ecosystem[](#c-has-a-confusing-ecosystem)
...
## C++ is not a good choice for beginners[](#c-is-not-a-good-choice-for-beginners)
...
## C++ vs Rust: Friends or Rivals?[](#c-vs-rust-friends-or-rivals)
...
## Is C++ Still Used in 2025?[](#is-c-still-used-in-2025)
...
*   [Zig Error Handling](/blog/zig-error-handling/)
*   [Read Directory Contents With Zig](/blog/read-directory-contents-with-zig/)