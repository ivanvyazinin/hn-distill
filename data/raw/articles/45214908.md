...
![Profile](/_next/image?url=%2Fimages%2Fprofile.jpg&w=48&q=75)
...
Earlier this week, I dissected [ChatGPT's memory system](/writing/posts/chatgpt-memory-bitter-lesson). Since then, I've been doing the same for Claude and realized something remarkable: these two leading AI assistants have built completely opposite memory systems.
...
![Claude searching for Chandni Chowk conversations](/images/blog/claude-memory/chandni-chowk.png)
...
![Claude running multiple searches for different topics](/images/blog/claude-memory/multiple-searches.png)

conversation\_search tool definition
...
![Claude retrieving last 10 conversations](/images/blog/claude-memory/last-10-conversations.png)
...
![Claude retrieving conversations from November 2024](/images/blog/claude-memory/november-2024.png)

recent\_chats tool definition
...
[AI](/writing?tag=AI)[Claude](/writing?tag=Claude)[Memory](/writing?tag=Memory)