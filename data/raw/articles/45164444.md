...
[![mermaid](/static/09ce3a5ecf0860c16fec39889a498207/fcda8/mermaid.png "mermaid")](/static/09ce3a5ecf0860c16fec39889a498207/772aa/mermaid.png)
...
[![complex](/static/98850388a09a740397fe744a725059f2/fcda8/mermaid-complex.png "complex")](/static/98850388a09a740397fe744a725059f2/772aa/mermaid-complex.png)
...
A foreign key constraint forces `user_id` to correspond to an actual row in the `users` table. If you try to create or update a post with user\_id 999, and there is no user with that id, the foreign key constraint will cause the SQL query to fail.
...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/invalid-states/&t='Make invalid states unrepresentable' considered harmful).

September 8, 2025 │ Tags: [software design](/tags/software design/)

* * *

[subscribe](https://buttondown.com/seangoedecke) │ [about](/about) │ [popular](/popular) │ [rss](/rss.xml) │ [book](/book)

*   [← An unofficial FAQ for Stripe's new "Tempo" blockchain](/tempo-faq/)