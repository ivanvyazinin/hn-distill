Kai Pereira :D        Build Your Own RP2040 Devboard - Kai Pereira

[\[Back to my Journal\]](/journal)
...
_This is how are schematic will look when done the tutorial_

![Pasted image 20250930162101.png](/images/Pasted%20image%2020250930162101.png)
...
![Pasted image 20250930162139.png](/images/Pasted%20image%2020250930162139.png)
...
![Pasted image 20250925070320.png](/images/Pasted%20image%2020250925070320.png) ![Pasted image 20250925070335.png](/images/Pasted%20image%2020250925070335.png) You'll notice the symbol and actual component are 2 different things if you look at the first screenshot. The symbol just tells you all the pins on the component, and how they'll be wired to what. The actual component has the physical pads where traces will actually connect to on your PCB!
...
![Pasted image 20250925071047.png](/images/Pasted%20image%2020250925071047.png)
...
So go back into your schematic and then tap on the "Draw Wires" icon to connect the VREF\_VOUT and DVDD, and then separately connect the IO\_VDD, USB\_VDD, ADC\_AVDD and VREG\_IN, because these pins have different voltages.
...
![Pasted image 20250925072335.png](/images/Pasted%20image%2020250925072335.png)

Then tap "p" to open up the POWER symbol library (you can also tap a, but searching in p will be faster because there's less symbols), and search for "1V1" and "3V3" and place the 1.1V on the VREG\_VOUT and DVDD, and 3.3V on the IOVDD and those other pins.

![Pasted image 20250925072502.png](/images/Pasted%20image%2020250925072502.png)
...
![Pasted image 20250925102628.png](/images/Pasted%20image%2020250925102628.png)
...
![Pasted image 20250925103109.png](/images/Pasted%20image%2020250925103109.png)
...
![Pasted image 20250925103224.png](/images/Pasted%20image%2020250925103224.png)
...
![Pasted image 20250925103733.png](/images/Pasted%20image%2020250925103733.png)
...
![Pasted image 20250925105339.png](/images/Pasted%20image%2020250925105339.png)
...
To do this, tap global label in the right hand toolbar, type in the name for your label (USB\_D+ and USB\_D-), and add them to the pins:

![Pasted image 20250925164006.png](/images/Pasted%20image%2020250925164006.png) Next, pulldown the CC pins through a 5.1K resistor to GND to enable power to go through the USB-C receptacle. Open up the symbol library, and then type "r" the shorthand for resistors, and then place it down and edit the value to be 5.1K:

![Pasted image 20250925163923.png](/images/Pasted%20image%2020250925163923.png)
...
So add in the **NCP1117-3.3\_SOT223** symbol, wire GND and attach VBUS to the VI (voltage input) of the LDO.

![Pasted image 20250925163857.png](/images/Pasted%20image%2020250925163857.png)
...
![Pasted image 20250925163830.png](/images/Pasted%20image%2020250925163830.png)
...
![Pasted image 20250925163756.png](/images/Pasted%20image%2020250925163756.png)
...
So wire the USB D+ and D- pairs into the MCU USB\_DP and USB\_DM (the P is for + and the M is for -) through 27 ohm resistors:

![Pasted image 20250925164239.png](/images/Pasted%20image%2020250925164239.png)
...
![Pasted image 20250926064330.png](/images/Pasted%20image%2020250926064330.png)
...
![Pasted image 20250926064501.png](/images/Pasted%20image%2020250926064501.png)
...
![Pasted image 20250926063705.png](/images/Pasted%20image%2020250926063705.png)
...
![Pasted image 20250926064920.png](/images/Pasted%20image%2020250926064920.png)
...
![Pasted image 20250926085431.png](/images/Pasted%20image%2020250926085431.png) It has 4 major pins you need to understand:
...
![Pasted image 20250926090037.png](/images/Pasted%20image%2020250926090037.png)
...
![Pasted image 20250926091004.png](/images/Pasted%20image%2020250926091004.png)

Next, add in our flash memory IC (chip), **W25Q128JVS**, and wire up all the QSPI pins, and put GND to GND, and VCC to 3.3V:

![Pasted image 20250926091609.png](/images/Pasted%20image%2020250926091609.png)
...
![Pasted image 20250926093017.png](/images/Pasted%20image%2020250926093017.png)
...
![Pasted image 20250928011101.png](/images/Pasted%20image%2020250928011101.png)
...
![Pasted image 20251001072358.png](/images/Pasted%20image%2020251001072358.png)
...
![Pasted image 20250928145822.png](/images/Pasted%20image%2020250928145822.png)
...
![Pasted image 20250928150705.png](/images/Pasted%20image%2020250928150705.png)
...
Next, we'll just add in all the pins, and we'll just leave out the ones we don't know yet like VSYS, 3V3\_EN and ADC\_VREF, I'll explain those after:

![Pasted image 20250928205318.png](/images/Pasted%20image%2020250928205318.png)
...
We also don't need 3V3\_EN, and then ADC\_VREF is kind of just another thing to give a reference voltage to ADC, but it isn't really necessary, and we're just making a simple devboard so we won't use it.
...
![Pasted image 20250928210525.png](/images/Pasted%20image%2020250928210525.png)
...
![Pasted image 20250928210731.png](/images/Pasted%20image%2020250928210731.png)
...
![Pasted image 20250928210917.png](/images/Pasted%20image%2020250928210917.png)
...
![Pasted image 20250928211031.png](/images/Pasted%20image%2020250928211031.png)
...
![Pasted image 20250928211106.png](/images/Pasted%20image%2020250928211106.png)
...
![Pasted image 20250928211235.png](/images/Pasted%20image%2020250928211235.png)
...
![Pasted image 20250928211327.png](/images/Pasted%20image%2020250928211327.png)
...
![Pasted image 20250928211526.png](/images/Pasted%20image%2020250928211526.png)
...
*   **USB\_C\_Receptacle\_HRO\_TYPE-C-31-M-12**: JLCPCB doesn't have any basic part USB-C receptacles, so I just chose this one I kind of like from a previous board. [PART](https://jlcpcb.com/partdetail/Korean_HropartsElec-TYPE_C_31_M12/C165948)
*   **PinHeader\_1x20\_P2.54mm\_Vertical**: This is just the proper size header pins we need, they should be through hole/THT to be stronger instead of SMD, I mean if you wanted to, it could be SMD though. The part is just pin headers I'll buy separately
*   **SW\_Push\_SPST\_NO\_Alps\_SKRK**: This is a small SMD size button footprint found in the JLCPCB _basic_ library, so it doesn't cost anything extra and is pretty compact. This isn't actually the EXACT footprint, but it's close by like .1mm, and I found it by just scrolling through footprints with some filters. [PART](https://jlcpcb.com/partdetail/XUNPU-TS_1088AR02016/C720477)
*   **Crystal\_SMD\_3225-4Pin\_3.2x2.5mm**: I found this crystal on JLCPCB basic parts, and looked at the datasheet to find the footprint. You really have to make sure your crystal footprint pinout is proper because lots of people accidentally use the wrong footprint or symbol. [PART](https://jlcpcb.com/partdetail/YXC_CrystalOscillators-X322512MSB4SI/C9002)
...
![Pasted image 20250928023842.png](/images/Pasted%20image%2020250928023842.png)
...
![Pasted image 20250928211730.png](/images/Pasted%20image%2020250928211730.png)
...
![Pasted image 20250928214035.png](/images/Pasted%20image%2020250928214035.png)
...
![Pasted image 20250928214259.png](/images/Pasted%20image%2020250928214259.png)
...
![Pasted image 20250928225148.png](/images/Pasted%20image%2020250928225148.png)
...
![Pasted image 20250928225551.png](/images/Pasted%20image%2020250928225551.png)
...
![Pasted image 20250928230231.png](/images/Pasted%20image%2020250928230231.png)

Then, I'm going to center the USB-C, down a bit to the top of the devboard:

![Pasted image 20250928230453.png](/images/Pasted%20image%2020250928230453.png)

Now looking at the flash memory and LDO IC, they're really big, so let's use different components for them:

![Pasted image 20250928231949.png](/images/Pasted%20image%2020250928231949.png)
...
![Pasted image 20250929111310.png](/images/Pasted%20image%2020250929111310.png)

And then, we're going to change the flash memory to what the Pi Pico uses and has a slightly smaller package, which is the **W25Q16JVZPIQ TR** and uses the **Package\_SON:Winbond\_USON-8-1EP\_3x2mm\_P0.5mm\_EP0.2x1.6mm** footprint, so switch the footprint to that new one!

![Pasted image 20250929112550.png](/images/Pasted%20image%2020250929112550.png)

Now your footprints should be much better:

![Pasted image 20250929112732.png](/images/Pasted%20image%2020250929112732.png)
...
![Pasted image 20250929113626.png](/images/Pasted%20image%2020250929113626.png)
...
![Pasted image 20250929114427.png](/images/Pasted%20image%2020250929114427.png)
...
![Pasted image 20250929120135.png](/images/Pasted%20image%2020250929120135.png)
...
![Pasted image 20250929121131.png](/images/Pasted%20image%2020250929121131.png)
...
![Pasted image 20250929134312.png](/images/Pasted%20image%2020250929134312.png)
...
![Pasted image 20250929134841.png](/images/Pasted%20image%2020250929134841.png)

Now to route a differential pair. First wire the USB D+'s/D-'s together:

![Pasted image 20250929163018.png](/images/Pasted%20image%2020250929163018.png)
...
![Pasted image 20250929163304.png](/images/Pasted%20image%2020250929163304.png)
...
![Pasted image 20250929155154.png](/images/Pasted%20image%2020250929155154.png)
...
![Pasted image 20250929163336.png](/images/Pasted%20image%2020250929163336.png)
...
![Pasted image 20250929161759.png](/images/Pasted%20image%2020250929161759.png)
...
![Pasted image 20250929163631.png](/images/Pasted%20image%2020250929163631.png)
...
![Pasted image 20250929164321.png](/images/Pasted%20image%2020250929164321.png)
...
![Pasted image 20250929165330.png](/images/Pasted%20image%2020250929165330.png)

![Pasted image 20250929170407.png](/images/Pasted%20image%2020250929170407.png)
...
![Pasted image 20250929171108.png](/images/Pasted%20image%2020250929171108.png)

Then, select the entire PCB with your ground fill, and then **tap "B"** to fill it:

![Pasted image 20250929171800.png](/images/Pasted%20image%2020250929171800.png)
...
![Pasted image 20250929172715.png](/images/Pasted%20image%2020250929172715.png)
...
![Pasted image 20250929203934.png](/images/Pasted%20image%2020250929203934.png)
...
![Pasted image 20250929204855.png](/images/Pasted%20image%2020250929204855.png)
...
![Pasted image 20250929205046.png](/images/Pasted%20image%2020250929205046.png)
...
![Pasted image 20250929205810.png](/images/Pasted%20image%2020250929205810.png)
...
![Pasted image 20250929210949.png](/images/Pasted%20image%2020250929210949.png)
...
![Pasted image 20250929211118.png](/images/Pasted%20image%2020250929211118.png)
...
![Pasted image 20250929211638.png](/images/Pasted%20image%2020250929211638.png)

This is how mine looks when done:

![Pasted image 20250929211919.png](/images/Pasted%20image%2020250929211919.png)
...
![Pasted image 20250929215517.png](/images/Pasted%20image%2020250929215517.png)

![Pasted image 20250929215558.png](/images/Pasted%20image%2020250929215558.png)

![Pasted image 20250929215613.png](/images/Pasted%20image%2020250929215613.png)
...
![Pasted image 20250929220810.png](/images/Pasted%20image%2020250929220810.png)
...
![Pasted image 20250929223401.png](/images/Pasted%20image%2020250929223401.png)

Next, you need to replace the headers on your BOM file, this is just changing **Designation -> Comment**

![Pasted image 20250930151428.png](/images/Pasted%20image%2020250930151428.png)
...
![Pasted image 20250929223554.png](/images/Pasted%20image%2020250929223554.png)

And now I usually make another folder called production in my root, and put this zip file inside of there:

![Pasted image 20250929223622.png](/images/Pasted%20image%2020250929223622.png)
...
![Pasted image 20250929221835.png](/images/Pasted%20image%2020250929221835.png)

![Pasted image 20250929221852.png](/images/Pasted%20image%2020250929221852.png)
...
![Pasted image 20250930151803.png](/images/Pasted%20image%2020250930151803.png)
...
![Pasted image 20250930192047.png](/images/Pasted%20image%2020250930192047.png)

Now continue on, and don't place the header pins (it'll prompt you), and then you'll see your assembled board show up:

![Pasted image 20250930155306.png](/images/Pasted%20image%2020250930155306.png)
...
![Pasted image 20250930161046.png](/images/Pasted%20image%2020250930161046.png)

Now, tap next, and **congratulations, you're done your PCB!!!!**

![Pasted image 20250930161129.png](/images/Pasted%20image%2020250930161129.png)
...
I hope you learned alot, if you want to checkout some of the other stuff I've created, check out my projects on [GitHub](https://github.com/KaiPereira) or my personal website [https://kaipereira.com/](https://kaipereira.com/)! Don't forget to post your finished projects in #ship and ping me (@KaiPereira) too!
...
![Pasted image 20251026153701.png](/images/Pasted%20image%2020251026153701.png)
