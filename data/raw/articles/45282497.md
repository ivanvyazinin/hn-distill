...
![Dirk-jan Mollema](/assets/img/thisisapicture.png)
...
Looking for a security test or training? Business contact via [outsidersecurity.nl](https://outsidersecurity.nl)

Follow

*   Both sides of a security boundary
*   [Twitter](https://twitter.com/_dirkjan)
*   [GitHub](https://github.com/dirkjanm)
...
While preparing for my Black Hat and DEF CON talks in July of this year, I found the most impactful Entra ID vulnerability that I will probably ever find. This vulnerability could have allowed me to compromise every Entra ID tenant in the world (except probably those in national cloud deployments[1](#fn:1)). If you are an Entra ID admin reading this, yes that means complete access to your tenant. The vulnerability consisted of two components: undocumented impersonation tokens, called “Actor tokens”, that Microsoft uses in their backend for service-to-service (S2S) communication. Additionally, there was a critical flaw in the (legacy) Azure AD Graph API that failed to properly validate the originating tenant, allowing these tokens to be used for cross-tenant access.
...
![Initiated by exchange and a global admin](/assets/img/actortokens/initiatedby.png)
...
[Previous](/extending-ad-cs-attack-surface-intune-certs/ "Extending AD CS attack surface to the cloud with Intune certificates
") [Next](#)

*   [GitHub](https://github.com/dirkjanm)
*   [Feed](/feed.xml)
*   [![Creative Commons License](/assets/img/cc-by.png)](http://creativecommons.org/licenses/by/4.0/)

All blog content is available under the [Creative Commons BY 4.0 License](http://creativecommons.org/licenses/by/4.0/) unless stated otherwise.  
Powered by [Jekyll](https://jekyllrb.com) and a modified version of the "Minimal Mistakes" theme.