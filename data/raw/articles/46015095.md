...
[Go](/blog/articles-by-tag.html#go) [Concurrency](/blog/articles-by-tag.html#concurrency)

**Table of contents**

*   [Accidental capture in a closure of an outer variable](#accidental-capture-in-a-closure-of-an-outer-variable)
    *   [The fix](#the-fix)
    *   [Learnings](#learnings)
*   [Concurrent use of http.Client](#concurrent-use-of-http-client)
    *   [The fix](#the-fix-1)
    *   [Learnings](#learnings-1)
*   [Improper lifetime of a mutex](#improper-lifetime-of-a-mutex)
    *   [The fix](#the-fix-2)
    *   [Learnings](#learnings-2)
*   [Concurrent reads and writes to standard library containers](#concurrent-reads-and-writes-to-standard-library-containers)
    *   [The fix](#the-fix-3)
    *   [Learnings](#learnings-3)
*   [Conclusion](#conclusion)
*   [Ideas to improve the status quo](#ideas-to-improve-the-status-quo)
...
## [Accidental capture in a closure of an outer variable](#accidental-capture-in-a-closure-of-an-outer-variable)[](#accidental-capture-in-a-closure-of-an-outer-variable)
...
## [Concurrent use of http.Client](#concurrent-use-of-http-client)[](#concurrent-use-of-http-client)
...
### [Learnings](#learnings-1)[](#learnings-1)
...
## [Improper lifetime of a mutex](#improper-lifetime-of-a-mutex)[](#improper-lifetime-of-a-mutex)
...
### [Learnings](#learnings-2)[](#learnings-2)
...
## [Concurrent reads and writes to standard library containers](#concurrent-reads-and-writes-to-standard-library-containers)[](#concurrent-reads-and-writes-to-standard-library-containers)
...
### [Learnings](#learnings-3)[](#learnings-3)

Most types in the Go standard library (or third-party libraries for that matter) are _not_ concurrency safe and synchronization is typically on you. I still often see questions on the internet about that, so assume it is not until the documentation states otherwise.
...
## [Ideas to improve the status quo](#ideas-to-improve-the-status-quo)[](#ideas-to-improve-the-status-quo)
