...
_They fixed the vulnerabilities after I literally had to cold-call their HQ pretending to know security employees. This is that story._
...
_"User has successfully registered" - That was surprisingly easy_
...
_They email you the password in plaintext. In 2025._
...
_"McDonald's highly confidential and proprietary information. For internal use by McDonald's system only and not for distribution."_
...
_TRT's "Start Impersonation" feature - accessible to crew members_
...
_Testing order field validation_
...
_Still think about those nuggets sometimes. And my friend who lost their job. Corporate security is weird._
