...
If you liked this post, consider [subscribing](https://buttondown.com/seangoedecke) to email updates about my new posts, or [sharing it on Hacker News](https://news.ycombinator.com/submitlink?u=https://www.seangoedecke.com/ai-agents-and-code-review/&t=If you are good at code review, you will be good at using AI agents).

September 20, 2025 │ Tags: [ai](/tags/ai/)

* * *

[subscribe](https://buttondown.com/seangoedecke) │ [about](/about) │ [popular](/popular) │ [rss](/rss.xml) │ [book](/book)

*   [← The whole point of OpenAI's Responses API is to help them hide reasoning traces](/responses-api/)
