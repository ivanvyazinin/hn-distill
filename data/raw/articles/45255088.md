...
**[Basic debugging techniques](./debug.html#g0)**

**1.1.** 

**[Kinds of failure](./debug.html#g1)**

**1.2.** 

**[Understanding error messages](./debug.html#g2)**

**1.3.** 

**[Staring at the code](./debug.html#g3)**

**1.4.** 

**[Simplifying the code and input](./debug.html#g4)**

**1.5.** 

**[Printing messages](./debug.html#g5)**

**1.6.** 

**[Tracing](./debug.html#g6)**

**1.7.** 

**[Debugging load errors](./debug.html#g7)**

**2.** 

**[Advanced debugging techniques](./debug.html#g8)**

**2.1.** 

**[Entering the inspector](./debug.html#g9)**

**2.2.** 

**[Using the inspector](./debug.html#g10)**

**2.3.** 

**[Break handler](./debug.html#g11)**

**2.4.** 

**[Explicit break points](./debug.html#g12)**

**2.5.** 

**[Invoking the inspector directly](./debug.html#g13)**

When a program fails to operate as it should, it is said to have a _bug_. A bug is the root cause of an observed behavior, such as failure to terminate, failure to perform some action, termination with an error message, or merely producing incorrect results.
...
_Acknowledgements:_ This document was influenced by Gary Leaven's "Chez Scheme error messages and what they might mean," which appeared on the web around 1993.
...
Errors that pertain to variable reference or applications and some that don't pertain to any particular syntactic form or procedure aren't identified with a _name_. For example, you might see the following error message.
...
1\. For procedures bound to top-level variables, including built-in procedures, the trace syntactic form may be used. (trace _name_ ...) traces the procedures bound to the top-level variables _name_ ....
...
Error: _message_ at line _line_, char _char_ of _filename_.  
Error in _name_: _message_ at line _line_, char _char_ of _filename_.
...
The inspector is menu driven, and you can always see the available options by typing "?." For the most part, the options are self-explanatory. Consult the _[Chez Scheme Version 7 User's Guide](http://www.scheme.com/csug7)_ for a detailed description of the various options. The command "s" (show) is probably the second command (after "?") that you'll want to type; it shows the contents of the object being inspected.
