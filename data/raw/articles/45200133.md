...
*   [Index](index.html)
*   [Everything](index-full.html)
*   [RSS](rss.xml)
*   [RSS using HTML](rss-html.xml)

**About me:** My name is _Solène Rapenne_, pronouns she/her. I like learning and sharing knowledge. Hobbies: '(Qubes OS BSD OpenBSD Lisp cmdline gaming security QubesOS internet-stuff). I **love** percent and lambda characters. Qubes OS core team member, former OpenBSD developer solene@. No AI is involved in this blog.

Contact me: _solene at dataswamp dot org_ or [](https://bsd.network/@solene)_@solene@bsd.network_ (mastodon).

I'm a [freelance OpenBSD, FreeBSD, Linux and Qubes OS consultant](https://lambda-solene.eu/), this includes DevOps, DevSecOps, technical writing or documentation work.

# [Introduction to GrapheneOS](2025-01-12-intro-to-grapheneos.html)

Written by _Solène_, on 12 January 2025.  
Tags: [#android](tag-android.html) [#security](tag-security.html) [#privacy](tag-privacy.html)

[Comments on Fediverse/Mastodon](https://bsd.network/@solenepercent/113825584988118647)

# Table of contents

*   1\. [Introduction](#_Introduction)
*   2\. [What is GrapheneOS?](#_What_is_GrapheneOS?)
*   3\.  [Installation and updates](# Installation_and_updates)
*   4\. [Permission management](#_Permission_management)
*   5\. [Performance](#_Performance)
*   6\. [Security](#_Security)
*   7\. [My workflow](#_My_workflow)
*   8\. [The device itself](#_The_device_itself)
*   9\. [Conclusion](#_Conclusion)
*   10\. [Going further](#_Going_further)

# 1\. Introduction [§](#_Introduction)

This blog post is an introduction to the smartphone and security oriented operating system GrapheneOS.

[GrapheneOS official project web page](https://grapheneos.org/)
...
[GrapheneOS website: Exploitation Protection](https://grapheneos.org/features#exploit-protection)
...
This article has been useful for you? Please consider [hiring me as a freelance](https://lambda-solene.eu) or [send me a tip](https://dataswamp.org/~solene/page-donate.html).

Content under [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/legalcode).

[This blog is powered by my own Common LISP blog engine](https://dataswamp.org/~solene/tag-cl-yag.html)