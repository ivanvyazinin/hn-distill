...
Was [draft-wilde-sunset-header](/doc/draft-wilde-sunset-header/11/) (individual in art area)

Select version

*   [00](/doc/html/draft-wilde-sunset-header-00)
*   [01](/doc/html/draft-wilde-sunset-header-01)
*   [02](/doc/html/draft-wilde-sunset-header-02)
*   [03](/doc/html/draft-wilde-sunset-header-03)
*   [04](/doc/html/draft-wilde-sunset-header-04)
*   [05](/doc/html/draft-wilde-sunset-header-05)
*   [06](/doc/html/draft-wilde-sunset-header-06)
*   [07](/doc/html/draft-wilde-sunset-header-07)
*   [08](/doc/html/draft-wilde-sunset-header-08)
*   [09](/doc/html/draft-wilde-sunset-header-09)
*   [10](/doc/html/draft-wilde-sunset-header-10)
*   [11](/doc/html/draft-wilde-sunset-header-11)
*   [RFC 8594](/doc/html/rfc8594)

Compare versions

RFC 8594 draft-wilde-sunset-header-11 draft-wilde-sunset-header-10 draft-wilde-sunset-header-09 draft-wilde-sunset-header-08 draft-wilde-sunset-header-07 draft-wilde-sunset-header-06 draft-wilde-sunset-header-05 draft-wilde-sunset-header-04 draft-wilde-sunset-header-03 draft-wilde-sunset-header-02 draft-wilde-sunset-header-01 draft-wilde-sunset-header-00 RFC 8594 draft-wilde-sunset-header-11 draft-wilde-sunset-header-10 draft-wilde-sunset-header-09 draft-wilde-sunset-header-08 draft-wilde-sunset-header-07 draft-wilde-sunset-header-06 draft-wilde-sunset-header-05 draft-wilde-sunset-header-04 draft-wilde-sunset-header-03 draft-wilde-sunset-header-02 draft-wilde-sunset-header-01 draft-wilde-sunset-header-00 Side-by-side Inline

Author

[Erik Wilde](/person/erik.wilde@dret.net "Datatracker profile of Erik Wilde")[](mailto:erik.wilde%40dret.net "Compose email to erik.wilde@dret.net")  
[Email authors](mailto:rfc8594@ietf.org?subject=rfc8594 "Send email to the document authors")

RFC stream

![IETF Logo](https://static.ietf.org/dt/12.47.0/ietf/images/ietf-logo-nor-white.svg) ![IETF Logo](https://static.ietf.org/dt/12.47.0/ietf/images/ietf-logo-nor.svg)

Other formats

[txt](https://www.rfc-editor.org/rfc/rfc8594.txt) [html](https://www.rfc-editor.org/rfc/rfc8594.html) [pdf](https://www.rfc-editor.org/rfc/pdfrfc/rfc8594.txt.pdf) [bibtex](/doc/rfc8594/bibtex/)
...
Status of This Memo
   ...
   Standard; see [Section 2 of RFC 7841](/doc/html/rfc7841#section-2).

   Information about the current status of this document, any errata,
   and how to provide feedback on it may be obtained at
   [https://www.rfc-editor.org/info/rfc8594](https://www.rfc-editor.org/info/rfc8594).
...
[RFC 8594](/doc/html/rfc8594)                      Sunset Header                     May 2019

Table of Contents

   [1](#section-1).  Introduction  . . . . . . . . . . . . . . . . . . . . . . . .   [2](#page-2)
     [1.1](#section-1.1).  Temporary Resources . . . . . . . . . . . . . . . . . . .   [3](#page-3)
     [1.2](#section-1.2).  Migration . . . . . . . . . . . . . . . . . . . . . . . .   [3](#page-3)
     [1.3](#section-1.3).  Retention . . . . . . . . . . . . . . . . . . . . . . . .   [3](#page-3)
     [1.4](#section-1.4).  Deprecation . . . . . . . . . . . . . . . . . . . . . . .   [3](#page-3)
   [2](#section-2).  Terminology . . . . . . . . . . . . . . . . . . . . . . . . .   [4](#page-4)
   [3](#section-3).  The Sunset HTTP Response Header Field . . . . . . . . . . . .   [4](#page-4)
   [4](#section-4).  Sunset and Caching  . . . . . . . . . . . . . . . . . . . . .   [5](#page-5)
   [5](#section-5).  Sunset Scope  . . . . . . . . . . . . . . . . . . . . . . . .   [6](#page-6)
   [6](#section-6).  The Sunset Link Relation Type . . . . . . . . . . . . . . . .   [6](#page-6)
   [7](#section-7).  IANA Considerations . . . . . . . . . . . . . . . . . . . . .   [7](#page-7)
     [7.1](#section-7.1).  The Sunset Response Header Field  . . . . . . . . . . . .   [7](#page-7)
     [7.2](#section-7.2).  The Sunset Link Relation Type . . . . . . . . . . . . . .   [8](#page-8)
   [8](#section-8).  Security Considerations . . . . . . . . . . . . . . . . . . .   [8](#page-8)
   [9](#section-9).  Example . . . . . . . . . . . . . . . . . . . . . . . . . . .   [9](#page-9)
   [10](#section-10). References  . . . . . . . . . . . . . . . . . . . . . . . . .  [10](#page-10)
     [10.1](#section-10.1).  Normative References . . . . . . . . . . . . . . . . . .  [10](#page-10)
     [10.2](#section-10.2).  Informative References . . . . . . . . . . . . . . . . .  [10](#page-10)
   Acknowledgements  . . . . . . . . . . . . . . . . . . . . . . . .  [10](#page-10)
   Author's Address  . . . . . . . . . . . . . . . . . . . . . . . .  [11](#page-11)
...
[1.1](#section-1.1).  Temporary Resources
...
[RFC 8594](/doc/html/rfc8594)                      Sunset Header                     May 2019
   ...
   [Section 5](#section-5) discusses how the scope of the Sunset header field may
...
[2](#section-2).  Terminology
   ...
   [BCP 14](/doc/html/bcp14) \[[RFC2119](/doc/html/rfc2119 "\"Key words for use in RFCs to Indicate Requirement Levels\"")\] \[[RFC8174](/doc/html/rfc8174 "\"Ambiguity of Uppercase vs Lowercase in RFC 2119 Key Words\"")\] when, and only when, they appear in all
   capitals, as shown here.

[3](#section-3).  The Sunset HTTP Response Header Field
   ...
   in [Section 7.1.1.1 of \[RFC7231\]](/doc/html/rfc7231#section-7.1.1.1), and SHOULD be a timestamp in the
   future.
...
[4](#section-4).  Sunset and Caching

   It should be noted that the Sunset HTTP response header field serves
   a different purpose than HTTP caching \[[RFC7234](/doc/html/rfc7234 "\"Hypertext Transfer Protocol (HTTP/1.1): Caching\"")\].  HTTP caching is
...
[5](#section-5).  Sunset Scope
   ...
   resource.  However, as discussed in [Section 1.4](#section-1.4), there may be
...
[6](#section-6).  The Sunset Link Relation Type
...
[7.1](#section-7.1).  The Sunset Response Header Field

   The Sunset response header field has been added to the "Permanent
   Message Header Field Names" registry (see \[[RFC3864](/doc/html/rfc3864 "\"Registration Procedures for Message Header Fields\"")\]), taking into
   account the guidelines given by HTTP/1.1 \[[RFC7231](/doc/html/rfc7231 "\"Hypertext Transfer Protocol (HTTP/1.1): Semantics and Content\"")\].
      ...
      Reference: [RFC 8594](/doc/html/rfc8594)
...
[7.2](#section-7.2).  The Sunset Link Relation Type

   The sunset link relation type has been added to the permanent "Link
   Relation Types" registry according to [Section 4.2 of \[RFC8288\]](/doc/html/rfc8288#section-4.2):
...
[10.1](#section-10.1).  Normative References
   ...
   \[RFC7231\]  Fielding, R., Ed. and J. Reschke, Ed., "Hypertext Transfer
              Protocol (HTTP/1.1): Semantics and Content", [RFC 7231](/doc/html/rfc7231),
   ...
   \[RFC8288\]  Nottingham, M., "Web Linking", [RFC 8288](/doc/html/rfc8288),
...
[10.2](#section-10.2).  Informative References
   ...
   \[RFC7234\]  Fielding, R., Ed., Nottingham, M., Ed., and J. Reschke,
              ...
              [RFC 7234](/doc/html/rfc7234), DOI 10.17487/RFC7234, June 2014,
...
Author's Address
   ...
   URI:   [http://dret.net/netdret/](http://dret.net/netdret/)

Wilde                         Informational                    \[Page 11\]

[Datatracker](/doc/rfc8594/)
