When Curl Works But IntelliJ Doesn’t: The Ollama Connection Mystery :: The Tymscar Blog
...
2025-09-05Oscar Molnar3 min read (599 words)

#[macOS](/tags/macos/)  #[development](/tags/development/)  #[jetbrains](/tags/jetbrains/)  #[debugging](/tags/debugging/)  #[networking](/tags/networking/) 
...
## False Start #1: “Maybe IntelliJ just doesn’t support HTTPS here”[#](#false-start-1-maybe-intellij-just-doesnt-support-https-here)
...
## False Start #2: “macOS local network permission?”[#](#false-start-2-macos-local-network-permission)

Checked System Settings > Privacy & Security > Local Network. IntelliJ was already allowed. Nothing to toggle. Still failed.

## False Start #3: “Firewall?”[#](#false-start-3-firewall)
...
## What was really happening[#](#what-was-really-happening)
...
[\[I washed my Yubikey twice by accident. Here's how I saved it both times.\] >](/posts/yubicowashingmachine/)
