...
[![Nick Yoder](https://nickyoder.com/content/images/2023/05/Logo-2-1.png)](https://nickyoder.com)

*   [Home](https://nickyoder.com/)
*   [About Me](https://nickyoder.com/about-me/)
*   [What I'm Reading](https://nickyoder.com/reading/)
*   [Travel](https://nickyoder.com/travel/)
*   [Collaboration](https://nickyoder.com/collaboration/)

[Sign in](#/portal/signin) [Subscribe](#/portal/signup)

[Machine Learning](/tag/machine-learning/) Featured

# Beyond Orthogonality: How Language Models Pack Billions of Concepts into 12,000 Dimensions

*   [![Nicholas Yoder](/content/images/size/w100/2020/07/Nicholas-Yoder-3.jpg)](/author/nick/)

#### [Nicholas Yoder](/author/nick/)

20 Feb 2025 • 8 min read

![Beyond Orthogonality: How Language Models Pack Billions of Concepts into 12,000 Dimensions](/content/images/size/w2000/2025/02/Dimensions.png)

In a recent [3Blue1Brown video series](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&ref=nickyoder.com) on transformer models, Grant Sanderson posed a fascinating question: How can a relatively modest embedding space of 12,288 dimensions (GPT-3) accommodate millions of distinct real-world concepts?

The answer lies at the intersection of high-dimensional geometry and a remarkable mathematical result known as the [Johnson-Lindenstrauss lemma](https://stanford.edu/class/cs114/readings/JL-Johnson.pdf?ref=nickyoder.com). While exploring this question, I discovered something unexpected that led to an interesting collaboration with Grant and a deeper understanding of vector space geometry.
...
loss = (dot\_products.abs()).relu().sum()  
...
loss = exp(20\*dot\_products.abs()\*\*2).sum() ([Full code here](https://github.com/NickYoder86/Johnson-Lindenstrauss?ref=nickyoder.com))
...
While most practitioners use values between 4 and 8 as a conservative choice for [random projections](http://www.yaroslavvb.com/papers/achlioptas-database.pdf?ref=nickyoder.com), the optimal value of C remains an open question. As we'll see in the experimental section, engineered projections can achieve much lower values of C, with profound implications for embedding space capacity.
...
When we move from random projections to engineered solutions, the theoretical bounds for C of the JL lemma become surprisingly conservative. While a [Hadamard matrix transformation](https://documents.uow.edu.au/~jennie/WEBPDF/175_1992.pdf?ref=nickyoder.com) with random elements can reliably achieve a C value between 2.5 and 4 in a single pass, our GPU experiments suggest even more efficient arrangements are possible through optimization.
...
![](https://nickyoder.com/content/images/2025/02/Screenshot-2025-02-18-at-3.19.12-PM.png)

Experimental values of C (GPU optimization)

Several key observations emerge from this data:

1.  The value of C initially rises with N, reaching a maximum around ~0.9 (notably always below 1.0)
2.  After peaking, C begins a consistent downward trend
3.  At high ratios of N to K, we observe C values trend below 0.2

![](https://nickyoder.com/content/images/2025/02/Screenshot-2025-02-20-at-12.07.39-PM.png)
...
1.  C = 4: A conservative choice for random projections with Hadamard matrices
2.  C = 1: A likely upper bound for optimized or emergent embeddings
3.  C = 0.2: A value suggested by our experiments for very large spaces

![](https://nickyoder.com/content/images/2025/02/Screenshot-2025-02-20-at-1.20.34-PM.png)
...
1.  **Efficient Dimensionality Reduction**: The robustness of random projections, particularly when combined with Hadamard transformations (or [BCH coding](https://www.ece.unb.ca/tervo/ece4253/bch.shtml?ref=nickyoder.com)), provides a computationally efficient way to work with high-dimensional data. No complex optimization required – the mathematics of high-dimensional spaces does the heavy lifting for us.
2.  **Embedding Space Design**: Understanding the true capacity of high-dimensional spaces helps explain how transformer models can maintain rich, nuanced representations of language in relatively compact embeddings. Concepts like "Canadian," "morose," "Hitchcockian," "handsome," "whimsical," and "Muppet-like" can all find their place in the geometry while preserving their subtle relationships to each other.
...
[My code for Hadamard and optimized projections](https://github.com/NickYoder86/Johnson-Lindenstrauss?ref=nickyoder.com).
...
I would also like to thank [Suman Dev](https://www.linkedin.com/in/suman-dev-3529a872/?ref=nickyoder.com) for his help in optimizing the GPU code.
...
1.  [Sphere Packings, Lattices and Groups](https://www.scribd.com/document/345998742/sphere-packing-lattices-and-groups-10-1-1-66-8958-pdf?ref=nickyoder.com) by Conway and Sloane
2.  [Database-friendly random projections: Johnson-Lindenstrauss with binary coins](https://www.sciencedirect.com/science/article/pii/S0022000003000254?ref=nickyoder.com) by Achlioptas
3.  [Hadamard Matrices, Sequences, and Block Designs](https://documents.uow.edu.au/~jennie/WEBPDF/175_1992.pdf?ref=nickyoder.com) by Seberry and Yamada
...
[![GPT-2: Feature Influence](/content/images/size/w600/2025/05/GPT-Feature-2.png)](/gpt-2-feature-influence/)
...
[![A Mathematical Constraint on Reality: Why the Universe Must Be 11-Dimensional](/content/images/size/w600/2025/06/11-Dimensions.png)](/a-mathematical-constraint-on-reality-why-the-universe-must-be-11-dimensional/)
...
[![Hemisphere's Plot](/content/images/size/w600/2025/04/Screenshot-2025-04-25-at-1.55.49-AM.png)](/hemispheres-plot/)
...
[Nick Yoder](https://nickyoder.com) © 2025
