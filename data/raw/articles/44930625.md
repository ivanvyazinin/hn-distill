...
[Good News Everyone:  VictoriaLogs Cluster Version Is Now Available!](https://docs.victoriametrics.com/victorialogs/cluster/)
...
*   [Our Products](/products/)
    *   [VictoriaMetrics](/products/open-source/)
    *   [VictoriaLogs](/products/victorialogs/)
    *   [VictoriaMetrics Enterprise](/products/enterprise/)
    *   [VictoriaMetrics Cloud](/products/cloud/)
    *   [VictoriaMetrics Anomaly Detection](/products/enterprise/anomaly-detection/)
...
*   [Resources](/resources/)
    ...
    *   [Security](/security/)
*   [Support](#)
    *   [Enterprise Support](/support/enterprise-support/)
    *   [Community Support](/support/community-support/)
*   [About Us](/about-us/)
    *   [The Team](/team/)
    *   [Customers](/customers/)
    *   [News & Articles](/news/)
...
by [Phuong Le](/blog/authors/phuong-le/) on Aug 8, 2025 12 Minutes Read

[Blog /](/blog/)

[Open Source Tech](/blog/categories/open-source-tech/) [VictoriaLogs](/blog/categories/victorialogs/)

Share:

[](https://www.linkedin.com/shareArticle?mini=true&url=https://victoriametrics.com/blog/victorialogs-concepts-message-time-stream/&title=VictoriaLogs%20Practical%20Ingestion%20Guide%20for%20Message%2c%20Time%20and%20Streams&summary=VictoriaLogs%20Practical%20Ingestion%20Guide%20for%20Message%2c%20Time%20and%20Streams&https://victoriametrics.com/blog/victorialogs-concepts-message-time-stream/)[](https://twitter.com/intent/tweet/?text=VictoriaLogs%20Practical%20Ingestion%20Guide%20for%20Message%2c%20Time%20and%20Streams&url=https://victoriametrics.com/blog/victorialogs-concepts-message-time-stream/)[](mailto:?subject=VictoriaLogs%20Practical%20Ingestion%20Guide%20for%20Message%2c%20Time%20and%20Streams&body=https://victoriametrics.com/blog/victorialogs-concepts-message-time-stream/ "E-Mail")

![VictoriaLogs Practical Ingestion Guide for Message, Time and Streams](/blog/victorialogs-concepts-message-time-stream/preview.jpg)
...
You would choose the `service` field as the _stream field_. So every log coming from a service will be put into one bucket (log stream).

Why does the database do this? Because it writes logs of a stream together on disk and compresses them into blocks.

![Logs organized into service-specific blocks](/blog/victorialogs-concepts-message-time-stream/victorialogs-stream-block-organization.png)
...
For instance, if you query using the `service` stream field, the results will be very fast. For example, you can use the LogsQL [stream filter](https://docs.victoriametrics.com/victorialogs/logsql/#stream-filter) to find logs for the payment service or gateway service:
...
![Query targets only relevant service blocks](/blog/victorialogs-concepts-message-time-stream/query-block-targeting.png)
...
![Single service stream creates many blocks](/blog/victorialogs-concepts-message-time-stream/fat-stream-logs.png)
...
![High cardinality: many unique user streams](/blog/victorialogs-concepts-message-time-stream/high-cardinality-streams.png)
...
[victorialogs](/blog/tags/victorialogs/), [opensources](/blog/tags/opensources/), [structured logs](/blog/tags/structured-logs/)

Leave a comment below or [Contact Us](/contact-us/) if you have any questions!
...
*   [VictoriaLogs Concepts](#victorialogs-concepts)
    *   [Message and Time](#message-and-time)
    *   [Stream](#stream)
...
## Watch Your Monitoring SkyRocket With VictoriaMetrics!
 ...
 I agree to share my contact information in order to get the demo offer.  
Don't worry, we don't spam!

*   [VictoriaMetrics](/products/open-source/)
*   [LogsQL](/products/logsql/)
*   [VictoriaMetrics Enterprise](/products/enterprise/)
*   [Monitoring of Monitoring](/products/mom/)
*   [VictoriaMetrics Cloud](/products/cloud/)
*   [VictoriaMetrics Anomaly Detection](/products/enterprise/anomaly-detection/)
*   [Metrics QL](/products/metricsql/)
*   [Plans & Features](/plans-features/)
*   [VictoriaLogs](/products/victorialogs/)
*   [Status Page](https://status.victoriametrics.com/)
...
*   [News & Articles](/news/)
*   [24hr Support](/support/)

*   [Privacy Policy](https://victoriametrics.com/legal/privacy-policy/)
*   [Disclosure Policy](https://victoriametrics.com/legal/disclosure-policy/)
*   [Cookie Use Policy](https://victoriametrics.com/legal/cookie-use-policy/)
*   [Enterprise Solution Agreement](https://victoriametrics.com/legal/esa/)

Oops, it looks like something went wrong! Please let us know here [Contact Us](/contact-us/).

[](https://www.linkedin.com/company/victoriametrics/)[](https://t.me/VictoriaMetrics_en)[](https://slack.victoriametrics.com/)[](https://twitter.com/VictoriaMetrics)[](https://github.com/VictoriaMetrics/VictoriaMetrics)[](/index.xml)

© 2019-2025 VictoriaMetrics
