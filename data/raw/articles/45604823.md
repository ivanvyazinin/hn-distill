...
Introducing Rill’s MCP server—a new chapter for conversational BI.

[Learn more](https://www.rilldata.com/mcp)

[![rill data logo](https://cdn.prod.website-files.com/659ddac460dbacbdc813b204/659f844796d68d4f86cbd785_rill%20logo%20white.svg)](/)
...
](/powering-self-serve-analytics-for-a-leading-audio-advertising-platform)[
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/67a126af97f65dba2fd38b05_Pivot%20tables%20(2).png)
...
![](https://cdn.prod.website-files.com/659ddac460dbacbdc813b204/65a1da9eef99d904bb7f4b72_c6b670bc0b90b6abcfcdb0916a33e6c1.webp)

![](https://cdn.prod.website-files.com/659ddac460dbacbdc813b204/65a1dc52fa5edfde7722ebb0_Raster%20bg.svg)
...
_Pivot table with quickly exploring the data and changing dimensions | Video by_ [_Excel Campus - Jon_](https://www.youtube.com/watch?v=F9WgF1K_K2g)
...
_Pivot table combined with charts and dashboards | Video by_ [_Excel Campus - Jon_](https://www.youtube.com/watch?v=F9WgF1K_K2g)
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/67a0ed9ab8915baa4f168e57_67a0ebcb55b40c861b508725_upload_0049909858c0e948b4731fa26f9dda0a.png)
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/679bd8bb4f68d310cf0e67de_679bd830dc2b4fb8ea3727bb_upload_ba6831fc4801b8f543534da72096fe80.png)

Early Spreadsheet Software | Image by [Not Boring by Packy McCormick](https://www.notboring.co/p/excel-never-dies)
...
<ul>  
   <li>  
       1993: Excel 5.0 - Introduction of <strong>PivotTables</strong> and Visual Basic for Applications (<strong>VBA</strong>)  
   </li>  
   <li>  
       2006: Excel 2007 - Major UI overhaul with <strong>Ribbon</strong> interface and increased <strong>row/column limits</strong> (1M+ rows) with the VertiPaq engine (in-memory columnar database) that to this day powers MS Excel, Power Pivot, SQL Server Analysis Services (SSAS) Tabular, and Power BI)  
       <ul>  
           <li>2010-2012: Power Tools Era</li>  
           <li><strong>Power Query</strong> (later renamed Get & Transform)</li>  
           <li><strong>PowerPivot</strong> with DAX language</li>  
           <li><strong>Power View</strong> for interactive visualizations</li>  
           <li><strong>Power Map</strong> (later renamed <strong>3D Maps</strong>) for geographical visualization</li>  
       </ul>  
   </li>  
   <li>  
...
       <ul>  
           <li><strong>Power BI</strong> integration</li>  
           <li><strong>Python</strong> in Excel (2023)</li>  
       </ul>  
   </li>  
   <li>  
       Key BI-specific tools:  
       <ul>  
           <li><a href="https://support.microsoft.com/en-us/office/load-the-analysis-toolpak-in-excel-6a63e598-cd6d-42e3-9317-6b40ba1a66b4">Analysis ToolPak</a> (statistical analysis)</li>  
           <li><a href="https://support.microsoft.com/en-us/office/define-and-solve-a-problem-by-using-solver-5d1a388f-079d-43ac-a7eb-f63e45925040">Solver</a> (optimization)</li>  
           <li>Cube functions (OLAP integration)</li>  
       </ul></li></ul>  
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/67a0ed9ab8915baa4f168e49_67a0ec688df7e0db38d572db_upload_2e4384e279e80d3c46d17c6cb0ff2a47.png)

Complex SQL vs. simple Pivot Table
...
«The Human Factor» of data, and what makes an intuitive data tool. A tool is intuitive if we are familiar with it, if it's simple, if we can control it, and if we trust it. We achieve this by having **well-defined, built-in constraints**, leading to standardization across the board.
...
<img src="https://cdn.prod.website-files.com/659ddac460dbacbdc813b204/67a11dd131e6bcfa6a460441\_meme-bell-curve.png" alt="A typical flow of emotions we go through the years - from starting with simple pivot tables to advanced solutions, back to pivot tables">  
...
If you want to know more about this, read the [great answers](https://sh.reddit.com/r/excel/comments/ll87se/am_i_missing_anything_by_never_using_pivot_tables/) on Reddit, what people say, and why pivot tables are something you don't want to miss once you use them.
...
With the added SQL query features of [table formats](https://www.onehouse.ai/blog/apache-hudi-vs-delta-lake-vs-apache-iceberg-lakehouse-feature-comparison) (Iceberg, Hudi, and Delta) to distributed files, this may be a matter of time.
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/68c1ab2fef28eb2b950bb002_featured-image.png)
...
![](https://cdn.prod.website-files.com/659ddac460dbacbdc813b204/67949bbac017499ff6b2220e_Frame%20(2).svg)
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/685496bf6ab0a732ce9baf5a_Self-serve%20BI%20blog%20post%20hero%20(1).png)
...
![](https://cdn.prod.website-files.com/65a86746782488f38259fe35/6824f5f9147414054442de61_Iceberg%20Blog%20Hero%20(1).png)
...
![](https://cdn.prod.website-files.com/659ddac460dbacbdc813b204/65a1dc140974f8f5956bce79_Lines.svg)
...
](https://discord.com/invite/ngVV4KzEGv)[
...
[Overview](/product)[Pricing](/pricing)[Github](https://github.com/rilldata/rill)[Apache Druid](/apache-druid)
...
[Documentation](https://docs.rilldata.com/)[Example demos](https://docs.rilldata.com/example-projects)[Case studies](/case-studies)[Release notes](https://docs.rilldata.com/notes/)[Blog](/blog)[Events](/events)

Solutions

[Programmatic advertising](/programmatic-advertising)[Infrastructure monitoring](/infrastructure-monitoring)[Product analytics](/product-analytics)[IoT & logistics](/iot-logistics)

About Us

[Team](/team)[Careers](/careers)[Contact us](/contact)

© 2025 Rill Data, Inc · San Francisco, CA.
