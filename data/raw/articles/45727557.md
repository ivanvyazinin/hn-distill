...
The traits are a bit similar to [Stream](https://docs.rs/futures/latest/futures/stream/trait.Stream.html) and [Sink](https://docs.rs/futures/latest/futures/io/struct.Sink.html), but with two important additions.

*   We allow sending and receiving [Bytes](https://docs.rs/bytes/latest/bytes/struct.Bytes.html), since iroh streams work with bytes internally. That way we avoid a copy in the default case.
...
We will have this as an optional feature of [sendme](https://www.iroh.computer/sendme) in one of the next releases.
