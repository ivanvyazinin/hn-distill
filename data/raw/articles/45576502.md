...
[↑ Copy-and-Patch ↑](/copy-and-patch/) [How It Works ↦](/copy-and-patch/how-it-works.html)
...
1.  const\_int\_reg1: `a = 1;`
    
2.  const\_int\_reg2: `b = 2;`
    
3.  add\_int1\_int2: `c = a + b;`
    
4.  return\_int1: `return c;`
    

And to define our copy-and-patch JIT, we’ll take each of these and:

1.  Implement the operation in C with relocation holes to be later patched to form our stencil.
    
2.  Compile the stencil into native code.
    
3.  Copy-paste the native code back into a C file with functions to emit it to a buffer and patch any relocations.
...
$ clang cnp\_jit.c cnp\_stencils.c -o cnp\_jit
$ ./cnp\_jit
JIT'd 1 + 2 = 3
...
0000000000000000 <fused\_multiply\_add\_sqrt\_ifnotzero>:
   0:	50                   	push   rax
   1:	b8 00 00 00 00       	mov    eax,0x0
			2: R\_X86\_64\_32	cnp\_small\_value\_hole\_2
   6:	b9 00 00 00 00       	mov    ecx,0x0
			7: R\_X86\_64\_32	cnp\_small\_value\_hole\_1
   b:	0f af c8             	imul   ecx,eax
   e:	48 b8 00 00 00 00 00 	movabs rax,0x0
  15:	00 00 00
			10: R\_X86\_64\_64	cnp\_large\_value\_hole\_1
  18:	48 01 c8             	add    rax,rcx
  1b:	75 05                	jne    22 <fused\_multiply\_add\_sqrt\_ifnotzero+0x22>
  1d:	e8 00 00 00 00       	call   22 <fused\_multiply\_add\_sqrt\_ifnotzero+0x22>
			1e: R\_X86\_64\_PLT32	cnp\_near\_func\_hole\_1-0x4
  22:	48 b8 00 00 00 00 00 	movabs rax,0x0
  29:	00 00 00
			24: R\_X86\_64\_64	cnp\_far\_func\_hole\_1
  2c:	48 bf 00 00 00 00 00 	movabs rdi,0x0
  33:	00 00 00
			2e: R\_X86\_64\_64	cnp\_large\_value\_hole\_1
  36:	ff d0                	call   rax
  38:	49 89 c4             	mov    r12,rax
  3b:	58                   	pop    rax
  3c:	e9 00 00 00 00       	jmp    41 <fused\_multiply\_add\_sqrt\_ifnotzero+0x41>
			3d: R\_X86\_64\_PLT32	cnp\_stencil\_output-0x4
