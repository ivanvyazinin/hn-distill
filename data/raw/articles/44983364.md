What about using rel=”share-url” to expose sharing intents? – Terence Eden’s Blog                       
...
[HTML](https://shkspr.mobi/blog/tag/html/) [standards](https://shkspr.mobi/blog/tag/standards/) [webdev](https://shkspr.mobi/blog/tag/webdev/) · [1 comment](https://shkspr.mobi/blog/2025/08/what-about-using-relshare-url-to-expose-sharing-intents/#comments) · 450 words

* * *

[](https://shkspr.mobi/blog/wp-content/uploads/2025/08/share-on.webp)
...
![Screenshot. "Share this page on" followed by colourful icons for popular social networks.](https://shkspr.mobi/blog/wp-content/uploads/2025/08/share-on.webp)

You click the relevant icon and get taken to the site with the sharing details pre-filled.

![Screenshot of the Telegram sharing page.](https://shkspr.mobi/blog/wp-content/uploads/2025/08/telegram.webp)
...
As you can see, some only allow a URL, some text and a URL, and some just a plain text which could contain the URl. A bit of a mess! It's probably impossible to get every site to agree on a standard for their sharing intent. But there _could_ be a standard for exposing their existing sharing mechanism.

That's the proposal from [Ben Werdmuller](https://about.werd.io/) with "[Share Openly](https://shareopenly.org/integrate/)".
...
For sites which take a URl and an (optional) title, the meta element looks like:
 ...
 ![](https://shkspr.mobi/blog/wp-content/plugins/tempest-highlight//svg/html.svg) HTML`<link rel="share-url" href="https://www.facebook.com/sharer.php?u={url}&t={text}"> <link rel="share-url" href="https://lemmy.world/create_post?url={url}&title={text}">`

For those which only take URl, it looks like:

 ![](https://shkspr.mobi/blog/wp-content/plugins/tempest-highlight//svg/html.svg) HTML`<link rel="share-url" href="https://www.linkedin.com/sharing/share-offsite/?url={url}">`
...
It's slightly trickier for sites like Mastodon and BlueSky which only have a text sharing field and no separate URl. The current proposal is just to use the text. For example
 ...
 ![](https://shkspr.mobi/blog/wp-content/plugins/tempest-highlight//svg/html.svg) HTML`<link rel="share-url" href="https://bsky.app/intent/compose?text={text}">`

But it could be something like

 ![](https://shkspr.mobi/blog/wp-content/plugins/tempest-highlight//svg/html.svg) HTML`<link rel="share-url" href="https://mastodon.social/share?text={text}%0A{url}">`

## [What Next?](#what-next)

The HTML specification has this to say [about adding new link types](https://html.spec.whatwg.org/multipage/links.html#other-link-types):

> Extensions to the predefined set of link types may be registered on the [microformats page for existing rel values](https://microformats.org/wiki/existing-rel-values#HTML5_link_type_extensions).
...
## One thought on “What about using rel="share-url" to expose sharing intents?”

1.  [2025-08-22 12:56](https://fedi.vale.rocks/objects/aa0cf86d-6050-4832-b6ef-86726e21cc22)
    
    ![](https://files.mastodon.social/cache/accounts/avatars/111/323/825/115/020/738/original/0b5358170549fc1d.png)
    
    ###  ![](https://icons.duckduckgo.com/ip9/fedi.vale.rocks.ico) [Vale](https://fedi.vale.rocks/objects/aa0cf86d-6050-4832-b6ef-86726e21cc22) said on fedi.vale.rocks:
    
    [@Edent](https://mastodon.social/@Edent) A few years ago I ran a (flawed) little poll with the intent to get a bit of an idea of whether people use share buttons. Might be of interest.
    
    [https://fedi.vale.rocks/notice/AbMVOUA2MBBDdbOLTs](https://fedi.vale.rocks/notice/AbMVOUA2MBBDdbOLTs)
    
    [Reply](https://shkspr.mobi/blog/2025/08/what-about-using-relshare-url-to-expose-sharing-intents/?replytocom=466836#respond) | [Reply to original comment on fedi.vale.rocks](https://fedi.vale.rocks/objects/aa0cf86d-6050-4832-b6ef-86726e21cc22)
...
2.  ![](data:image/svg+xml;base64,)
    ...
    ### [More comments on Mastodon](https://mastodon.social/@Edent/115072205050108449).
    

### What are your reckons? [Cancel reply](/blog/2025/08/what-about-using-relshare-url-to-expose-sharing-intents/#respond)
...
![](/blog/okok.php?nv=0&up=0&p=62488)