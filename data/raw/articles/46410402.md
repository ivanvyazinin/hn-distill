Building a macOS app to know when my Mac is thermal throttling · Stan's blog

![](https://matomo.angristan.xyz/matomo.php?idsite=5&rec=1)
...
[macos](https://stanislas.blog/tags/macos/) [programming](https://stanislas.blog/tags/programming/)
...
In practice, when my Mac starts getting hot, from the `powermetrics` perspective it goes into `moderate`, and when it starts throttling, it goes into `heavy`. The problem is that with `ProcessInfo`, both are covered by the `fair` state, so it’s not really useful to know when the Mac is _actually_ throttling. ☹️
...
[](https://stanislas.blog/feed.xml)[](https://github.com/angristan)[](https://mstdn.io/@angristan)[](https://twitter.com/fuolpit)[](https://bsky.app/profile/fuolpit.bsky.social)[](https://linkedin.com/in/stanislas-lange)[](https://stanislas.photo)[](https://bookmarks.stanislas.blog/)

* * *

[←→ Migrating my web analytics from Matomo to Umami 22 December 2025](https://stanislas.blog/2025/12/migrating-matomo-to-umami-web-analytics/)
...
](/2025/12/claude-code-opus-open-source-maintenance/?utm_source=related)[

![Redirecting dead links to my Hugo images with a Cloudflare Worker](/2025/02/redirect-dead-links-hugo-images-cloudflare-worker/where_hu_8989e498f5e226c4.jpg)

Redirecting dead links to my Hugo images with a Cloudflare Worker 20 February 2025

](/2025/02/redirect-dead-links-hugo-images-cloudflare-worker/?utm_source=related)[

![Logging 404s on a Cloudflare Pages website with a Cloudflare Worker](/2025/02/logging-404-cloudflare-pages-website-with-worker/cloudflare-worker-dashboard-logs_hu_2de463a42a8da33a.png)

Logging 404s on a Cloudflare Pages website with a Cloudflare Worker 19 February 2025

](/2025/02/logging-404-cloudflare-pages-website-with-worker/?utm_source=related)
...
Since 2014 | [Say thanks 🙏](https://coindrop.to/stanislas) | Content under the [CC BY-NC-SA 4.0 license.](https://creativecommons.org/licenses/by-nc-sa/4.0/)