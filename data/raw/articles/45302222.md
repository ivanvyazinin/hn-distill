...
The tuner ![](/images/old-tv/sintonizador.jpg)
...
These modulators output different channels at different frequencies. ![](/images/old-tv/rca-rf.jpg)

These frequencies are what you 'tune' to by rotating the tuner's knob ([learn more about tuners here](https://hackaday.com/2016/07/11/not-quite-101-uses-for-an-analog-uhf-tv-tuner/)). I left the tv tuner in a fixed channel, the same as what the modulator outputs.

_Let there be video!_
...
Switch connected to GPIO ![](/images/old-tv/switch-gpio.jpg)
...
LM7809 and LM7805 placed using part of the TV as a heatsink ![](/images/old-tv/7805.jpg)
...
The code can be found [here](https://github.com/DavidVentura/old-tv), but be warned, it is very bad.
...
I also made a fake parcel-tracking website that'd display the status of the package. ![](/images/old-tv/tracking-1.png)

![](/images/old-tv/tracking-2.png)

# Inspiration

[This](https://hackaday.com/2017/02/23/bring-saturday-mornings-back-to-life-with-this-cartoon-server/) [guy](https://twitter.com/FozzTexx/status/825358304515747840) made me think about this in the first place. Our approaches are quite different, as I wanted to have the TV be 'stand alone'.

Feel free to send me comments, questions or feedback [via email](mailto:hello@davidv.dev).  
If you liked this content, you may also enjoy other [blogs I follow](/blogs-i-follow.html).  
There's also an [![RSS logo](/images/rss.svg) RSS feed](/rss.xml).