...
Published on 2025-11-12, 1602 words, 6 minutes to read
...
![Cadey is wat](https://stickers.xeiaso.net/sticker/cadey/wat)
...
Wait, you said that you can do _anything_ you can do on a normal PC, but you also said it's running an immutable OS. What if my definition of "anything" includes "install system packages"?

![Cadey is aha](https://stickers.xeiaso.net/sticker/cadey/aha)

[Cadey](/characters#cadey)

Good point, I'm not worried about that for two main reasons: developers have already found ways to use things like [distrobox](https://distrobox.it/) to give you islands of mutablity in an otherwise immutable system on the Steam Deck, and you can just blow away the OS and install whatever you want (such as [Bazzite](https://bazzite.gg/)) or any normal Linux distribution. You could even put Windows on it if you needed to for some reason.
...
![Cadey is hug](https://stickers.xeiaso.net/sticker/cadey/hug)
...
Served by xesite v4 (/app/bin/xesite) with site version [13ebc010](https://github.com/Xe/site/commit/13ebc010bf30216fee508a873527a8206e4da80f) , source code available [here](https://github.com/Xe/site).