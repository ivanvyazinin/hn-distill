...
![Stalwart Labs](/img/logo.svg)![Stalwart Labs](/img/logo.svg)

**Stalwart**](https://stalw.art)[Documentation](/docs/category/getting-started)

[Blog](/blog)[GitHub](https://github.com/stalwartlabs)

Search

Recent posts

*   [JMAP for Calendars, Contacts and Files now in Stalwart](/blog/jmap-collaboration)
*   [Security at the Core: Stalwart completes Second Security Audit](/blog/security-audit-2025)
*   [Stalwart Joins GitHub's Open Source Secure Fund](/blog/github-ossf)
*   [Introducing Virtual Queues and Strategy-Driven Delivery in Stalwart MTA](/blog/virtual-queues)
*   [The Future of Stalwart: Webmail, Roadmap, and Beyond](/blog/roadmap)

# JMAP for Calendars, Contacts and Files now in Stalwart

October 22, 2025 · 4 min read

[![Mauro D.](https://github.com/mdecimus.png)](https://github.com/mdecimus)

[Mauro D.](https://github.com/mdecimus)
...
## A New Generation of Protocols[​](#a-new-generation-of-protocols "Direct link to A New Generation of Protocols")
...
## Limitations of Yesterday's Technology[​](#limitations-of-yesterdays-technology "Direct link to Limitations of Yesterday's Technology")
...
## JMAP: A Modern Solution for Modern Needs[​](#jmap-a-modern-solution-for-modern-needs "Direct link to JMAP: A Modern Solution for Modern Needs")
...
## Client Support and Ecosystem[​](#client-support-and-ecosystem "Direct link to Client Support and Ecosystem")

As Stalwart is the first complete JMAP server to support these new protocols, client support is still emerging. However, we’re excited to share that several projects are already working to adopt these new standards. [Mailtemi](https://mailtemi.com/), [Parula](https://parula.beonex.com/), and [OpenCloud](https://opencloud.eu/en) are actively developing client-side implementations for **JMAP Calendars**, **Contacts**, and **File Storage**. The ecosystem is growing, and we expect rapid adoption as developers experience the elegance and power of JMAP firsthand.

## A Word of Thanks[​](#a-word-of-thanks "Direct link to A Word of Thanks")
...
## Looking Ahead to 1.0.0[​](#looking-ahead-to-100 "Direct link to Looking Ahead to 1.0.0")
...
*   [jmap](/blog/tags/jmap)
*   [calendar](/blog/tags/calendar)
*   [contacts](/blog/tags/contacts)
*   [files](/blog/tags/files)
*   [collaboration](/blog/tags/collaboration)
*   [groupware](/blog/tags/groupware)

[Edit this page](https://github.com/stalwartlabs/website/tree/main/blog/2025-10-22-jmap-collaboration.mdx)
...
](/blog/security-audit-2025)

*   [A New Generation of Protocols](#a-new-generation-of-protocols)
*   [Limitations of Yesterday's Technology](#limitations-of-yesterdays-technology)
*   [JMAP: A Modern Solution for Modern Needs](#jmap-a-modern-solution-for-modern-needs)
*   [Why This Matters](#why-this-matters)
*   [Client Support and Ecosystem](#client-support-and-ecosystem)
*   [A Word of Thanks](#a-word-of-thanks)
*   [Looking Ahead to 1.0.0](#looking-ahead-to-100)

Documentation

*   [Getting Started](/docs/install/get-started)
*   [Email Store](/docs/email/overview)
*   [MTA](/docs/mta/overview)
*   [Collaboration](/docs/collaboration/overview)
*   [Spam Filter](/docs/spamfilter/overview)

Community

*   [Github Discussions](https://github.com/stalwartlabs/mail-server/discussions)
*   [Reddit](https://www.reddit.com/r/stalwartlabs)
*   [Discord](https://discord.com/servers/stalwart-923615863037390889)
*   [Mastodon](https://mastodon.social/@stalwartlabs)
*   [Twitter](https://twitter.com/stalwartlabs)

More

*   [Blog](/blog)
*   [GitHub](https://github.com/stalwartlabs)

Copyright © 2025 Stalwart Labs Ltd.