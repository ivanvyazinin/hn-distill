...
[![](/img/pion-logo.svg)](/)[](https://github.com/pion)[](https://x.com/_pion)[](https://bsky.app/profile/pion.ly)[](https://discord.gg/6EsQz85vPE)

[Blog](/blog/) [Why Pion](/why-pion/) [awesome-pion](https://github.com/pion/awesome-pion) [WebRTC for the Curious](https://webrtcforthecurious.com) [Office Hours](https://siobud.com/meeting) [Triage](/triage/)

[](https://github.com/pion)[](https://x.com/_pion)[](https://bsky.app/profile/pion.ly)[](https://discord.gg/6EsQz85vPE)
...
# Simplifying WebRTC Datachannels for Games[](#simplifying-webrtc-datachannels-for-games)
...
## Why Not Use Websockets?[](#why-not-use-websockets)
...
## The Case for Web Transport[](#the-case-for-web-transport)
...
## Datachannels: A Hidden Gem of WebRTC[](#datachannels-a-hidden-gem-of-webrtc)
...
*   They were created in part for exactly this use case
    ...
    *   [Not to mention that one of the original implementers of WebRTC wanted to enable this usecase](https://news.ycombinator.com/item?id=13264952) ![Comment from original WebRTC team member](/img/comment_from_webrtc_team.png)

## Benefits and Drawbacks of WebRTC[](#benefits-and-drawbacks-of-webrtc)
...
### Existing Game Networking Libraries Using WebRTC[](#existing-game-networking-libraries-using-webrtc)
...
## Why Go for Development?[](#why-go-for-development)
...
## Why Ebitengine for Game Development?[](#why-ebitengine-for-game-development)
...
## Official Pion Example[](#official-pion-example)
...
*   **Limitations**
    *   Right now, this can only support two players on the same computer
        ...
        *   The machinery is there to support more than two players in a lobby, but as of writing this article it is [currently hardcoded](https://github.com/pion/example-webrtc-applications/blob/5c7005933879d34fa19b4d0c744bb884a247f5dc/ebiten-game/game/main.go#L154) to just two ![Picture of game](/img/game_on_web_and_desktop.png)

## Other Games That Use WebRTC[](#other-games-that-use-webrtc)

*   [Tough Love Arena](https://toughlovearena.com/)
*   [Counterpick Labs](https://www.counterpicklabs.com/)
*   [2D Soccer](https://2dsoccer.com/)

## Possibilities with WebRTC[](#possibilities-with-webrtc)
...
[Edit this page](https://github.com/pion/website/blob/master/content/en/blog/making-a-game-with-pion.md)