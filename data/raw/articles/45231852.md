...
## My project: Parsing old AIM logs [🔗︎](#my-project-parsing-old-aim-logs)
...
## My background in programming languages [🔗︎](#my-background-in-programming-languages)
...
## How do I parse command-line args? [🔗︎](#how-do-i-parse-command-line-args)
...
## What does `gleam build` do? [🔗︎](#what-does-gleam-build-do)
...
## Let me implement the simplest possible parser [🔗︎](#let-me-implement-the-simplest-possible-parser)
...
## Adjusting my brain to a functional language [🔗︎](#adjusting-my-brain-to-a-functional-language)
...
## How do I iterate over a list in a language with no loops? [🔗︎](#how-do-i-iterate-over-a-list-in-a-language-with-no-loops)
...
## Scraping an AIM message from a line [🔗︎](#scraping-an-aim-message-from-a-line)
...
## How do I access the last element of a list? [🔗︎](#how-do-i-access-the-last-element-of-a-list)
...
## Filtering out empty strings [🔗︎](#filtering-out-empty-strings)
...
## Tidying up string splitting [🔗︎](#tidying-up-string-splitting)
...
## Getting rid of the empty string hack [🔗︎](#getting-rid-of-the-empty-string-hack)
...
## Overall reflections [🔗︎](#overall-reflections)
...
### Love: Pipelines [🔗︎](#love-pipelines)
...
### Like: Example-centric documentation [🔗︎](#like-example-centric-documentation)
...
### Like: Built-in unused symbol warnings [🔗︎](#like-built-in-unused-symbol-warnings)
...
### Like: `todo` keyword [🔗︎](#like-todo-keyword)
...
### Like: Pattern matching [🔗︎](#like-pattern-matching)
...
### Dislike: Error handling [🔗︎](#dislike-error-handling)
...
### Dislike: Small core language [🔗︎](#dislike-small-core-language)
...
### Dislike: Limited standard library [🔗︎](#dislike-limited-standard-library)
...
## Source code [🔗︎](#source-code)

The source code for this project is available on Codeberg:

*   [https://codeberg.org/mtlynch/gleam-chat-log-parser](https://codeberg.org/mtlynch/gleam-chat-log-parser)
...
[Twitter](https://twitter.com/intent/tweet?via=deliberatecoder&text=My%20First%20Impressions%20of%20Gleam%20https%3a%2f%2fmtlynch.io%2fnotes%2fgleam-first-impressions%2f "Share on Twitter") [Facebook](https://www.facebook.com/sharer/sharer.php?u=https%3a%2f%2fmtlynch.io%2fnotes%2fgleam-first-impressions%2f "Share on Facebook") [LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https%3a%2f%2fmtlynch.io%2fnotes%2fgleam-first-impressions%2f "Share on LinkedIn")
