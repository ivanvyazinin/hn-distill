...
*   [![Cartoon avatar of blinry](/assets/images/avatar.png)](/)
*   [Latest](/#latest)
*   [Popular](/#popular)
*   [My Favorites](/#favs)
*   [Contact](/about/)
...
2024-03-16 / [blinry](/about/) / [CC BY-SA 4.0](/about/#license) / [tech](/#tech)
...
![The device looks like a big USB stick with a bronze screw connector at the back end. It's labelled "RTL-SDR Blog V4".](/50-things-with-sdr/ed1513b2b350229a.jpeg "The device looks like a big USB stick with a bronze screw connector at the back end. It's labelled "RTL-SDR Blog V4".")
...
I looked into the topic a bit, and a popular, cheap SDR right now is the [_RTL-SDR Blog V4_](https://www.rtl-sdr.com/rtl-sdr-blog-v4-dongle-initial-release/), which has the form factor of a simple SUB dongle. You can get it for around $30, or as a kit with telescopic antennas for $50.
...
![A 1.4 m long, two sided antenna, attached to my window.](/50-things-with-sdr/e7c6048323389ceb.jpg "A 1.4 m long, two sided antenna, attached to my window.")

And for higher frequencies, I used the tiny screw-on antennas from the kit:

![The antennas are only a couple of centimeters long.](/50-things-with-sdr/6476ab30f0d233df.jpg "The antennas are only a couple of centimeters long.")
...
![A short burst in the waterfall diagram, at 149.05 MHz.](/50-things-with-sdr/99dc224db1441231.png "A short burst in the waterfall diagram, at 149.05 MHz.")
...
![A antenna made from two short wires.](/50-things-with-sdr/abc2bb1af1132f58.jpeg "A antenna made from two short wires.")
...
![Planes around Hamburg on a map, together with a table of their properties.](/50-things-with-sdr/0e508ca1be070861.png "Planes around Hamburg on a map, together with a table of their properties.")

### 6: Listen to _stereo_ FM radio
...
**Correction:** I’ve been told that instead of what I call “left” and “right” in this diagram, the upper frequencies transmit the _difference of the left and right channels_! That way, the receiver can calculate the left and right channels from the mono signal (which is, esseutially, the _sum_ of left and right).

![An audio spectrum, with the pilot tone and the frequency ranges marked in blue.](/50-things-with-sdr/117da03f9f7ff03c.png "An audio spectrum, with the pilot tone and the frequency ranges marked in blue.")

### 7: Receive road traffic information

*   **Frequency:** 87.5-108 MHz

If you _triple_ the frequency of the pilot tone, you get to a range where FM stations transmit small amounts of digital metadata, like the name and genre of the station, and the current song! That’s a protocol called Radio Data System.
...
![Metadata of a station called N-JOY.](/50-things-with-sdr/1d19e5388d95bcab.png "Metadata of a station called N-JOY.")
...
![An Excel file, with the proper street and town highlighted.](/50-things-with-sdr/dc403604e704fc79.png "An Excel file, with the proper street and town highlighted.")
...
![An FM signal at 145.75 MHz.](/50-things-with-sdr/ba8aecf90d72d5b2.png "An FM signal at 145.75 MHz.")
...
![Some speech burts in a noisy waterfall diagram.](/50-things-with-sdr/9138cbe316231071.png "Some speech burts in a noisy waterfall diagram.")
...
![Short signal bursts in the frequency spectrum, at different frequencies around 433 MHz.](/50-things-with-sdr/00f1744c6d7d5180.png "Short signal bursts in the frequency spectrum, at different frequencies around 433 MHz.")

Using the decoder [rtl\_433](https://github.com/merbanan/rtl_433), I saw two sensors that output the current temperature, humidity, and air pressure!

There were also some “IBIS beacons” flying by, which are used in public transportation, so maybe it’s buses driving by?

![Command line output of rtl_433, reporting sensor data.](/50-things-with-sdr/88f09ea499f9273d.png "Command line output of rtl_433, reporting sensor data.")
...
Ships send out their status using AIS (Automatic Identification System). And again, I received _a lot_ of them here in Hamburg! :O
...
![A table of ships, along with a map.](/50-things-with-sdr/f99730ce760ad7f9.png "A table of ships, along with a map.")
...
![A map of the Earth, with satellite positions and predictions.](/50-things-with-sdr/4193c146fe11aac1.png "A map of the Earth, with satellite positions and predictions.")

I was super excited when I first received a signal from a NOAA satellite! 🛰️

![A striped signal in a waterfall diagram, at around 137 MHz.](/50-things-with-sdr/0d64ef01beb64d32.png "A striped signal in a waterfall diagram, at around 137 MHz.")
...
![A noisy image with borders.](/50-things-with-sdr/64de2491fb3d1ae5.png "A noisy image with borders.")
...
![Colorful, very orderly strips in a waterfall diagram.](/50-things-with-sdr/dca4c590f7d2da84.png "Colorful, very orderly strips in a waterfall diagram.")
...
![Digital chirps, separated by 200 kHz.](/50-things-with-sdr/d1f3086c9e6f0e4a.png "Digital chirps, separated by 200 kHz.")
...
![Broadband RF in a waterfall diagram.](/50-things-with-sdr/ccf19960970b8fe5.png "Broadband RF in a waterfall diagram.")
...
![Data about the balloon. Location on a map, height data graph.](/50-things-with-sdr/158b4820a354d902.png "Data about the balloon. Location on a map, height data graph.")

### 19: _Hunt_ weather balloons!

I decided to go on a field trip, using trains and my bike.

![I'm holding a bike at a train station.](/50-things-with-sdr/9f2f23bd87802298.jpg "I'm holding a bike at a train station.")

I was following the tracker. The balloon popped earlier than predicted, and I frantically changed travel plans!

![Balloon paths on map.](/50-things-with-sdr/4722c8707fad48c0.jpeg "Balloon paths on map.")
...
![All pictures show me in a swampy forest.](/50-things-with-sdr/4a198ccef135bdf3.jpg "All pictures show me in a swampy forest.")
...
![](/50-things-with-sdr/90f66724915ebe41.jpg)

![](/50-things-with-sdr/aba76e16c50cafac.jpg)
...
![A table of packets in a rather cryptic format.](/50-things-with-sdr/8574d165534474e5.png "A table of packets in a rather cryptic format.")

SDRangel can create a map automatically:

![Icons on a map around Hamburg.](/50-things-with-sdr/8a8b76e532277035.png "Icons on a map around Hamburg.")

## Thursday

I started the day by building an antenna!

![A big roll of green wire.](/50-things-with-sdr/fe8dbe63472e66d9.jpg "A big roll of green wire.")
...
![Green wire spread across a carpet.](/50-things-with-sdr/73e5201fdfad8421.png "Green wire spread across a carpet.")

…directly attached it to the center of another SMA connector…

![A golden screwable connector on the end of the wire.](/50-things-with-sdr/12235733fb4034fa.jpg "A golden screwable connector on the end of the wire.")

…and draped it all around my room!

![The green wire draped over a wooden shelf.](/50-things-with-sdr/a623475543e9868f.png "The green wire draped over a wooden shelf.")
...
![The reports contain temperature, pressure, and wind direction.](/50-things-with-sdr/4fd45254eab3176f.png "The reports contain temperature, pressure, and wind direction.")
...
![A waterfall diagram, and a table of decoded messages.](/50-things-with-sdr/9d65a50a712d4873.png "A waterfall diagram, and a table of decoded messages.")
...
In the low frequencies, occasionally, you can hear a short _chirp_! :D These are caused by ionosondes, scientific instruments which measure the properties of the ionosphere by sweeping a wide frequency spectrum.
...
![A diagonal line across 16 MHz, and a shorter, repeating pattern, repeating 4 times a second.](/50-things-with-sdr/9c312ae5e3f42bfa.png "A diagonal line across 16 MHz, and a shorter, repeating pattern, repeating 4 times a second.")
...
One trick is to transmit _just_ those sidebands, which saves power! But you have to “guess” the base frequency when listening. Depending on which part you transmit, this is called “lower side band” or “upper side band”.
...
I put my antenna outside, and I could hear _a lot_ of broadcasting stations! On [short-wave.info](https://www.short-wave.info), you can look up where they are located.
...
If you squint _really_ hard, you can make out the coast of Spain and the Mediterranean Sea on the right side!

![A partial map with pressure lines on it. Number's are hard to read. At the bottom, there's today's date, and a copyright note by the Deutscher Wetterdienst.](/50-things-with-sdr/3e5447217ad0d450.png "A partial map with pressure lines on it. Number's are hard to read. At the bottom, there's today's date, and a copyright note by the Deutscher Wetterdienst.")
...
![Grayscale map of Europe, with several very noisy parts. Border lines are drawn on top. You can see a cloud cover on Italy.](/50-things-with-sdr/f03b58a0472b0d32.png "Grayscale map of Europe, with several very noisy parts. Border lines are drawn on top. You can see a cloud cover on Italy.")

### 34: Estimate the speed of satellites

*   **Frequency:** 136-138 MHz

Here’s what the NOAA-15 weather satellite sounds like, by the way! _tick-tock_
...
![Colorful TV test image at the top, colorful noise at the bottom.](/50-things-with-sdr/dcd37ab4912cae59.png "Colorful TV test image at the top, colorful noise at the bottom.")
...
![A spectrogram, displaying a signal consisting of diagonal lines.](/50-things-with-sdr/be27f9c605c4eaad.png "A spectrogram, displaying a signal consisting of diagonal lines.")
...
![A log of transmissions found, and a decoded message that gives room and radiator temperature.](/50-things-with-sdr/2732b0f9fb5a28b7.png "A log of transmissions found, and a decoded message that gives room and radiator temperature.")
...
![A bus on an intersection. There's a white number printed on it at the front.](/50-things-with-sdr/24514cc9f989de85.jpeg "A bus on an intersection. There's a white number printed on it at the front.")
...
![One signal has a little frequency warp to it.](/50-things-with-sdr/24108965ac1d0455.png "One signal has a little frequency warp to it.")
...
![Faint Morse code in a waterfall diagram.](/50-things-with-sdr/9c049d30d265cbb9.png "Faint Morse code in a waterfall diagram.")
...
![Morse code signs in a waterfall diagram.](/50-things-with-sdr/4c63b62ed100e688.png "Morse code signs in a waterfall diagram.")

### 46: Receive navigational aids for airplanes

*   **Frequency:** 108.00-117.95 MHz

There are ground stations that emit a signal that allow calculating your angle relative to it! If you receive two, you can determine your position. (Thanks, @fly\_it!)
...
The neat navigational map is from [https://skyvector.com](https://skyvector.com)!

![View of SDRangel, it decodes the signal in the lower left, and shows 229°!](/50-things-with-sdr/5029b31e8a681a21.png "View of SDRangel, it decodes the signal in the lower left, and shows 229°!")

![An aeronautic navigational chart.](/50-things-with-sdr/273232dae2961991.png "An aeronautic navigational chart.")

![A map where I show that the real angle is 224 degrees.](/50-things-with-sdr/408727dc40cc80cc.png "A map where I show that the real angle is 224 degrees.")
...
![All screenshots show experiments I did in GNU Radio and Audacity.](/50-things-with-sdr/0e55a27def0a797d.png "All screenshots show experiments I did in GNU Radio and Audacity.")

![](/50-things-with-sdr/95edb38ca810d73b.png)

![](/50-things-with-sdr/2be773fb7f56d5d7.png)
...
![Three lines at around 1296 MHz.](/50-things-with-sdr/833875a5a00f9c32.png "Three lines at around 1296 MHz.")
...
You can add your comment [in the Fediverse](https://chaos.social/@blinry/112036984423655020)! Alternatively, drop me a mail at mail@blinry_._org. Also, you can support me [on Patreon](https://www.patreon.com/blinry) or subscribe to [my newsletter](https://tinyletter.com/blinry)