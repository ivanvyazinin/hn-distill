...
_A critique of React Server Components and Next.js 15._
...
*   [A Technical Review, What are Server Components?](#technical-review)
*   [Real-world Pitfalls of the App Router](#real-world-pitfalls)
    *   [Optimistic Updates are Impossible](#optimistic-updates)
    *   [Every Navigation is Another Fetch](#redundant-fetches)
    *   [Layouts are Artificially Restricted](#layout-restrictions)
    *   [You Still Download All the Content Twice](#rsc-payload)
    *   [Turbopack Sucks](#turbopack)
*   [Seamlessly Ditching Next.js and Vercel at Work](#ditching-nextjs)
    *   [`next/metadata` is Great](#next-metadata)
    *   [`next/og` is Good Too](#vercel-og)
*   [My Experience Feels Like the Usual](#experience-feels-like-the-usual)
*   [Prefer Tools that Respect You](#prefer-respectful-tools)
...
Since the App Router starts every page as a server component, with (ideally) small areas of interactivity, a navigation to a new page _has_ to fetch the Next.js server, regardless of what data the client already has available! Even with a a `loading.tsx` file, opening `/`, navigating to `/other`, and then going back to `/` will show the loading state while it re-fetches the homepage.
...
When a coworker asks me about why Next.js rejects some code, I've given up on explaining the technical intricacies and just say _"It's a Next.js Skill Issue, I'm going to blow it up soon don't worry."_ These rules are too hard for normal developers to understand.
...
We're not the only ones seeing the change. While I try and keep myself off of social media, someone sent me [the results of Brian Anglin's work at Superwall](https://twitter.com/BriansAngles/status/1978834116079436242#m), showing incredible CPU reductions on TanStack Start. I also recall ChatGPT switching from Next.js to Remix (random online chatter: \[[1](https://xcancel.com/ryanflorence/status/1831379475654947233)\] \[[2](https://old.reddit.com/r/reactjs/comments/1f97zgr/chatgpt_migrates_from_nextjs_to_remix)\] \[[3](https://old.reddit.com/r/nextjs/comments/1f92jdv/chatgptcom_switched_from_nextjs_to_remix)\]) a year ago.

### [§](#toc)`next/metadata` is Great
...
## [§](#toc)Prefer Tools that Respect You
...
[click here to send an email to `subscribe@paperclover.net`, requesting that you would like to be added to the mailing list.](mailto:subscribe@paperclover.net?subject=paper%20clover%20mailing%20list&body=I%20would%20like%20to%20be%20subscribed%20to%20the%20following%20mailing%20lists%3A%0A%0A-%20Technical%20Blog%20Posts%20-%20YES%0A-%20Art%20\(Original%20Music%2FVideo\)%20-%20YES%0A%0A\(feel%20free%20to%20write%20whatever%20else%20you%20want\)) (i manage this mailing list manually)
