...
![sping Interactive Demo](demo.gif)

_Real-time latency monitoring with interactive charts showing HTTP response times, outlier detection, and live statistics._
...
_Note: Outlier detection helps identify performance degradation, network issues, or service problems that might not trigger error thresholds._
...
_Warm oranges and reds reminiscent of a beautiful sunset_
...
Latest documentation • [Version 0.2.11 specific docs](0.2.11/) • [Install from PyPI](https://pypi.org/project/service-ping-sping/)