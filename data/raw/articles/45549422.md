Nue 2.0: The UNIX of the web / Nue             

[**NUE**](/) [Docs](/docs/) [Blog](/blog/)[NewNue 2.0 is out ->](/blog/2.0/)

[**Slack**](//join.slack.com/t/nuejs/shared_invite/zt-2wf8ozu5i-N2Y9PA_D17weIWuN2QPOqQ) [8.8k](https://github.com/nuejs/nue)
...
Edge-first server development

### Nueglow

CSS first syntax highlighting
...
Get email when [multi-site development](/docs/roadmap) is ready
