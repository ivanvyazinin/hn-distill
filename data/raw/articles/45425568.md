...
1.  [“The Joel Test: 12 Steps to Better Code” by Joel Spolsky (2000)](#-by-joel-spolsky-2000)
2.  [“Parse, don’t validate” by Alexis King (2019)](#-by-alexis-king-2019)
3.  [“No Silver Bullet - Essence and Accident in Software Engineering” by Fred Brooks (1986)](#-by-fred-brooks-1986)
4.  [“Choices” by Joel Spolsky (2000)](#-by-joel-spolsky-2000-1)
5.  [“Application compatibility layers are there for the customer, not for the program” by Raymond Chen (2010)](#-by-raymond-chen-2010)
6.  [“Don’t Put Logic in Tests” by Erik Kuefler (2014)](#-by-erik-kuefler-2014)
7.  [“A little bit of plain Javascript can do a lot” by Julia Evans (2020)](#-by-julia-evans-2020)
8.  [“Choose Boring Technology” by Dan McKinley (2015)](#-by-dan-mckinley-2015)
9.  [“I’ve locked myself out of my digital life” by Terence Eden (2022)](#-by-terence-eden-2022)
10.  [Bonus: Brad Fitzpatrick on parsing user input (2009)](#bonus-brad-fitzpatrick-on-parsing-user-input-2009)

## [“The Joel Test: 12 Steps to Better Code”](https://www.joelonsoftware.com/2000/08/09/the-joel-test-12-steps-to-better-code/) by Joel Spolsky (2000)[🔗](#-by-joel-spolsky-2000)
...
## [“Parse, don’t validate”](https://lexi-lambda.github.io/blog/2019/11/05/parse-don-t-validate/) by Alexis King (2019)[🔗](#-by-alexis-king-2019)
...
The problem with this approach is that your code is unsafe by default. You have to remember to validate every username you receive, so it’s easy to create a code path that accidentally processes a username without validating it. And if a nefarious user notices the mistake, they can do tricky things like embed malicious code in the username field or stuff it with a billion characters to fill up your database.
...
## [“No Silver Bullet - Essence and Accident in Software Engineering”](https://www.cs.unc.edu/techreports/86-020.pdf) by Fred Brooks (1986)[🔗](#-by-fred-brooks-1986)
...
## [“Choices”](https://www.joelonsoftware.com/2000/04/12/choices/) by Joel Spolsky (2000)[🔗](#-by-joel-spolsky-2000-1)

I said [above](#-by-joel-spolsky-2000) that it was hard to pick a single favorite Joel Spolsky essay, which is why I’ve chosen two.
...
The dialog infuriates Joel because it interrupts the user while they’re trying to get help, and it asks them to make an uninformed about database optimization. Windows was shirking a decision and pushing it onto the user.
...
## [“Application compatibility layers are there for the customer, not for the program”](https://devblogs.microsoft.com/oldnewthing/20100311-00/?p=14643) by Raymond Chen (2010)[🔗](#-by-raymond-chen-2010)
...
I loved this analogy. The metaphor was so funny that I didn’t realize until just now that Raymond is in the wrong. He’s making fun of a developer whose sin is expecting Windows not to break their app after a single release.
...
## [“Don’t Put Logic in Tests”](https://testing.googleblog.com/2014/07/testing-on-toilet-dont-put-logic-in.html) by Erik Kuefler (2014)[🔗](#-by-erik-kuefler-2014)
...
Erik’s essay made me realize that I shouldn’t treat test code like production code at all. The two have [completely different goals and constraints](https://mtlynch.io/good-developers-bad-tests/#test-code-is-not-like-other-code).
...
## [“A little bit of plain Javascript can do a lot”](https://jvns.ca/blog/2020/06/19/a-little-bit-of-plain-javascript-can-do-a-lot/) by Julia Evans (2020)[🔗](#-by-julia-evans-2020)
...
Then, I read Julia’s essay, and I realized I’d been so confident that JavaScript needed fixing that I never gave it a chance.
...
## [“Choose Boring Technology”](https://mcfunley.com/choose-boring-technology) by Dan McKinley (2015)[🔗](#-by-dan-mckinley-2015)
...
## [“I’ve locked myself out of my digital life”](https://shkspr.mobi/blog/2022/06/ive-locked-myself-out-of-my-digital-life/) by Terence Eden (2022)[🔗](#-by-terence-eden-2022)
...
## Bonus: Brad Fitzpatrick on parsing user input (2009)[🔗](#bonus-brad-fitzpatrick-on-parsing-user-input-2009)
...
[Hacker News](https://news.ycombinator.com/item?id=45425568 "Discuss on Hacker News") [Reddit](https://www.reddit.com/r/programming/comments/1nug0oo/the_software_essays_that_shaped_me/ "Discuss on reddit")
