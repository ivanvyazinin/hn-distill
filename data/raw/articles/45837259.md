A File Format Uncracked for 20 Years | lander's posts                 
...
[![](https://landaire.net/processed_images/banner.c9874fccf7528554.png)](/img/splinter-cell/banner.png)

# A File Format Uncracked for 20 Years

_"I’ve had enough reasonable file formats fired at me in my time to tell you that wasn’t one" - Sam Fisher_
...
*   [https://www.unrealarchive.org/wikis/unreal-wiki/Legacy:UMOD/File\_Format.html](https://www.unrealarchive.org/wikis/unreal-wiki/Legacy:UMOD/File_Format.html)
...
## [#](#tl-dr-of-the-general-lin-structure) tl;dr of the general `.lin` structure
...
## [#](#logging-load-order-for-static-recompilation) Logging Load Order for Static Recompilation
...
## [#](#dumping-at-runtime) Dumping at Runtime
...
### [#](#patching-og-xbox-binaries) Patching OG Xbox Binaries
...
To confirm my assumption, I set a breakpoint in the function which kicks off object deserialization so that it would break immediately before:
 ...
 Targeted Export Breakpoint Code
...
## [#](#general-issues-with-dumping) General Issues With Dumping
