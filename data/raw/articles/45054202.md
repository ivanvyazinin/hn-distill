...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2FDeluxeOwl%2Fchronicle)
...
[Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F%3Cuser-name%3E%2F%3Crepo-name%3E&source=header-repo&source_repo=DeluxeOwl%2Fchronicle)
...
[DeluxeOwl](/DeluxeOwl) / **[chronicle](/DeluxeOwl/chronicle)** Public

*   [Notifications](/login?return_to=%2FDeluxeOwl%2Fchronicle) You must be signed in to change notification settings
*   [Fork 0](/login?return_to=%2FDeluxeOwl%2Fchronicle)
*   [Star 54](/login?return_to=%2FDeluxeOwl%2Fchronicle)
    

Idiomatic, type safe event sourcing framework for Go.

### License

[BSD-3-Clause license](/DeluxeOwl/chronicle/blob/main/LICENSE)

[54 stars](/DeluxeOwl/chronicle/stargazers) [0 forks](/DeluxeOwl/chronicle/forks) [Branches](/DeluxeOwl/chronicle/branches) [Tags](/DeluxeOwl/chronicle/tags) [Activity](/DeluxeOwl/chronicle/activity)

[Star](/login?return_to=%2FDeluxeOwl%2Fchronicle)

[Notifications](/login?return_to=%2FDeluxeOwl%2Fchronicle) You must be signed in to change notification settings

*   [Code](/DeluxeOwl/chronicle)
*   [Issues 0](/DeluxeOwl/chronicle/issues)
*   [Pull requests 0](/DeluxeOwl/chronicle/pulls)
*   [Actions](/DeluxeOwl/chronicle/actions)
*   [Projects 0](/DeluxeOwl/chronicle/projects)
*   [Security](/DeluxeOwl/chronicle/security)
    
    [](/DeluxeOwl/chronicle/security)
    ...
    [There was an error while loading.](/DeluxeOwl/chronicle/security) Please reload this page.
    
*   [Insights](/DeluxeOwl/chronicle/pulse)

Additional navigation options

*   [Code](/DeluxeOwl/chronicle)
*   [Issues](/DeluxeOwl/chronicle/issues)
*   [Pull requests](/DeluxeOwl/chronicle/pulls)
*   [Actions](/DeluxeOwl/chronicle/actions)
*   [Projects](/DeluxeOwl/chronicle/projects)
*   [Security](/DeluxeOwl/chronicle/security)
*   [Insights](/DeluxeOwl/chronicle/pulse)
...
[Branches](/DeluxeOwl/chronicle/branches)[Tags](/DeluxeOwl/chronicle/tags)

[](/DeluxeOwl/chronicle/branches)[](/DeluxeOwl/chronicle/tags)
...
[313 Commits](/DeluxeOwl/chronicle/commits/main/)

[](/DeluxeOwl/chronicle/commits/main/)

[.vscode](/DeluxeOwl/chronicle/tree/main/.vscode ".vscode")

[.vscode](/DeluxeOwl/chronicle/tree/main/.vscode ".vscode")

[aggregate](/DeluxeOwl/chronicle/tree/main/aggregate "aggregate")

[aggregate](/DeluxeOwl/chronicle/tree/main/aggregate "aggregate")

[assets](/DeluxeOwl/chronicle/tree/main/assets "assets")

[assets](/DeluxeOwl/chronicle/tree/main/assets "assets")

[event](/DeluxeOwl/chronicle/tree/main/event "event")

[event](/DeluxeOwl/chronicle/tree/main/event "event")

[eventlog](/DeluxeOwl/chronicle/tree/main/eventlog "eventlog")

[eventlog](/DeluxeOwl/chronicle/tree/main/eventlog "eventlog")

[examples](/DeluxeOwl/chronicle/tree/main/examples "examples")

[examples](/DeluxeOwl/chronicle/tree/main/examples "examples")

[internal](/DeluxeOwl/chronicle/tree/main/internal "internal")

[internal](/DeluxeOwl/chronicle/tree/main/internal "internal")

[pkg/timeutils](/DeluxeOwl/chronicle/tree/main/pkg/timeutils "This path skips through empty directories")

[pkg/timeutils](/DeluxeOwl/chronicle/tree/main/pkg/timeutils "This path skips through empty directories")

[serde](/DeluxeOwl/chronicle/tree/main/serde "serde")

[serde](/DeluxeOwl/chronicle/tree/main/serde "serde")

[snapshotstore](/DeluxeOwl/chronicle/tree/main/snapshotstore "snapshotstore")

[snapshotstore](/DeluxeOwl/chronicle/tree/main/snapshotstore "snapshotstore")

[version](/DeluxeOwl/chronicle/tree/main/version "version")

[version](/DeluxeOwl/chronicle/tree/main/version "version")

[.commitlintrc.yml](/DeluxeOwl/chronicle/blob/main/.commitlintrc.yml ".commitlintrc.yml")

[.commitlintrc.yml](/DeluxeOwl/chronicle/blob/main/.commitlintrc.yml ".commitlintrc.yml")

[.envrc](/DeluxeOwl/chronicle/blob/main/.envrc ".envrc")

[.envrc](/DeluxeOwl/chronicle/blob/main/.envrc ".envrc")

[.gitignore](/DeluxeOwl/chronicle/blob/main/.gitignore ".gitignore")

[.gitignore](/DeluxeOwl/chronicle/blob/main/.gitignore ".gitignore")

[.golangci.yml](/DeluxeOwl/chronicle/blob/main/.golangci.yml ".golangci.yml")

[.golangci.yml](/DeluxeOwl/chronicle/blob/main/.golangci.yml ".golangci.yml")

[LICENSE](/DeluxeOwl/chronicle/blob/main/LICENSE "LICENSE")

[LICENSE](/DeluxeOwl/chronicle/blob/main/LICENSE "LICENSE")

[README.md](/DeluxeOwl/chronicle/blob/main/README.md "README.md")

[README.md](/DeluxeOwl/chronicle/blob/main/README.md "README.md")

[Taskfile.yml](/DeluxeOwl/chronicle/blob/main/Taskfile.yml "Taskfile.yml")

[Taskfile.yml](/DeluxeOwl/chronicle/blob/main/Taskfile.yml "Taskfile.yml")

[chronicle.go](/DeluxeOwl/chronicle/blob/main/chronicle.go "chronicle.go")

[chronicle.go](/DeluxeOwl/chronicle/blob/main/chronicle.go "chronicle.go")

[devbox.json](/DeluxeOwl/chronicle/blob/main/devbox.json "devbox.json")

[devbox.json](/DeluxeOwl/chronicle/blob/main/devbox.json "devbox.json")

[devbox.lock](/DeluxeOwl/chronicle/blob/main/devbox.lock "devbox.lock")

[devbox.lock](/DeluxeOwl/chronicle/blob/main/devbox.lock "devbox.lock")

[go.mod](/DeluxeOwl/chronicle/blob/main/go.mod "go.mod")

[go.mod](/DeluxeOwl/chronicle/blob/main/go.mod "go.mod")

[go.sum](/DeluxeOwl/chronicle/blob/main/go.sum "go.sum")

[go.sum](/DeluxeOwl/chronicle/blob/main/go.sum "go.sum")

[lefthook.yml](/DeluxeOwl/chronicle/blob/main/lefthook.yml "lefthook.yml")
...
[![chronicle](/DeluxeOwl/chronicle/raw/main/assets/logov2.png)](/DeluxeOwl/chronicle/blob/main/assets/logov2.png)
...
modern event sourcing in Go.

[](#a-pragmatic-and-type-safe-toolkit-for-modern-event-sourcing-in-go)

[_Want to hire me?_](mailto:andreisurugiu.tm@gmail.com)
...
The events **MUST** be side effect free (no i/o). The event methods (`EventName`, `isAccountEvent`) **MUST** have pointer receivers:
...
func (\*moneyDeposited) EventName() string { return "account/money\_deposited" }
...
// ⚠️ Note: the event name is unique
func (\*moneyWithdrawn) EventName() string { return "account/money\_withdrawn" }
...
Now we need a way to build the aggregate's state from its history of events. This is done by "replaying" or "applying" the events to the aggregate. You shouldn't check business logic rules here, you should just recompute the state of the aggregate.
...
❯ go run examples/1\_quickstart/main.go
version: 3
&main.accountOpened{
  ID: "123",
...
You can find this example in [./examples/1\_quickstart](/DeluxeOwl/chronicle/blob/main/examples/1_quickstart). You can find the implementation of the account in [./examples/internal/account/account.go](/DeluxeOwl/chronicle/blob/main/examples/internal/account/account.go).
...
Event sourcing is a pattern for storing all changes to an application's state as a sequence of _immutable_ "**events**".
...
With this model, if you see the balance is $150, you have no idea _how_ it got there. The history is lost.
...
Events are facts: they describe _something_ that happened in the past and should be named in the past tense:
...
Projection State (our read model)

_(initial state)_

`{ "john_count": 0 }`

`person/was_born` `{"name": "John Smith"}`

Name starts with "John". `john_count` is incremented.

`{ "john_count": 1 }`

`person/aged_one_year` `{}`

Irrelevant event for this projection. State is unchanged.

`{ "john_count": 1 }`

`person/was_born` `{"name": "Lisa Doe"}`

Name does not start with "John". State is unchanged.

`{ "john_count": 1 }`

`person/was_born` `{"name": "John Doe"}`
...
`person/was_born` `{"name": "Peter Jones"}`

Name does not start with "John". State is unchanged.

`{ "john_count": 2 }`

The final result is a projection - a simple read model that's fast to query. It could be stored in a key-value store like Redis, or a simple db table:
...
The event log is the source of truth, so projections can be rebuilt from it at any time. However, projections are usually updated _after_ an event is written, which means they can briefly lag behind the state in the event log. This is known as **eventual consistency**.
...
> [_"Every system is a log"_](https://news.ycombinator.com/item?id=42813049)
...
> Event sourcing helps you first model _what happens_ (the events), and **then** worry about how to interpret that data using projections.
...
You can find this example in [./examples/2\_optimistic\_concurrency/main.go](/DeluxeOwl/chronicle/blob/main/examples/2_optimistic_concurrency/main.go).
...
The account starts at version 0, `Open` is event 1, `Deposit` is event 2. After saving, the version will be 2.
...
At the **same time**, User A tried to withdraw $100. The business logic passes because their copy of the account _thinks_ the balance is still $200.
...
You can find this example in [./examples/3\_snapshots/main.go](/DeluxeOwl/chronicle/blob/main/examples/3_snapshots/main.go) and [(./examples/internal/account/account\_snapshot.go](/DeluxeOwl/chronicle/blob/main/examples/internal/account/account_snapshot.go).
...
A snapshot is a serialized copy of an aggregate's state at a specific version. Instead of replaying the entire event history, the system can load the _latest snapshot_ and then replay only the events that have occurred _since_ that snapshot was taken.
...
An example in [account\_snapshot.go](/DeluxeOwl/chronicle/blob/main/examples/internal/account/account_snapshot.go):
...
You can find this example in [./examples/5\_event\_metadata](/DeluxeOwl/chronicle/blob/main/examples/5_event_metadata/main.go), [./examples/internal/shared](/DeluxeOwl/chronicle/blob/main/examples/internal/shared/event.go) and [./examples/internal/accountv2](/DeluxeOwl/chronicle/blob/main/examples/internal/accountv2).
...
We want our events to have the following: a unique id and a timestamp. For that, we're going to create a shared event that must be embedded by our `AccountEvent`(s).
...
//go:generate go run github.com/matryer/moq@latest -pkg timeutils -skip-ensure -rm -out now\_mock.go . TimeProvider
...
These errors tell use that we're missing the method `isEventMeta()`, a method that is only satisfied by the `shared.EventMetadata` struct. This acts as our compile-time check, telling us that we must embed the `shared.EventMetadata` struct to our events.
...
We're going to use the snapshot example but adapt it to account for our shared metadata. You can find this in [examples/5\_event\_metadata](/DeluxeOwl/chronicle/blob/main/examples/5_event_metadata/main.go).
...
go run examples/5\_event\_metadata/main.go
...
account/money\_deposited {"eventID":"03bff837-ff2f-7d27-a50b-a81c5f7a33eb","occuredAt":"2100-08-27T11:20:56.239665+03:00","amount":100}
account/money\_deposited {"eventID":"03bff837-ff2f-7d28-8c54-9594563b48b4","occuredAt":"2100-08-27T11:20:56.239666+03:00","amount":100}
...
This is where the `event.GlobalLog` interface comes in. It extends `event.Log` with the ability to read a single, globally ordered stream of all events. Backends like the `Postgres` and `Sqlite` logs implement this by assigning a unique, monotonically increasing `global_version` to every event that is committed, in addition to its per-aggregate `version`.
...
You can find this example in in [./examples/4\_transformers\_crypto/main.go](/DeluxeOwl/chronicle/blob/main/examples/4_transformers_crypto/main.go) and [account\_aes\_crypto\_transformer.go](/DeluxeOwl/chronicle/blob/main/examples/internal/account/account_aes_crypto_transformer.go).
...
❯ go run examples/4\_transformers\_crypto/main.go
...
// in examples/4\_transformers/main.go
...
This framework isn't opinionated in _how_ you're creating projections but provides a few primitives that help.

### `event.TransactionalEventLog` and `aggregate.TransactionalRepository`

[](#eventtransactionaleventlog-and-aggregatetransactionalrepository)
...
We're going to make use of `accountv2`. You can find this example in [examples/6\_projections/main.go](/DeluxeOwl/chronicle/blob/main/examples/6_projections/main.go) and [examples/internal/accountv2/account\_processor.go](/DeluxeOwl/chronicle/blob/main/examples/internal/accountv2/account_processor.go).
...
func NewAccountsWithNameProcessor(db \*sql.DB) (\*AccountsWithNameProcessor, error) {
	\_, err := db.Exec(\`
        CREATE TABLE IF NOT EXISTS projection\_accounts (
            account\_id TEXT PRIMARY KEY,
            holder\_name TEXT NOT NULL
        );
    \`)
	if err != nil {
	...
	for evt := range events.All() {
		...
		if opened, ok := evt.(\*accountOpened); ok {
			\_, err := tx.ExecContext(ctx, \`
                INSERT INTO projection\_accounts (account\_id, holder\_name) 
                VALUES (?, ?)
                ON CONFLICT(account\_id) DO UPDATE SET 
                    holder\_name = excluded.holder\_name
...
sqlprinter.Query("SELECT account\_id, holder\_name FROM projection\_accounts")
...
sqlprinter.Query(
	"SELECT global\_version, log\_id, version, event\_name, json\_extract(data, '$') as data FROM chronicle\_events",
)
...
go run examples/6\_projections/main.go
...
│ 2              │ alice-account-01 │ 2       │ account/money\_deposited │ {"eventID":"0198f03e-4042-723d-a335-0f13b54c78cb","occuredAt":"2025-08-28T13:34:28.290757+03:00","amount":100}                                                                              │
│ 3              │ alice-account-01 │ 3       │ account/money\_deposited │ {"eventID":"0198f03e-4042-723e-a5e5-b127aec593f2","occuredAt":"2025-08-28T13:34:28.290758+03:00","amount":50}                                                                               │
...
│ 5              │ bob-account-02   │ 2       │ account/money\_deposited │ {"eventID":"0198f03e-4043-723f-96db-0c01cbf57d70","occuredAt":"2025-08-28T13:34:28.291036+03:00","amount":200}                                                                              │
└────────────────┴──────────────────┴─────────┴─────────────────────────┴─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
For a production environment, take a look at [https://watermill.io/advanced/forwarder/](https://watermill.io/advanced/forwarder/) .
...
You can find this example in [examples/7\_outbox/main.go](/DeluxeOwl/chronicle/blob/main/examples/7_outbox/main.go) and [examples/internal/accountv2/account\_outbox\_processor.go](/DeluxeOwl/chronicle/blob/main/examples/internal/accountv2/account_outbox_processor.go).
...
func NewAccountOutboxProcessor(db \*sql.DB) (\*AccountOutboxProcessor, error) {
	\_, err := db.Exec(\`
        CREATE TABLE IF NOT EXISTS outbox\_account\_events (
...
func (p \*AccountOutboxProcessor) Process(
	...
	for \_, event := range committedEvents {
		...
		\_, err \= tx.ExecContext(ctx, \`
            INSERT INTO outbox\_account\_events (aggregate\_id, event\_name, payload) 
            VALUES (?, ?, ?)
...
go func() {
		...
		for {
			...
			case <-ticker.C:
				...
				row := tx.QueryRowContext(ctx, "SELECT id, aggregate\_id, event\_name, payload FROM outbox\_account\_events ORDER BY id LIMIT 1")
				// ... scan row
				...
				\_, err \= tx.ExecContext(ctx, "DELETE FROM outbox\_account\_events WHERE id = ?", msg.OutboxID)
				// ...
...
2.  **Global projections**
    ...
    *   ⚠️ In `chronicle`:
        ...
        *   Can also be done by directly querying the backing store of the event log, as seen in [examples/6\_projections/main.go](/DeluxeOwl/chronicle/blob/main/examples/6_projections/main.go) - where it can be done via sql queries directly.
...
[](#implementing-a-custom-eventlog)
...
I recommend taking a look at the [./eventlog/postgres.go](/DeluxeOwl/chronicle/blob/main/eventlog/postgres.go) and [./eventlog/sqlite.go](/DeluxeOwl/chronicle/blob/main/eventlog/sqlite.go) implementations as a reference.
...
SELECT version, event\_name, data
FROM my\_events\_table
WHERE log\_id \= ? AND version \>= ?
...
[](#global-event-log-the-eventglobalreader-interface)
...
[](#implementing-a-custom-aggregaterepository)
...
This project uses Devbox ([https://www.jetify.com/docs/devbox/quickstart/](https://www.jetify.com/docs/devbox/quickstart/)) to manage the dev environment - ensuring everyone who contributes has the same tooling and depndencies.
...
We use [https://taskfile.dev/](https://taskfile.dev/) for automating various tasks:
...
The event logs are tested all at once (since they satisfy the same interface) in [./eventlog/eventlog\_test.go](/DeluxeOwl/chronicle/blob/main/eventlog/eventlog_test.go).

A sample aggregate is used for testing in [./aggregate/aggregate\_test.go](/DeluxeOwl/chronicle/blob/main/aggregate/aggregate_test.go).

This framework uses `go:generate` with the [`moq`](https://github.com/matryer/moq) library to create mock implementations of the core interfaces. You can see this in files like [./aggregate/repository.go](/DeluxeOwl/chronicle/blob/main/aggregate/repository.go).

// in aggregate/repository.go
//go:generate go run github.com/matryer/moq@latest -pkg aggregate\_test -skip-ensure -rm -out repository\_mock\_test.go . Repository
...
*   [https://github.com/get-eventually/go-eventually](https://github.com/get-eventually/go-eventually) - many thanks to this one
*   [https://github.com/eugene-khyst/postgresql-event-sourcing](https://github.com/eugene-khyst/postgresql-event-sourcing)
*   [https://github.com/hallgren/eventsourcing](https://github.com/hallgren/eventsourcing)
    *   [https://github.com/hallgren/wtf](https://github.com/hallgren/wtf)
*   [https://github.com/thefabric-io/eventsourcing](https://github.com/thefabric-io/eventsourcing)
    *   [https://github.com/thefabric-io/eventsourcing.example](https://github.com/thefabric-io/eventsourcing.example)
...
*   [https://khalilstemmler.com/articles/categories/domain-driven-design/](https://khalilstemmler.com/articles/categories/domain-driven-design/)
*   [https://blog.devgenius.io/go-golang-clean-architecture-repositories-vs-transactions-9b3b7c953463](https://blog.devgenius.io/go-golang-clean-architecture-repositories-vs-transactions-9b3b7c953463)
...
*   [https://watermill.io/advanced/forwarder/](https://watermill.io/advanced/forwarder/)
*   [https://github.com/Sairyss/domain-driven-hexagon](https://github.com/Sairyss/domain-driven-hexagon)
*   [https://martendb.io/introduction.html](https://martendb.io/introduction.html)
*   [https://getakka.net/articles/persistence/event-sourcing.html](https://getakka.net/articles/persistence/event-sourcing.html)
*   [https://github.com/oskardudycz/EventSourcing.NetCore](https://github.com/oskardudycz/EventSourcing.NetCore)
    *   [https://domaincentric.net/blog/event-sourcing-projections](https://domaincentric.net/blog/event-sourcing-projections)
    *   [https://event-driven.io/en/dealing\_with\_eventual\_consistency\_and\_idempotency\_in\_mongodb\_projections](https://event-driven.io/en/dealing_with_eventual_consistency_and_idempotency_in_mongodb_projections)
        *   [https://event-driven.io/en/projections\_and\_read\_models\_in\_event\_driven\_architecture/](https://event-driven.io/en/projections_and_read_models_in_event_driven_architecture/)
*   [https://github.com/AxonFramework/AxonFramework](https://github.com/AxonFramework/AxonFramework)
*   [https://occurrent.org/](https://occurrent.org/)
*   [https://dewdrop.events/](https://dewdrop.events/)
*   [https://docs.kurrent.io/getting-started/features.html](https://docs.kurrent.io/getting-started/features.html)
    *   [https://docs.kurrent.io/getting-started/concepts.html#event-stream](https://docs.kurrent.io/getting-started/concepts.html#event-stream)
    *   [https://docs.kurrent.io/server/v25.0/features/projections/](https://docs.kurrent.io/server/v25.0/features/projections/)
*   [https://github.com/eugene-khyst/postgresql-event-sourcing](https://github.com/eugene-khyst/postgresql-event-sourcing)
*   [https://zitadel.com/docs/concepts/architecture/software](https://zitadel.com/docs/concepts/architecture/software)
    *   [https://zitadel.com/docs/concepts/eventstore/implementation](https://zitadel.com/docs/concepts/eventstore/implementation)
...
[go](/topics/go "Topic: go") [golang](/topics/golang "Topic: golang") [cqrs](/topics/cqrs "Topic: cqrs") [ddd](/topics/ddd "Topic: ddd") [domain-driven-design](/topics/domain-driven-design "Topic: domain-driven-design") [event-sourcing](/topics/event-sourcing "Topic: event-sourcing") [event-driven](/topics/event-driven "Topic: event-driven") [golang-library](/topics/golang-library "Topic: golang-library") [cqrs-es](/topics/cqrs-es "Topic: cqrs-es")
...
[Activity](/DeluxeOwl/chronicle/activity)

### Stars

[**54** stars](/DeluxeOwl/chronicle/stargazers)

### Watchers

[**1** watching](/DeluxeOwl/chronicle/watchers)

### Forks

[**0** forks](/DeluxeOwl/chronicle/forks)

[Report repository](/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2FDeluxeOwl%2Fchronicle&report=DeluxeOwl+%28user%29)

## [Releases](/DeluxeOwl/chronicle/releases)

[1 tags](/DeluxeOwl/chronicle/tags)

## [Packages 0](/users/DeluxeOwl/packages?repo_name=chronicle)

No packages published  

## Languages

*   [Go 99.9%](/DeluxeOwl/chronicle/search?l=go)
*   [Shell 0.1%](/DeluxeOwl/chronicle/search?l=shell)
