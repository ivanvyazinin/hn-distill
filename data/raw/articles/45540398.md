...
[*   Home](/)[*   Archives](/post/)[*   Tags](/tags/)[*   Categories](/categories/)[*   Donate](https://liberapay.com/hackeryarn)
...
*   [Donate](https://liberapay.com/hackeryarn)
...
*   [Prior art](#prior-art)
*   [Macro design process](#macro-design-process)
    *   [Don’t write macros](#dont-write-macros)
*   [The simplest query! macro](#the-simplest-query-macro)
    *   [Our first match arm](#our-first-match-arm)
    *   [Implementing single field select](#implementing-single-field-select)
...
[Let's write a macro in Rust - Part 2 Prev](/post/rust-macros-2/) [You don't need a map for that Next](/post/maps/)

Please enable JavaScript to view the [comments powered by Disqus.](http://disqus.com/?ref_noscript)

[](https://twitter.com/hackeryarn "twitter")[](https://www.linkedin.com/in/achernyak "linkedin")[](https://github.com/hackeryarn "github")

Powered by [Hugo](https://gohugo.io) | Theme - [Even](https://github.com/olOwOlo/hugo-theme-even) © 2018 - 2025