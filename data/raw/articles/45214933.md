...
This post was originally given as a talk for [Friendly.rb](https://friendlyrb.com). The [slides](https://speakerdeck.com/indirect/rails-on-sqlite-exciting-new-ways-to-cause-outages) are also available.
