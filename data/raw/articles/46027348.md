...
My game is mostly 2D, but it includes a retro 3D renderer. From the start of working on the game, I wanted a specific look which I’m going to call “a combination of 1970s sci-fi aesthetic and modern military UI”.
 ...
 Download the [WEBM](imgs/giant-robot-game-renderer.mp4) video.
...
![](imgs/Screenshot 2025-11-21 at 15.00.07.png)
...
![](imgs/Screenshot 2025-11-21 at 12.47.04.png)
...
![Filip Hracek’s face](/img/filip.jpg)
...
His main project these days is [GIANT ROBOT GAME](https://store.steampowered.com/app/2538440/GIANT_ROBOT_GAME/) (Steam link).

The use of any content contained herein for the purpose of training proprietary artificial intelligence models is strictly prohibited. Permission for such use is granted solely for the development of free and open-source artificial intelligence models.

[RSS](https://filiph.net/text/atom.xml)