Resizeable BAR support on the Raspberry Pi | Jeff Geerling   [Skip to main content](#main-content)
...
![Intel Arc B580 on Raspberry Pi 500+](/sites/default/files/images/sparkle-intel-arc-b580-on-raspberry-pi-500-plus.jpg)
...
I chose an 8GB BAR[1](#fn:bar-size), as that's what the A750 asked for in the error message (`Failed to resize BAR2 to 8192M`).
...
![Intel B580 on Pi 500+ running an LLM with llama.cpp](/sites/default/files/images/intel-b580-on-pi-500-plus-llm-running.jpg)
...
*   [Add new comment](/comment/reply/node/3503/comment_node_blog_post#comment-form "Share your thoughts and opinions.")

## Comments

PCIe Info – [3 days ago](/comment/36273#comment-36273)

The BAR (Base Address Register) can only be in powers of 2 starting at 4k and can only be assigned on the boundary size in which it is requested. In other words if a device requests 512MiB of space it must be on a 512MiB boundary.

*   [Reply](/comment/reply/node/3503/comment_node_blog_post/36273)
