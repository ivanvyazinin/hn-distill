...
So how do you know _when_ and _how_ to animate to improve the experience?
...
You can view the full animation on [linear.app/ai](https://linear.app/ai).
...
I use Raycast hundreds of times a day. If it animated every time I opened it, it would be _very_ annoying. But there’s no animation at all. That’s the optimal experience.
...
AnimationNo animation

Command Menu

Suggestions

![Linear](/you-dont-need-animations/linear-app-logo.png)LinearApplication

![ChatGPT](/you-dont-need-animations/openai-app-logo.png)ChatGPTApplication

![Cursor](/you-dont-need-animations/cursor-app-logo.png)CursorApplication

![Figma](/you-dont-need-animations/figma-app-logo.png)FigmaApplication

![Obsidian](/you-dont-need-animations/obsidian-app-icon.png)ObsidianApplication

Commands

Clipboard HistoryCommand
...
The same goes for keyboard-initiated actions. These actions may be repeated hundreds of times a day, an animation would make them feel slow, delayed, and disconnected from the user’s actions. You should _never_ animate them.
...
Unless you are working on marketing sites, your animations _have_ to be fast. They improve the perceived performance of your app, stay connected to user’s actions, and make the interface feel as if it’s truly listening to the user.
